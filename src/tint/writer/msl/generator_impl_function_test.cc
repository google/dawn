...
TEST_F(MslGeneratorImplTest, Emit_FunctionAttribute_EntryPoint_With_RW_StorageBuffer) {
    ...
    GlobalVar("coord", ty.Of(s), type::AddressSpace::kStorage, ast::Access::kReadWrite, Group(0_a),
              Binding(0_a));
...
TEST_F(MslGeneratorImplTest, Emit_FunctionAttribute_EntryPoint_With_RO_StorageBuffer) {
    ...
    GlobalVar("coord", ty.Of(s), type::AddressSpace::kStorage, ast::Access::kRead, Group(0_a),
              Binding(0_a));
...
TEST_F(MslGeneratorImplTest, Emit_Function_Multiple_EntryPoint_With_Same_ModuleVar) {
    ...
    GlobalVar("data", ty.Of(s), type::AddressSpace::kStorage, ast::Access::kReadWrite, Group(0_a),
              Binding(0_a));
