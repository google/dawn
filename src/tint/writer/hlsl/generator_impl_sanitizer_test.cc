...
TEST_F(HlslSanitizerTest, Call_ArrayLength) {
    ...
    GlobalVar("b", ty.Of(s), type::AddressSpace::kStorage, ast::Access::kRead, Binding(1_a),
              Group(2_a));
...
TEST_F(HlslSanitizerTest, Call_ArrayLength_ArrayLengthFromUniform) {
    ...
    GlobalVar("b", ty.Of(s), type::AddressSpace::kStorage, ast::Access::kRead, Binding(1_a),
              Group(2_a));
    GlobalVar("c", ty.Of(s), type::AddressSpace::kStorage, ast::Access::kRead, Binding(2_a),
              Group(2_a));
