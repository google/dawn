...
TEST_F(BuilderTest, GlobalVar_DeclReadOnly) {
    ...
    GlobalVar("b", ty.Of(A), type::AddressSpace::kStorage, ast::Access::kRead, Binding(0_a),
              Group(0_a));
...
TEST_F(BuilderTest, GlobalVar_TypeAliasDeclReadOnly) {
    ...
    GlobalVar("b", ty.Of(B), type::AddressSpace::kStorage, ast::Access::kRead, Binding(0_a),
              Group(0_a));
...
TEST_F(BuilderTest, GlobalVar_TwoVarDeclReadOnly) {
    ...
    auto* A = Structure("A", utils::Vector{Member("a", ty.i32())});
    GlobalVar("b", ty.Of(A), type::AddressSpace::kStorage, ast::Access::kRead, Group(0_a),
              Binding(0_a));
    GlobalVar("c", ty.Of(A), type::AddressSpace::kStorage, ast::Access::kReadWrite, Group(1_a),
              Binding(0_a));
