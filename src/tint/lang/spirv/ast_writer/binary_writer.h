...
#ifndef SRC_TINT_LANG_SPIRV_AST_WRITER_BINARY_WRITER_H_
#define SRC_TINT_LANG_SPIRV_AST_WRITER_BINARY_WRITER_H_
...
#endif  // SRC_TINT_LANG_SPIRV_AST_WRITER_BINARY_WRITER_H_
