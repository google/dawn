...
void main_inner(uint idx) {
  ...
  sb.Store((0u + (min(idx, ((v_24 / 800u) - 1u)) * 800u)), 0u);
  uint v_25 = 0u;
  sb.GetDimensions(v_25);
  sb.Store((4u + (min(idx, ((v_25 / 800u) - 1u)) * 800u)), 0u);
  uint v_26 = 0u;
  ...
  sb.Store2((16u + (min(idx, ((v_28 / 800u) - 1u)) * 800u)), (0u).xx);
  uint v_29 = 0u;
  sb.GetDimensions(v_29);
  sb.Store2((24u + (min(idx, ((v_29 / 800u) - 1u)) * 800u)), (0u).xx);
  uint v_30 = 0u;
  sb.GetDimensions(v_30);
  sb.Store2((32u + (min(idx, ((v_30 / 800u) - 1u)) * 800u)), (0u).xx);
  uint v_31 = 0u;
  sb.GetDimensions(v_31);
  sb.Store<vector<float16_t, 2> >((40u + (min(idx, ((v_31 / 800u) - 1u)) * 800u)), (float16_t(0.0h)).xx);
  uint v_32 = 0u;
  sb.GetDimensions(v_32);
  sb.Store3((48u + (min(idx, ((v_32 / 800u) - 1u)) * 800u)), (0u).xxx);
  uint v_33 = 0u;
  sb.GetDimensions(v_33);
  sb.Store3((64u + (min(idx, ((v_33 / 800u) - 1u)) * 800u)), (0u).xxx);
  uint v_34 = 0u;
  sb.GetDimensions(v_34);
  sb.Store3((80u + (min(idx, ((v_34 / 800u) - 1u)) * 800u)), (0u).xxx);
  uint v_35 = 0u;
  sb.GetDimensions(v_35);
  sb.Store<vector<float16_t, 3> >((96u + (min(idx, ((v_35 / 800u) - 1u)) * 800u)), (float16_t(0.0h)).xxx);
  uint v_36 = 0u;
  sb.GetDimensions(v_36);
  sb.Store4((112u + (min(idx, ((v_36 / 800u) - 1u)) * 800u)), (0u).xxxx);
  uint v_37 = 0u;
  sb.GetDimensions(v_37);
  sb.Store4((128u + (min(idx, ((v_37 / 800u) - 1u)) * 800u)), (0u).xxxx);
  uint v_38 = 0u;
  sb.GetDimensions(v_38);
  sb.Store4((144u + (min(idx, ((v_38 / 800u) - 1u)) * 800u)), (0u).xxxx);
  uint v_39 = 0u;
  sb.GetDimensions(v_39);
  sb.Store<vector<float16_t, 4> >((160u + (min(idx, ((v_39 / 800u) - 1u)) * 800u)), (float16_t(0.0h)).xxxx);
  uint v_40 = 0u;
  sb.GetDimensions(v_40);
  v_23((168u + (min(idx, ((v_40 / 800u) - 1u)) * 800u)), float2x2((0.0f).xx, (0.0f).xx));
  uint v_41 = 0u;
  sb.GetDimensions(v_41);
  v_22((192u + (min(idx, ((v_41 / 800u) - 1u)) * 800u)), float2x3((0.0f).xxx, (0.0f).xxx));
  uint v_42 = 0u;
  sb.GetDimensions(v_42);
  v_21((224u + (min(idx, ((v_42 / 800u) - 1u)) * 800u)), float2x4((0.0f).xxxx, (0.0f).xxxx));
  uint v_43 = 0u;
  sb.GetDimensions(v_43);
  v_20((256u + (min(idx, ((v_43 / 800u) - 1u)) * 800u)), float3x2((0.0f).xx, (0.0f).xx, (0.0f).xx));
  uint v_44 = 0u;
  sb.GetDimensions(v_44);
  v_19((288u + (min(idx, ((v_44 / 800u) - 1u)) * 800u)), float3x3((0.0f).xxx, (0.0f).xxx, (0.0f).xxx));
  uint v_45 = 0u;
  sb.GetDimensions(v_45);
  v_18((336u + (min(idx, ((v_45 / 800u) - 1u)) * 800u)), float3x4((0.0f).xxxx, (0.0f).xxxx, (0.0f).xxxx));
  uint v_46 = 0u;
  sb.GetDimensions(v_46);
  v_17((384u + (min(idx, ((v_46 / 800u) - 1u)) * 800u)), float4x2((0.0f).xx, (0.0f).xx, (0.0f).xx, (0.0f).xx));
  uint v_47 = 0u;
  sb.GetDimensions(v_47);
  v_16((416u + (min(idx, ((v_47 / 800u) - 1u)) * 800u)), float4x3((0.0f).xxx, (0.0f).xxx, (0.0f).xxx, (0.0f).xxx));
  uint v_48 = 0u;
  sb.GetDimensions(v_48);
  v_15((480u + (min(idx, ((v_48 / 800u) - 1u)) * 800u)), float4x4((0.0f).xxxx, (0.0f).xxxx, (0.0f).xxxx, (0.0f).xxxx));
  uint v_49 = 0u;
  sb.GetDimensions(v_49);
  v_14((544u + (min(idx, ((v_49 / 800u) - 1u)) * 800u)), matrix<float16_t, 2, 2>((float16_t(0.0h)).xx, (float16_t(0.0h)).xx));
  uint v_50 = 0u;
  sb.GetDimensions(v_50);
  v_13((552u + (min(idx, ((v_50 / 800u) - 1u)) * 800u)), matrix<float16_t, 2, 3>((float16_t(0.0h)).xxx, (float16_t(0.0h)).xxx));
  uint v_51 = 0u;
  sb.GetDimensions(v_51);
  v_12((568u + (min(idx, ((v_51 / 800u) - 1u)) * 800u)), matrix<float16_t, 2, 4>((float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx));
  uint v_52 = 0u;
  sb.GetDimensions(v_52);
  v_11((584u + (min(idx, ((v_52 / 800u) - 1u)) * 800u)), matrix<float16_t, 3, 2>((float16_t(0.0h)).xx, (float16_t(0.0h)).xx, (float16_t(0.0h)).xx));
  uint v_53 = 0u;
  sb.GetDimensions(v_53);
  v_10((600u + (min(idx, ((v_53 / 800u) - 1u)) * 800u)), matrix<float16_t, 3, 3>((float16_t(0.0h)).xxx, (float16_t(0.0h)).xxx, (float16_t(0.0h)).xxx));
  uint v_54 = 0u;
  sb.GetDimensions(v_54);
  v_9((624u + (min(idx, ((v_54 / 800u) - 1u)) * 800u)), matrix<float16_t, 3, 4>((float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx));
  uint v_55 = 0u;
  sb.GetDimensions(v_55);
  v((648u + (min(idx, ((v_55 / 800u) - 1u)) * 800u)), matrix<float16_t, 4, 2>((float16_t(0.0h)).xx, (float16_t(0.0h)).xx, (float16_t(0.0h)).xx, (float16_t(0.0h)).xx));
  uint v_56 = 0u;
  sb.GetDimensions(v_56);
  v_8((664u + (min(idx, ((v_56 / 800u) - 1u)) * 800u)), matrix<float16_t, 4, 3>((float16_t(0.0h)).xxx, (float16_t(0.0h)).xxx, (float16_t(0.0h)).xxx, (float16_t(0.0h)).xxx));
  uint v_57 = 0u;
  sb.GetDimensions(v_57);
  v_7((696u + (min(idx, ((v_57 / 800u) - 1u)) * 800u)), matrix<float16_t, 4, 4>((float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx));
  uint v_58 = 0u;
  sb.GetDimensions(v_58);
  float3 v_59[2] = (float3[2])0;
  v_4((736u + (min(idx, ((v_58 / 800u) - 1u)) * 800u)), v_59);
  uint v_60 = 0u;
  sb.GetDimensions(v_60);
  matrix<float16_t, 4, 2> v_61[2] = (matrix<float16_t, 4, 2>[2])0;
  v_1((768u + (min(idx, ((v_60 / 800u) - 1u)) * 800u)), v_61);
}
