...
void main_inner(uint idx) {
  ...
  sb.Store((0u + (min(idx, ((v_12 / 544u) - 1u)) * 544u)), 0u);
  uint v_13 = 0u;
  sb.GetDimensions(v_13);
  sb.Store((4u + (min(idx, ((v_13 / 544u) - 1u)) * 544u)), 0u);
  uint v_14 = 0u;
  sb.GetDimensions(v_14);
  sb.Store((8u + (min(idx, ((v_14 / 544u) - 1u)) * 544u)), 0u);
  uint v_15 = 0u;
  sb.GetDimensions(v_15);
  sb.Store2((16u + (min(idx, ((v_15 / 544u) - 1u)) * 544u)), (0u).xx);
  uint v_16 = 0u;
  sb.GetDimensions(v_16);
  sb.Store2((24u + (min(idx, ((v_16 / 544u) - 1u)) * 544u)), (0u).xx);
  uint v_17 = 0u;
  sb.GetDimensions(v_17);
  sb.Store2((32u + (min(idx, ((v_17 / 544u) - 1u)) * 544u)), (0u).xx);
  uint v_18 = 0u;
  sb.GetDimensions(v_18);
  sb.Store3((48u + (min(idx, ((v_18 / 544u) - 1u)) * 544u)), (0u).xxx);
  uint v_19 = 0u;
  sb.GetDimensions(v_19);
  sb.Store3((64u + (min(idx, ((v_19 / 544u) - 1u)) * 544u)), (0u).xxx);
  uint v_20 = 0u;
  sb.GetDimensions(v_20);
  sb.Store3((80u + (min(idx, ((v_20 / 544u) - 1u)) * 544u)), (0u).xxx);
  uint v_21 = 0u;
  sb.GetDimensions(v_21);
  sb.Store4((96u + (min(idx, ((v_21 / 544u) - 1u)) * 544u)), (0u).xxxx);
  uint v_22 = 0u;
  sb.GetDimensions(v_22);
  sb.Store4((112u + (min(idx, ((v_22 / 544u) - 1u)) * 544u)), (0u).xxxx);
  uint v_23 = 0u;
  sb.GetDimensions(v_23);
  sb.Store4((128u + (min(idx, ((v_23 / 544u) - 1u)) * 544u)), (0u).xxxx);
  uint v_24 = 0u;
  sb.GetDimensions(v_24);
  v_11((144u + (min(idx, ((v_24 / 544u) - 1u)) * 544u)), float2x2((0.0f).xx, (0.0f).xx));
  uint v_25 = 0u;
  sb.GetDimensions(v_25);
  v_10((160u + (min(idx, ((v_25 / 544u) - 1u)) * 544u)), float2x3((0.0f).xxx, (0.0f).xxx));
  uint v_26 = 0u;
  sb.GetDimensions(v_26);
  v_9((192u + (min(idx, ((v_26 / 544u) - 1u)) * 544u)), float2x4((0.0f).xxxx, (0.0f).xxxx));
  uint v_27 = 0u;
  sb.GetDimensions(v_27);
  v_8((224u + (min(idx, ((v_27 / 544u) - 1u)) * 544u)), float3x2((0.0f).xx, (0.0f).xx, (0.0f).xx));
  uint v_28 = 0u;
  sb.GetDimensions(v_28);
  v_7((256u + (min(idx, ((v_28 / 544u) - 1u)) * 544u)), float3x3((0.0f).xxx, (0.0f).xxx, (0.0f).xxx));
  uint v_29 = 0u;
  sb.GetDimensions(v_29);
  v_6((304u + (min(idx, ((v_29 / 544u) - 1u)) * 544u)), float3x4((0.0f).xxxx, (0.0f).xxxx, (0.0f).xxxx));
  uint v_30 = 0u;
  sb.GetDimensions(v_30);
  v_5((352u + (min(idx, ((v_30 / 544u) - 1u)) * 544u)), float4x2((0.0f).xx, (0.0f).xx, (0.0f).xx, (0.0f).xx));
  uint v_31 = 0u;
  sb.GetDimensions(v_31);
  v_4((384u + (min(idx, ((v_31 / 544u) - 1u)) * 544u)), float4x3((0.0f).xxx, (0.0f).xxx, (0.0f).xxx, (0.0f).xxx));
  uint v_32 = 0u;
  sb.GetDimensions(v_32);
  v_3((448u + (min(idx, ((v_32 / 544u) - 1u)) * 544u)), float4x4((0.0f).xxxx, (0.0f).xxxx, (0.0f).xxxx, (0.0f).xxxx));
  uint v_33 = 0u;
  sb.GetDimensions(v_33);
  float3 v_34[2] = (float3[2])0;
  v((512u + (min(idx, ((v_33 / 544u) - 1u)) * 544u)), v_34);
}
