...
void main_inner(uint idx) {
  ...
  int v_49 = tint_f32_to_i32(mat2x2_f32[0].x);
  uint v_50 = uint(v_48);
  int v_51 = int((v_50 + uint(v_49)));
  int v_52 = tint_f32_to_i32(mat2x3_f32[0].x);
  uint v_53 = uint(v_51);
  int v_54 = int((v_53 + uint(v_52)));
  int v_55 = tint_f32_to_i32(mat2x4_f32[0].x);
  uint v_56 = uint(v_54);
  int v_57 = int((v_56 + uint(v_55)));
  int v_58 = tint_f32_to_i32(mat3x2_f32[0].x);
  uint v_59 = uint(v_57);
  int v_60 = int((v_59 + uint(v_58)));
  int v_61 = tint_f32_to_i32(mat3x3_f32[0].x);
  uint v_62 = uint(v_60);
  int v_63 = int((v_62 + uint(v_61)));
  int v_64 = tint_f32_to_i32(mat3x4_f32[0].x);
  uint v_65 = uint(v_63);
  int v_66 = int((v_65 + uint(v_64)));
  int v_67 = tint_f32_to_i32(mat4x2_f32[0].x);
  uint v_68 = uint(v_66);
  int v_69 = int((v_68 + uint(v_67)));
  int v_70 = tint_f32_to_i32(mat4x3_f32[0].x);
  uint v_71 = uint(v_69);
  int v_72 = int((v_71 + uint(v_70)));
  int v_73 = tint_f32_to_i32(mat4x4_f32[0].x);
  uint v_74 = uint(v_72);
  int v_75 = int((v_74 + uint(v_73)));
  int v_76 = tint_f32_to_i32(arr2_vec3_f32[0].x);
  uint v_77 = uint(v_75);
