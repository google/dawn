...
void main_inner(uint idx) {
  ...
  int v_75 = tint_f32_to_i32(mat2x2_f32[0].x);
  uint v_76 = uint(v_74);
  int v_77 = int((v_76 + uint(v_75)));
  int v_78 = tint_f32_to_i32(mat2x3_f32[0].x);
  uint v_79 = uint(v_77);
  int v_80 = int((v_79 + uint(v_78)));
  int v_81 = tint_f32_to_i32(mat2x4_f32[0].x);
  uint v_82 = uint(v_80);
  int v_83 = int((v_82 + uint(v_81)));
  int v_84 = tint_f32_to_i32(mat3x2_f32[0].x);
  uint v_85 = uint(v_83);
  int v_86 = int((v_85 + uint(v_84)));
  int v_87 = tint_f32_to_i32(mat3x3_f32[0].x);
  uint v_88 = uint(v_86);
  int v_89 = int((v_88 + uint(v_87)));
  int v_90 = tint_f32_to_i32(mat3x4_f32[0].x);
  uint v_91 = uint(v_89);
  int v_92 = int((v_91 + uint(v_90)));
  int v_93 = tint_f32_to_i32(mat4x2_f32[0].x);
  uint v_94 = uint(v_92);
  int v_95 = int((v_94 + uint(v_93)));
  int v_96 = tint_f32_to_i32(mat4x3_f32[0].x);
  uint v_97 = uint(v_95);
  int v_98 = int((v_97 + uint(v_96)));
  int v_99 = tint_f32_to_i32(mat4x4_f32[0].x);
  uint v_100 = uint(v_98);
  int v_101 = int((v_100 + uint(v_99)));
  int v_102 = tint_f16_to_i32(mat2x2_f16[0].x);
  uint v_103 = uint(v_101);
  int v_104 = int((v_103 + uint(v_102)));
  int v_105 = tint_f16_to_i32(mat2x3_f16[0].x);
  uint v_106 = uint(v_104);
  int v_107 = int((v_106 + uint(v_105)));
  int v_108 = tint_f16_to_i32(mat2x4_f16[0].x);
  uint v_109 = uint(v_107);
  int v_110 = int((v_109 + uint(v_108)));
  int v_111 = tint_f16_to_i32(mat3x2_f16[0].x);
  uint v_112 = uint(v_110);
  int v_113 = int((v_112 + uint(v_111)));
  int v_114 = tint_f16_to_i32(mat3x3_f16[0].x);
  uint v_115 = uint(v_113);
  int v_116 = int((v_115 + uint(v_114)));
  int v_117 = tint_f16_to_i32(mat3x4_f16[0].x);
  uint v_118 = uint(v_116);
  int v_119 = int((v_118 + uint(v_117)));
  int v_120 = tint_f16_to_i32(mat4x2_f16[0].x);
  uint v_121 = uint(v_119);
  int v_122 = int((v_121 + uint(v_120)));
  int v_123 = tint_f16_to_i32(mat4x3_f16[0].x);
  uint v_124 = uint(v_122);
  int v_125 = int((v_124 + uint(v_123)));
  int v_126 = tint_f16_to_i32(mat4x4_f16[0].x);
  uint v_127 = uint(v_125);
  int v_128 = int((v_127 + uint(v_126)));
  int v_129 = tint_f16_to_i32(arr2_mat4x2_f16[0][0].x);
  uint v_130 = uint(v_128);
  int v_131 = int((v_130 + uint(v_129)));
  int v_132 = tint_f32_to_i32(arr2_vec3_f32[0].x);
