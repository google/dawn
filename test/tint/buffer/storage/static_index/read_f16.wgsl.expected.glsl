...
void main() {
  ...
  int v_40 = tint_f32_to_i32(mat2x2_f32[0].x);
  uint v_41 = uint(v_39);
  int v_42 = int((v_41 + uint(v_40)));
  int v_43 = tint_f32_to_i32(mat2x3_f32[0].x);
  uint v_44 = uint(v_42);
  int v_45 = int((v_44 + uint(v_43)));
  int v_46 = tint_f32_to_i32(mat2x4_f32[0].x);
  uint v_47 = uint(v_45);
  int v_48 = int((v_47 + uint(v_46)));
  int v_49 = tint_f32_to_i32(mat3x2_f32[0].x);
  uint v_50 = uint(v_48);
  int v_51 = int((v_50 + uint(v_49)));
  int v_52 = tint_f32_to_i32(mat3x3_f32[0].x);
  uint v_53 = uint(v_51);
  int v_54 = int((v_53 + uint(v_52)));
  int v_55 = tint_f32_to_i32(mat3x4_f32[0].x);
  uint v_56 = uint(v_54);
  int v_57 = int((v_56 + uint(v_55)));
  int v_58 = tint_f32_to_i32(mat4x2_f32[0].x);
  uint v_59 = uint(v_57);
  int v_60 = int((v_59 + uint(v_58)));
  int v_61 = tint_f32_to_i32(mat4x3_f32[0].x);
  uint v_62 = uint(v_60);
  int v_63 = int((v_62 + uint(v_61)));
  int v_64 = tint_f32_to_i32(mat4x4_f32[0].x);
  uint v_65 = uint(v_63);
  int v_66 = int((v_65 + uint(v_64)));
  int v_67 = tint_f16_to_i32(mat2x2_f16[0].x);
  uint v_68 = uint(v_66);
  int v_69 = int((v_68 + uint(v_67)));
  int v_70 = tint_f16_to_i32(mat2x3_f16[0].x);
  uint v_71 = uint(v_69);
  int v_72 = int((v_71 + uint(v_70)));
  int v_73 = tint_f16_to_i32(mat2x4_f16[0].x);
  uint v_74 = uint(v_72);
  int v_75 = int((v_74 + uint(v_73)));
  int v_76 = tint_f16_to_i32(mat3x2_f16[0].x);
  uint v_77 = uint(v_75);
  int v_78 = int((v_77 + uint(v_76)));
  int v_79 = tint_f16_to_i32(mat3x3_f16[0].x);
  uint v_80 = uint(v_78);
  int v_81 = int((v_80 + uint(v_79)));
  int v_82 = tint_f16_to_i32(mat3x4_f16[0].x);
  uint v_83 = uint(v_81);
  int v_84 = int((v_83 + uint(v_82)));
  int v_85 = tint_f16_to_i32(mat4x2_f16[0].x);
  uint v_86 = uint(v_84);
  int v_87 = int((v_86 + uint(v_85)));
  int v_88 = tint_f16_to_i32(mat4x3_f16[0].x);
  uint v_89 = uint(v_87);
  int v_90 = int((v_89 + uint(v_88)));
  int v_91 = tint_f16_to_i32(mat4x4_f16[0].x);
  uint v_92 = uint(v_90);
  int v_93 = int((v_92 + uint(v_91)));
  int v_94 = tint_f32_to_i32(arr2_vec3_f32[0].x);
  uint v_95 = uint(v_93);
  int v_96 = int((v_95 + uint(v_94)));
  int v_97 = tint_f16_to_i32(arr2_mat4x2_f16[0][0].x);
  uint v_98 = uint(v_96);
