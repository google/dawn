...
void main() {
  ...
  tint_store_and_preserve_padding_7(Inner(0, 0.0f, 0.0hf, 0.0hf));
  tint_store_and_preserve_padding_9(Inner[4](Inner(0, 0.0f, 0.0hf, 0.0hf), Inner(0, 0.0f, 0.0hf, 0.0hf), Inner(0, 0.0f, 0.0hf, 0.0hf), Inner(0, 0.0f, 0.0hf, 0.0hf)));
}
