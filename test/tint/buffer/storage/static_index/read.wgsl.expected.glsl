...
void main() {
  ...
  int v_28 = tint_f32_to_i32(mat2x2_f32[0].x);
  uint v_29 = uint(v_27);
  int v_30 = int((v_29 + uint(v_28)));
  int v_31 = tint_f32_to_i32(mat2x3_f32[0].x);
  uint v_32 = uint(v_30);
  int v_33 = int((v_32 + uint(v_31)));
  int v_34 = tint_f32_to_i32(mat2x4_f32[0].x);
  uint v_35 = uint(v_33);
  int v_36 = int((v_35 + uint(v_34)));
  int v_37 = tint_f32_to_i32(mat3x2_f32[0].x);
  uint v_38 = uint(v_36);
  int v_39 = int((v_38 + uint(v_37)));
  int v_40 = tint_f32_to_i32(mat3x3_f32[0].x);
  uint v_41 = uint(v_39);
  int v_42 = int((v_41 + uint(v_40)));
  int v_43 = tint_f32_to_i32(mat3x4_f32[0].x);
  uint v_44 = uint(v_42);
  int v_45 = int((v_44 + uint(v_43)));
  int v_46 = tint_f32_to_i32(mat4x2_f32[0].x);
  uint v_47 = uint(v_45);
  int v_48 = int((v_47 + uint(v_46)));
  int v_49 = tint_f32_to_i32(mat4x3_f32[0].x);
  uint v_50 = uint(v_48);
  int v_51 = int((v_50 + uint(v_49)));
  int v_52 = tint_f32_to_i32(mat4x4_f32[0].x);
  uint v_53 = uint(v_51);
  int v_54 = int((v_53 + uint(v_52)));
  int v_55 = tint_f32_to_i32(arr2_vec3_f32[0].x);
  uint v_56 = uint(v_54);
  uint v_57 = uint(int((v_56 + uint(v_55))));
  uint v_58 = uint(int((v_57 + uint(struct_inner.scalar_i32))));
  v_1.inner = int((v_58 + uint(array_struct_inner[0].scalar_i32)));
}
