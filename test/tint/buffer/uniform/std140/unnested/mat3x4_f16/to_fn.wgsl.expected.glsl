...
void main() {
  a(v_2(0u));
  b(tint_bitcast_to_16bit(v_1.inner[0u].zw));
  b(tint_bitcast_to_16bit(v_1.inner[0u].zw).ywxz);
  uvec4 v_10 = v_1.inner[0u];
  c(tint_bitcast_to_16bit_1(v_10.z).x);
  c(tint_bitcast_to_16bit(v_1.inner[0u].zw).ywxz.x);
}
