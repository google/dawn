...
void main() {
  a(v_2(0u));
  b(tint_bitcast_to_f16(v_1.inner[0u].zw));
  b(tint_bitcast_to_f16(v_1.inner[0u].zw).ywxz);
  uvec4 v_8 = v_1.inner[0u];
  c(tint_bitcast_to_f16_1(v_8.z).x);
  c(tint_bitcast_to_f16(v_1.inner[0u].zw).ywxz.x);
}
