...
void v_5(uint offset, matrix<float16_t, 3, 4> obj) {
...
matrix<float16_t, 3, 4> v_6(uint start_byte_offset) {
  ...
  return matrix<float16_t, 3, 4>(v_8, v_10, tint_bitcast_to_f16_1(((((((16u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_11.zw) : (v_11.xy))));
}
