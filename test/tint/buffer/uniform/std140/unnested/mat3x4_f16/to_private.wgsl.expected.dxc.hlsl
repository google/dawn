...
matrix<float16_t, 3, 4> v_1(uint start_byte_offset) {
  ...
  uint4 v_8 = u[(v_7 / 16u)];
  return matrix<float16_t, 3, 4>(v_3, v_6, tint_bitcast_to_f16_1(select((((v_7 & 15u) >> 2u) == 2u), v_8.zw, v_8.xy)));
}

[numthreads(1, 1, 1)]
void f() {
  p = v_1(0u);
  p[int(1)] = tint_bitcast_to_f16_1(u[0u].xy);
  p[int(1)] = tint_bitcast_to_f16_1(u[0u].xy).ywxz;
