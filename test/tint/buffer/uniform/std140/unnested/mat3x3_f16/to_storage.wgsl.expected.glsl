...
void main() {
  ...
  v_1.inner[1u] = tint_bitcast_to_16bit_1(v.inner[0u].xy).xyz;
  v_1.inner[1u] = tint_bitcast_to_16bit_1(v.inner[0u].xy).xyz.zxy;
  uvec4 v_10 = v.inner[0u];
  v_1.inner[0u].y = tint_bitcast_to_16bit(v_10.z).x;
}
