...
f16mat3 v_2(uint start_byte_offset) {
  ...
  return f16mat3(v_4, v_7, tint_bitcast_to_16bit_1(mix(v_9.xy, v_9.zw, bvec2((((v_8 & 15u) >> 2u) == 2u)))).xyz);
}
layout(local_size_x = 1, local_size_y = 1, local_size_z = 1) in;
void main() {
  a(v_2(0u));
  b(tint_bitcast_to_16bit_1(v_1.inner[0u].zw).xyz);
  b(tint_bitcast_to_16bit_1(v_1.inner[0u].zw).xyz.zxy);
  uvec4 v_10 = v_1.inner[0u];
  c(tint_bitcast_to_16bit(v_10.z).x);
  uvec4 v_11 = v_1.inner[0u];
  c(tint_bitcast_to_16bit(v_11.w).x);
}
