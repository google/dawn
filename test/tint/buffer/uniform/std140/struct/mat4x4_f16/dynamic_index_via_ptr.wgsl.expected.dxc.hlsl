...
void f() {
  ...
  matrix<float16_t, 4, 4> l_a_i_a_i_m = v_2((v_28 + v_29));
  uint v_31 = ((v_28 + v_29) + v_30);
  uint4 v_32 = a[(v_31 / 16u)];
  vector<float16_t, 4> l_a_i_a_i_m_i = tint_bitcast_to_f16(select((((v_31 & 15u) >> 2u) == 2u), v_32.zw, v_32.xy));
  uint v_33 = (((v_28 + v_29) + v_30) + (min(uint(i()), 3u) * 2u));
