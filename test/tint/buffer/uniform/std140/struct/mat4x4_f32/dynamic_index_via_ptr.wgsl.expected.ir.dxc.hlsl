...
%28 = func(%start_byte_offset_1:u32):Inner {  # %start_byte_offset_1: 'start_byte_offset'
  $B9: {
    %64:mat4x4<f32> = call %32, %start_byte_offset_1
    %65:Inner = construct %64
    ret %65
  }
}
%32 = func(%start_byte_offset_2:u32):mat4x4<f32> {  # %start_byte_offset_2: 'start_byte_offset'
  $B10: {
    ...
    %81:u32 = add 48u, %start_byte_offset_2
    %82:u32 = div %81, 16u
    %83:ptr<uniform, vec4<u32>, read> = access %a, %82
    %84:vec4<u32> = load %83
    %85:vec4<f32> = bitcast %84
    %86:mat4x4<f32> = construct %70, %75, %80, %85
    ret %86
  }
}
