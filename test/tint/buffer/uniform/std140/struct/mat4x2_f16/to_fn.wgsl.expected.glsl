...
f16mat4x2 v_2(uint start_byte_offset) {
  ...
  f16vec2 v_4 = tint_bitcast_to_f16(v_1.inner[((4u + start_byte_offset) / 16u)][(((4u + start_byte_offset) % 16u) / 4u)]);
  f16vec2 v_5 = tint_bitcast_to_f16(v_1.inner[((8u + start_byte_offset) / 16u)][(((8u + start_byte_offset) % 16u) / 4u)]);
  return f16mat4x2(v_3, v_4, v_5, tint_bitcast_to_f16(v_1.inner[((12u + start_byte_offset) / 16u)][(((12u + start_byte_offset) % 16u) / 4u)]));
}
