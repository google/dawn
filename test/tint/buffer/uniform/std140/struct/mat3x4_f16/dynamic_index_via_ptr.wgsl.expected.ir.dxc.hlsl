...
%28 = func(%start_byte_offset_2:u32):Inner {  # %start_byte_offset_2: 'start_byte_offset'
  $B10: {
    %72:mat3x4<f16> = call %32, %start_byte_offset_2
    %73:Inner = construct %72
    ret %73
  }
}
%32 = func(%start_byte_offset_3:u32):mat3x4<f16> {  # %start_byte_offset_3: 'start_byte_offset'
  $B11: {
    ...
    %89:mat3x4<f16> = construct %78, %83, %88
    ret %89
  }
}
