...
void f() {
  ...
  matrix<float16_t, 3, 4> l_a_i_a_i_m = v_2((v_25 + v_26));
  uint v_28 = ((v_25 + v_26) + v_27);
  uint4 v_29 = a[(v_28 / 16u)];
  vector<float16_t, 4> l_a_i_a_i_m_i = tint_bitcast_to_f16(select((((v_28 & 15u) >> 2u) == 2u), v_29.zw, v_29.xy));
  uint v_30 = (((v_25 + v_26) + v_27) + (min(uint(i()), 3u) * 2u));
