...
void f() {
  ...
  matrix<float16_t, 3, 4> l_a_i_a_i_m = v_1((v_24 + v_25));
  uint v_27 = ((v_24 + v_25) + v_26);
  uint4 v_28 = a[(v_27 / 16u)];
  vector<float16_t, 4> l_a_i_a_i_m_i = tint_bitcast_to_f16(select((((v_27 & 15u) >> 2u) == 2u), v_28.zw, v_28.xy));
  uint v_29 = (((v_24 + v_25) + v_26) + (min(uint(i()), 3u) * 2u));
