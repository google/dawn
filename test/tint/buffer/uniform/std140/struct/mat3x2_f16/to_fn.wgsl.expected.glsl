...
f16mat3x2 v_2(uint start_byte_offset) {
  ...
  return f16mat3x2(v_3, v_4, tint_bitcast_to_f16(v_1.inner[((8u + start_byte_offset) / 16u)][(((8u + start_byte_offset) % 16u) / 4u)]));
}
S v_5(uint start_byte_offset) {
  ...
  uvec4 v_9 = v_1.inner[((64u + start_byte_offset) / 16u)];
