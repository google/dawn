...
%28 = func(%start_byte_offset_2:u32):Inner {  # %start_byte_offset_2: 'start_byte_offset'
  $B10: {
    %73:mat2x2<f32> = call %32, %start_byte_offset_2
    %74:Inner = construct %73
    ret %74
  }
}
%32 = func(%start_byte_offset_3:u32):mat2x2<f32> {  # %start_byte_offset_3: 'start_byte_offset'
  $B11: {
