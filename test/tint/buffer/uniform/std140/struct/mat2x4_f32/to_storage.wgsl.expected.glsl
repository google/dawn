...
S v_3(uint start_byte_offset) {
  ...
  return S(v_5, 0u, 0u, 0u, v_6, tint_pad16_init, int(v_8[((v_7 & 15u) >> 2u)]), 0u, 0u, 0u, tint_pad16_init, tint_pad16_init, tint_pad16_init);
}
...
S[4] v_11(uint start_byte_offset) {
  S a[4] = S[4](S(0, 0u, 0u, 0u, mat2x4(vec4(0.0f), vec4(0.0f)), tint_pad16_init, 0, 0u, 0u, 0u, tint_pad16_init, tint_pad16_init, tint_pad16_init), S(0, 0u, 0u, 0u, mat2x4(vec4(0.0f), vec4(0.0f)), tint_pad16_init, 0, 0u, 0u, 0u, tint_pad16_init, tint_pad16_init, tint_pad16_init), S(0, 0u, 0u, 0u, mat2x4(vec4(0.0f), vec4(0.0f)), tint_pad16_init, 0, 0u, 0u, 0u, tint_pad16_init, tint_pad16_init, tint_pad16_init), S(0, 0u, 0u, 0u, mat2x4(vec4(0.0f), vec4(0.0f)), tint_pad16_init, 0, 0u, 0u, 0u, tint_pad16_init, tint_pad16_init, tint_pad16_init));
  {
    uint v_12 = 0u;
    v_12 = 0u;
    while(true) {
