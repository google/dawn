...
void main() {
  ...
  uint v_12 = (min(uint(i()), 1u) * 16u);
  Outer l_a[4] = v_7(0u);
  Outer l_a_i = v_6(v_10);
  Inner l_a_i_a[4] = v_3(v_10);
  Inner l_a_i_a_i = v_2((v_10 + v_11));
  mat2x4 l_a_i_a_i_m = v_1((v_10 + v_11));
  vec4 l_a_i_a_i_m_i = uintBitsToFloat(v.inner[(((v_10 + v_11) + v_12) / 16u)]);
  uint v_13 = (((v_10 + v_11) + v_12) + (min(uint(i()), 3u) * 4u));
