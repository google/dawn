...
%32 = func(%start_byte_offset:u32):mat2x3<f32> {
  $B4: {
  ...
  $B6: {
    ...
    loop [i: $B7, b: $B8, c: $B9] {  # loop_1
      ...
      $B8 (%idx:u32): {  # body
        ...
        %74:u32 = mul %idx, 64u
        %75:u32 = add %start_byte_offset_2, %74
        %76:ptr<function, Inner, read_write> = access %a_1, %idx
        %77:Inner = call %28, %75
        store %76, %77
        continue  # -> $B9
      }
      $B9: {  # continuing
        %78:u32 = add %idx, 1u
        next_iteration %78  # -> $B8
      }
    }
    %79:array<Inner, 4> = load %a_1
    ret %79
  }
}
