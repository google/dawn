...
f16mat4 v_3(uint start_byte_offset) {
  ...
  f16vec4 v_5 = tint_bitcast_to_16bit_1(mix(v_4.xy, v_4.zw, bvec2((((start_byte_offset & 15u) >> 2u) == 2u))));
  uint v_6 = (8u + start_byte_offset);
  uvec4 v_7 = v_1.inner[(v_6 / 16u)];
  f16vec4 v_8 = tint_bitcast_to_16bit_1(mix(v_7.xy, v_7.zw, bvec2((((v_6 & 15u) >> 2u) == 2u))));
  uint v_9 = (16u + start_byte_offset);
  uvec4 v_10 = v_1.inner[(v_9 / 16u)];
  f16vec4 v_11 = tint_bitcast_to_16bit_1(mix(v_10.xy, v_10.zw, bvec2((((v_9 & 15u) >> 2u) == 2u))));
  uint v_12 = (24u + start_byte_offset);
  uvec4 v_13 = v_1.inner[(v_12 / 16u)];
  return f16mat4(v_5, v_8, v_11, tint_bitcast_to_16bit_1(mix(v_13.xy, v_13.zw, bvec2((((v_12 & 15u) >> 2u) == 2u)))));
}
