...
matrix<float16_t, 4, 4> v_5(uint start_byte_offset) {
  ...
  vector<float16_t, 4> v_9 = tint_bitcast_to_f16_1(((((((8u + start_byte_offset) % 16u) / 4u) == 2u)) ? (v_8.zw) : (v_8.xy)));
  uint4 v_10 = u[((16u + start_byte_offset) / 16u)];
  vector<float16_t, 4> v_11 = tint_bitcast_to_f16_1(((((((16u + start_byte_offset) % 16u) / 4u) == 2u)) ? (v_10.zw) : (v_10.xy)));
  uint4 v_12 = u[((24u + start_byte_offset) / 16u)];
  return matrix<float16_t, 4, 4>(v_7, v_9, v_11, tint_bitcast_to_f16_1(((((((24u + start_byte_offset) % 16u) / 4u) == 2u)) ? (v_12.zw) : (v_12.xy))));
}
...
ary_ret v_13(uint start_byte_offset) {
  matrix<float16_t, 4, 4> a[4] = (matrix<float16_t, 4, 4>[4])0;
  {
    ...
    while(true) {
      ...
      a[v_15] = v_5((start_byte_offset + (v_15 * 32u)));
      {
        v_14 = (v_15 + 1u);
      }
      continue;
...
void f_inner(uint tint_local_index) {
  {
    ...
    while(true) {
      ...
      w[v_18] = matrix<float16_t, 4, 4>((float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx, (float16_t(0.0h)).xxxx);
      {
        v_17 = (v_18 + 1u);
      }
      continue;
  ...
  matrix<float16_t, 4, 4> v_19[4] = v_13(0u);
  w = v_19;
  w[1u] = v_5(64u);
