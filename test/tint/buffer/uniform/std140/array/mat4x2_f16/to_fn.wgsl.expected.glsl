...
void f() {
  float16_t tint_symbol = a(conv_arr4_mat4x2_f16(u.inner));
  float16_t tint_symbol_1 = b(conv_mat4x2_f16(u.inner[1u]));
  float16_t tint_symbol_2 = c(u.inner[1u].col0.yx);
  float16_t tint_symbol_3 = d(u.inner[1u].col0.yx[0u]);
