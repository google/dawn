...
ary_ret v_7(uint start_byte_offset) {
  ...
  matrix<float16_t, 2, 4> v_10[4] = a_1;
  return v_10;
}
...
void f() {
  ...
  matrix<float16_t, 2, 4> l_a[4] = v_7(0u);
  matrix<float16_t, 2, 4> l_a_i = v_2(v_11);
  uint v_13 = (v_11 + v_12);
  uint4 v_14 = a[(v_13 / 16u)];
  vector<float16_t, 4> l_a_i_i = tint_bitcast_to_f16(select((((v_13 & 15u) >> 2u) == 2u), v_14.zw, v_14.xy));
  uint v_15 = (v_11 + v_12);
