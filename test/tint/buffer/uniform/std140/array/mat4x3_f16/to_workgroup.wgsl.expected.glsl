...
f16mat4x3 v_1(uint start_byte_offset) {
  ...
  f16vec3 v_3 = tint_bitcast_to_f16_1(mix(v_2.xy, v_2.zw, bvec2((((start_byte_offset % 16u) / 4u) == 2u)))).xyz;
  uvec4 v_4 = v.inner[((8u + start_byte_offset) / 16u)];
  f16vec3 v_5 = tint_bitcast_to_f16_1(mix(v_4.xy, v_4.zw, bvec2(((((8u + start_byte_offset) % 16u) / 4u) == 2u)))).xyz;
  uvec4 v_6 = v.inner[((16u + start_byte_offset) / 16u)];
  f16vec3 v_7 = tint_bitcast_to_f16_1(mix(v_6.xy, v_6.zw, bvec2(((((16u + start_byte_offset) % 16u) / 4u) == 2u)))).xyz;
  uvec4 v_8 = v.inner[((24u + start_byte_offset) / 16u)];
  return f16mat4x3(v_3, v_5, v_7, tint_bitcast_to_f16_1(mix(v_8.xy, v_8.zw, bvec2(((((24u + start_byte_offset) % 16u) / 4u) == 2u)))).xyz);
}
f16mat4x3[4] v_9(uint start_byte_offset) {
...
void f_inner(uint tint_local_index) {
  {
    ...
    while(true) {
      ...
      w[v_13] = f16mat4x3(f16vec3(0.0hf), f16vec3(0.0hf), f16vec3(0.0hf), f16vec3(0.0hf));
      {
        v_12 = (v_13 + 1u);
      }
      continue;
  ...
  w = v_9(0u);
  w[1u] = v_1(64u);
  w[1u][0u] = tint_bitcast_to_f16_1(v.inner[0u].zw).xyz.zxy;
  uvec4 v_14 = v.inner[0u];
  w[1u][0u].x = tint_bitcast_to_f16(v_14.z).x;
}
