...
void main() {
  f16mat4x3 l_a[4] = v_10(0u);
  f16mat4x3 l_a_i = v_2(64u);
  f16vec3 l_a_i_i = tint_bitcast_to_f16(v.inner[4u].zw).xyz;
  uvec4 v_13 = v.inner[4u];
  v_1.inner = (((tint_bitcast_to_f16_1(v_13.z).x + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x);
}
