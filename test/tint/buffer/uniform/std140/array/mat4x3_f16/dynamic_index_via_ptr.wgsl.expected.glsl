...
void main() {
  ...
  f16mat4x3 l_a[4] = v_11(0u);
  f16mat4x3 l_a_i = v_3(v_14);
  uvec4 v_16 = v.inner[((v_14 + v_15) / 16u)];
  f16vec3 l_a_i_i = tint_bitcast_to_f16(mix(v_16.xy, v_16.zw, bvec2(((((v_14 + v_15) & 15u) >> 2u) == 2u)))).xyz;
  uvec4 v_17 = v.inner[((v_14 + v_15) / 16u)];
  v_1.inner = (((tint_bitcast_to_f16_1(v_17[(((v_14 + v_15) & 15u) >> 2u)])[mix(1u, 0u, (((v_14 + v_15) % 4u) == 0u))] + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x);
}
