...
ary_ret v_7(uint start_byte_offset) {
  ...
  matrix<float16_t, 2, 3> v_10[4] = a_2;
  return v_10;
}

[numthreads(1, 1, 1)]
void f() {
  matrix<float16_t, 2, 3> v_11[4] = v_7(0u);
  float16_t v_12 = a(v_11);
  float16_t v_13 = (v_12 + b(v_2(16u)));
  float16_t v_14 = (v_13 + c(tint_bitcast_to_f16_1(u[1u].xy).xyz.zxy));
  s.Store<float16_t>(0u, (v_14 + d(tint_bitcast_to_f16(u[1u].y).x)));
}
