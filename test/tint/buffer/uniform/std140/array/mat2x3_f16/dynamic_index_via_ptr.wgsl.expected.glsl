...
void main() {
  ...
  f16mat2x3 l_a[4] = v_8(0u);
  f16mat2x3 l_a_i = v_3(v_11);
  uint v_13 = (v_11 + v_12);
  uvec4 v_14 = v.inner[(v_13 / 16u)];
  f16vec3 l_a_i_i = tint_bitcast_to_16bit(mix(v_14.xy, v_14.zw, bvec2((((v_13 & 15u) >> 2u) == 2u)))).xyz;
  uint v_15 = (v_11 + v_12);
  uvec4 v_16 = v.inner[(v_15 / 16u)];
  v_1.inner = (((tint_bitcast_to_16bit_1(v_16[((v_15 & 15u) >> 2u)])[mix(1u, 0u, ((v_15 % 4u) == 0u))] + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x);
}
