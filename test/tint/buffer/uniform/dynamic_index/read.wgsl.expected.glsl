...
void main_inner(uint idx) {
  uvec4 v_29 = v.inner[((idx * 544u) / 16u)];
  float scalar_f32 = uintBitsToFloat(v_29[(((idx * 544u) & 15u) >> 2u)]);
  uvec4 v_30 = v.inner[((4u + (idx * 544u)) / 16u)];
  int scalar_i32 = int(v_30[(((4u + (idx * 544u)) & 15u) >> 2u)]);
  uvec4 v_31 = v.inner[((8u + (idx * 544u)) / 16u)];
  uint scalar_u32 = v_31[(((8u + (idx * 544u)) & 15u) >> 2u)];
  uvec4 v_32 = v.inner[((16u + (idx * 544u)) / 16u)];
  vec2 vec2_f32 = uintBitsToFloat(mix(v_32.xy, v_32.zw, bvec2(((((16u + (idx * 544u)) & 15u) >> 2u) == 2u))));
  uvec4 v_33 = v.inner[((24u + (idx * 544u)) / 16u)];
  ivec2 vec2_i32 = ivec2(mix(v_33.xy, v_33.zw, bvec2(((((24u + (idx * 544u)) & 15u) >> 2u) == 2u))));
  uvec4 v_34 = v.inner[((32u + (idx * 544u)) / 16u)];
  uvec2 vec2_u32 = mix(v_34.xy, v_34.zw, bvec2(((((32u + (idx * 544u)) & 15u) >> 2u) == 2u)));
  ...
  mat2 mat2x2_f32 = v_25((144u + (idx * 544u)));
  mat2x3 mat2x3_f32 = v_24((160u + (idx * 544u)));
  mat2x4 mat2x4_f32 = v_23((192u + (idx * 544u)));
  mat3x2 mat3x2_f32 = v_17((224u + (idx * 544u)));
  mat3 mat3x3_f32 = v_16((256u + (idx * 544u)));
  mat3x4 mat3x4_f32 = v_15((304u + (idx * 544u)));
