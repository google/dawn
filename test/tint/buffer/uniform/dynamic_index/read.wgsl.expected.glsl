...
mat4x2 v_7(uint start_byte_offset) {
  ...
  vec2 v_11 = uintBitsToFloat(mix(v_10.xy, v_10.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_12 = v.inner[((16u + start_byte_offset) / 16u)];
  vec2 v_13 = uintBitsToFloat(mix(v_12.xy, v_12.zw, bvec2(((((16u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_14 = v.inner[((24u + start_byte_offset) / 16u)];
  return mat4x2(v_9, v_11, v_13, uintBitsToFloat(mix(v_14.xy, v_14.zw, bvec2(((((24u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
...
mat2 v_25(uint start_byte_offset) {
  ...
  vec2 v_27 = uintBitsToFloat(mix(v_26.xy, v_26.zw, bvec2((((start_byte_offset & 15u) >> 2u) == 2u))));
  uvec4 v_28 = v.inner[((8u + start_byte_offset) / 16u)];
  return mat2(v_27, uintBitsToFloat(mix(v_28.xy, v_28.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
void main_inner(uint idx) {
  uvec4 v_29 = v.inner[((544u * idx) / 16u)];
  float scalar_f32 = uintBitsToFloat(v_29[(((544u * idx) & 15u) >> 2u)]);
  uvec4 v_30 = v.inner[((4u + (544u * idx)) / 16u)];
  int scalar_i32 = int(v_30[(((4u + (544u * idx)) & 15u) >> 2u)]);
  uvec4 v_31 = v.inner[((8u + (544u * idx)) / 16u)];
  uint scalar_u32 = v_31[(((8u + (544u * idx)) & 15u) >> 2u)];
  uvec4 v_32 = v.inner[((16u + (544u * idx)) / 16u)];
  vec2 vec2_f32 = uintBitsToFloat(mix(v_32.xy, v_32.zw, bvec2(((((16u + (544u * idx)) & 15u) >> 2u) == 2u))));
  uvec4 v_33 = v.inner[((24u + (544u * idx)) / 16u)];
  ivec2 vec2_i32 = ivec2(mix(v_33.xy, v_33.zw, bvec2(((((24u + (544u * idx)) & 15u) >> 2u) == 2u))));
  uvec4 v_34 = v.inner[((32u + (544u * idx)) / 16u)];
  uvec2 vec2_u32 = mix(v_34.xy, v_34.zw, bvec2(((((32u + (544u * idx)) & 15u) >> 2u) == 2u)));
  vec3 vec3_f32 = uintBitsToFloat(v.inner[((48u + (544u * idx)) / 16u)].xyz);
  ivec3 vec3_i32 = ivec3(v.inner[((64u + (544u * idx)) / 16u)].xyz);
  uvec3 vec3_u32 = v.inner[((80u + (544u * idx)) / 16u)].xyz;
  vec4 vec4_f32 = uintBitsToFloat(v.inner[((96u + (544u * idx)) / 16u)]);
  ivec4 vec4_i32 = ivec4(v.inner[((112u + (544u * idx)) / 16u)]);
  uvec4 vec4_u32 = v.inner[((128u + (544u * idx)) / 16u)];
  mat2 mat2x2_f32 = v_25((144u + (544u * idx)));
  mat2x3 mat2x3_f32 = v_24((160u + (544u * idx)));
  mat2x4 mat2x4_f32 = v_23((192u + (544u * idx)));
  mat3x2 mat3x2_f32 = v_17((224u + (544u * idx)));
  mat3 mat3x3_f32 = v_16((256u + (544u * idx)));
  mat3x4 mat3x4_f32 = v_15((304u + (544u * idx)));
  mat4x2 mat4x2_f32 = v_7((352u + (544u * idx)));
  mat4x3 mat4x3_f32 = v_6((384u + (544u * idx)));
  mat4 mat4x4_f32 = v_5((448u + (544u * idx)));
  vec3 arr2_vec3_f32[2] = v_2((512u + (544u * idx)));
