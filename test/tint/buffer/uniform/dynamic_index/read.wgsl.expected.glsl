...
void main_inner(uint idx) {
  ...
  int v_73 = tint_f32_to_i32(mat2x2_f32[0].x);
  uint v_74 = uint(v_72);
  int v_75 = int((v_74 + uint(v_73)));
  int v_76 = tint_f32_to_i32(mat2x3_f32[0].x);
  uint v_77 = uint(v_75);
  int v_78 = int((v_77 + uint(v_76)));
  int v_79 = tint_f32_to_i32(mat2x4_f32[0].x);
  uint v_80 = uint(v_78);
  int v_81 = int((v_80 + uint(v_79)));
  int v_82 = tint_f32_to_i32(mat3x2_f32[0].x);
  uint v_83 = uint(v_81);
  int v_84 = int((v_83 + uint(v_82)));
  int v_85 = tint_f32_to_i32(mat3x3_f32[0].x);
  uint v_86 = uint(v_84);
  int v_87 = int((v_86 + uint(v_85)));
  int v_88 = tint_f32_to_i32(mat3x4_f32[0].x);
  uint v_89 = uint(v_87);
  int v_90 = int((v_89 + uint(v_88)));
  int v_91 = tint_f32_to_i32(mat4x2_f32[0].x);
  uint v_92 = uint(v_90);
  int v_93 = int((v_92 + uint(v_91)));
  int v_94 = tint_f32_to_i32(mat4x3_f32[0].x);
  uint v_95 = uint(v_93);
  int v_96 = int((v_95 + uint(v_94)));
  int v_97 = tint_f32_to_i32(mat4x4_f32[0].x);
  uint v_98 = uint(v_96);
  int v_99 = int((v_98 + uint(v_97)));
  int v_100 = tint_f32_to_i32(arr2_vec3_f32[0].x);
