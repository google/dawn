...
void main_inner(uint idx) {
  ...
  float2 vec2_f32 = asfloat(((((((16u + (800u * min(idx, 7u))) % 16u) / 4u) == 2u)) ? (v_84.zw) : (v_84.xy)));
  uint4 v_85 = ub[((24u + (800u * min(idx, 7u))) / 16u)];
  int2 vec2_i32 = asint(((((((24u + (800u * min(idx, 7u))) % 16u) / 4u) == 2u)) ? (v_85.zw) : (v_85.xy)));
  uint4 v_86 = ub[((32u + (800u * min(idx, 7u))) / 16u)];
  uint2 vec2_u32 = ((((((32u + (800u * min(idx, 7u))) % 16u) / 4u) == 2u)) ? (v_86.zw) : (v_86.xy));
  ...
  vector<float16_t, 3> vec3_f16 = tint_bitcast_to_f16_1(((((((96u + (800u * min(idx, 7u))) % 16u) / 4u) == 2u)) ? (v_87.zw) : (v_87.xy))).xyz;
  ...
  vector<float16_t, 4> vec4_f16 = tint_bitcast_to_f16_1(((((((160u + (800u * min(idx, 7u))) % 16u) / 4u) == 2u)) ? (v_88.zw) : (v_88.xy)));
