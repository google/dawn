...
void main_inner(uint idx) {
  ...
  int v_89 = (tint_f32_to_i32(scalar_f32) + scalar_i32);
  int v_90 = (v_89 + int(scalar_u32));
  int v_91 = (v_90 + tint_f16_to_i32(scalar_f16));
  int v_92 = ((v_91 + tint_f32_to_i32(vec2_f32.x)) + vec2_i32.x);
  int v_93 = (v_92 + int(vec2_u32.x));
  int v_94 = (v_93 + tint_f16_to_i32(vec2_f16.x));
  int v_95 = ((v_94 + tint_f32_to_i32(vec3_f32.y)) + vec3_i32.y);
  int v_96 = (v_95 + int(vec3_u32.y));
  int v_97 = (v_96 + tint_f16_to_i32(vec3_f16.y));
  int v_98 = ((v_97 + tint_f32_to_i32(vec4_f32.z)) + vec4_i32.z);
  int v_99 = (v_98 + int(vec4_u32.z));
  int v_100 = (v_99 + tint_f16_to_i32(vec4_f16.z));
  int v_101 = (v_100 + tint_f32_to_i32(mat2x2_f32[0u].x));
  int v_102 = (v_101 + tint_f32_to_i32(mat2x3_f32[0u].x));
  int v_103 = (v_102 + tint_f32_to_i32(mat2x4_f32[0u].x));
  int v_104 = (v_103 + tint_f32_to_i32(mat3x2_f32[0u].x));
  int v_105 = (v_104 + tint_f32_to_i32(mat3x3_f32[0u].x));
  int v_106 = (v_105 + tint_f32_to_i32(mat3x4_f32[0u].x));
  int v_107 = (v_106 + tint_f32_to_i32(mat4x2_f32[0u].x));
  int v_108 = (v_107 + tint_f32_to_i32(mat4x3_f32[0u].x));
  int v_109 = (v_108 + tint_f32_to_i32(mat4x4_f32[0u].x));
  int v_110 = (v_109 + tint_f16_to_i32(mat2x2_f16[0u].x));
  int v_111 = (v_110 + tint_f16_to_i32(mat2x3_f16[0u].x));
  int v_112 = (v_111 + tint_f16_to_i32(mat2x4_f16[0u].x));
  int v_113 = (v_112 + tint_f16_to_i32(mat3x2_f16[0u].x));
  int v_114 = (v_113 + tint_f16_to_i32(mat3x3_f16[0u].x));
  int v_115 = (v_114 + tint_f16_to_i32(mat3x4_f16[0u].x));
  int v_116 = (v_115 + tint_f16_to_i32(mat4x2_f16[0u].x));
  int v_117 = (v_116 + tint_f16_to_i32(mat4x3_f16[0u].x));
  int v_118 = (v_117 + tint_f16_to_i32(mat4x4_f16[0u].x));
  int v_119 = (v_118 + tint_f32_to_i32(arr2_vec3_f32[0u].x));
  s.Store(0u, asuint((v_119 + tint_f16_to_i32(arr2_mat4x2_f16[0u][0u].x))));
}
