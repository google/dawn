...
void main_inner(uint idx) {
  float scalar_f32 = asfloat(ub[((544u * idx) / 16u)][(((544u * idx) & 15u) >> 2u)]);
  int scalar_i32 = asint(ub[((4u + (544u * idx)) / 16u)][(((4u + (544u * idx)) & 15u) >> 2u)]);
  uint scalar_u32 = ub[((8u + (544u * idx)) / 16u)][(((8u + (544u * idx)) & 15u) >> 2u)];
  uint4 v_28 = ub[((16u + (544u * idx)) / 16u)];
  float2 vec2_f32 = asfloat(((((((16u + (544u * idx)) & 15u) >> 2u) == 2u)) ? (v_28.zw) : (v_28.xy)));
  uint4 v_29 = ub[((24u + (544u * idx)) / 16u)];
  int2 vec2_i32 = asint(((((((24u + (544u * idx)) & 15u) >> 2u) == 2u)) ? (v_29.zw) : (v_29.xy)));
  uint4 v_30 = ub[((32u + (544u * idx)) / 16u)];
  uint2 vec2_u32 = ((((((32u + (544u * idx)) & 15u) >> 2u) == 2u)) ? (v_30.zw) : (v_30.xy));
  float3 vec3_f32 = asfloat(ub[((48u + (544u * idx)) / 16u)].xyz);
  int3 vec3_i32 = asint(ub[((64u + (544u * idx)) / 16u)].xyz);
  uint3 vec3_u32 = ub[((80u + (544u * idx)) / 16u)].xyz;
  float4 vec4_f32 = asfloat(ub[((96u + (544u * idx)) / 16u)]);
  int4 vec4_i32 = asint(ub[((112u + (544u * idx)) / 16u)]);
  uint4 vec4_u32 = ub[((128u + (544u * idx)) / 16u)];
  float2x2 mat2x2_f32 = v_24((144u + (544u * idx)));
  float2x3 mat2x3_f32 = v_23((160u + (544u * idx)));
  float2x4 mat2x4_f32 = v_22((192u + (544u * idx)));
  float3x2 mat3x2_f32 = v_16((224u + (544u * idx)));
  float3x3 mat3x3_f32 = v_15((256u + (544u * idx)));
  float3x4 mat3x4_f32 = v_14((304u + (544u * idx)));
  float4x2 mat4x2_f32 = v_6((352u + (544u * idx)));
  float4x3 mat4x3_f32 = v_5((384u + (544u * idx)));
  float4x4 mat4x4_f32 = v_4((448u + (544u * idx)));
  float3 arr2_vec3_f32[2] = v((512u + (544u * idx)));
  int v_31 = asint((asuint(tint_f32_to_i32(scalar_f32)) + asuint(scalar_i32)));
  int v_32 = asint((asuint(v_31) + asuint(int(scalar_u32))));
  ...
  int v_35 = asint((asuint(asint((asuint(v_34) + asuint(tint_f32_to_i32(vec3_f32.y))))) + asuint(vec3_i32.y)));
  int v_36 = asint((asuint(v_35) + asuint(int(vec3_u32.y))));
  int v_37 = asint((asuint(asint((asuint(v_36) + asuint(tint_f32_to_i32(vec4_f32.z))))) + asuint(vec4_i32.z)));
  int v_38 = asint((asuint(v_37) + asuint(int(vec4_u32.z))));
  int v_39 = asint((asuint(v_38) + asuint(tint_f32_to_i32(mat2x2_f32[0u].x))));
  int v_40 = asint((asuint(v_39) + asuint(tint_f32_to_i32(mat2x3_f32[0u].x))));
  int v_41 = asint((asuint(v_40) + asuint(tint_f32_to_i32(mat2x4_f32[0u].x))));
  int v_42 = asint((asuint(v_41) + asuint(tint_f32_to_i32(mat3x2_f32[0u].x))));
  int v_43 = asint((asuint(v_42) + asuint(tint_f32_to_i32(mat3x3_f32[0u].x))));
  int v_44 = asint((asuint(v_43) + asuint(tint_f32_to_i32(mat3x4_f32[0u].x))));
  int v_45 = asint((asuint(v_44) + asuint(tint_f32_to_i32(mat4x2_f32[0u].x))));
  int v_46 = asint((asuint(v_45) + asuint(tint_f32_to_i32(mat4x3_f32[0u].x))));
  int v_47 = asint((asuint(v_46) + asuint(tint_f32_to_i32(mat4x4_f32[0u].x))));
  s.Store(0u, asuint(asint((asuint(v_47) + asuint(tint_f32_to_i32(arr2_vec3_f32[0u].x))))));
}
