...
void main_inner(uint idx) {
  ...
  float scalar_f32 = uintBitsToFloat(v_77[(((800u * min(idx, 7u)) & 15u) >> 2u)]);
  uvec4 v_78 = v.inner[((4u + (800u * min(idx, 7u))) / 16u)];
  int scalar_i32 = int(v_78[(((4u + (800u * min(idx, 7u))) & 15u) >> 2u)]);
  uvec4 v_79 = v.inner[((8u + (800u * min(idx, 7u))) / 16u)];
  uint scalar_u32 = v_79[(((8u + (800u * min(idx, 7u))) & 15u) >> 2u)];
  uvec4 v_80 = v.inner[((12u + (800u * min(idx, 7u))) / 16u)];
  float16_t scalar_f16 = tint_bitcast_to_f16(v_80[(((12u + (800u * min(idx, 7u))) & 15u) >> 2u)])[mix(1u, 0u, (((12u + (800u * min(idx, 7u))) % 4u) == 0u))];
  uvec4 v_81 = v.inner[((16u + (800u * min(idx, 7u))) / 16u)];
  vec2 vec2_f32 = uintBitsToFloat(mix(v_81.xy, v_81.zw, bvec2(((((16u + (800u * min(idx, 7u))) & 15u) >> 2u) == 2u))));
  uvec4 v_82 = v.inner[((24u + (800u * min(idx, 7u))) / 16u)];
  ivec2 vec2_i32 = ivec2(mix(v_82.xy, v_82.zw, bvec2(((((24u + (800u * min(idx, 7u))) & 15u) >> 2u) == 2u))));
  uvec4 v_83 = v.inner[((32u + (800u * min(idx, 7u))) / 16u)];
  uvec2 vec2_u32 = mix(v_83.xy, v_83.zw, bvec2(((((32u + (800u * min(idx, 7u))) & 15u) >> 2u) == 2u)));
  f16vec2 vec2_f16 = tint_bitcast_to_f16(v.inner[((40u + (800u * min(idx, 7u))) / 16u)][(((40u + (800u * min(idx, 7u))) & 15u) >> 2u)]);
  ...
  f16vec3 vec3_f16 = tint_bitcast_to_f16_1(mix(v_84.xy, v_84.zw, bvec2(((((96u + (800u * min(idx, 7u))) & 15u) >> 2u) == 2u)))).xyz;
  ...
  f16vec4 vec4_f16 = tint_bitcast_to_f16_1(mix(v_85.xy, v_85.zw, bvec2(((((160u + (800u * min(idx, 7u))) & 15u) >> 2u) == 2u))));
