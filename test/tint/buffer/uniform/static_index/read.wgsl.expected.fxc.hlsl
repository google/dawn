...
void main() {
  ...
  s.Store(0u, asuint(asint((asuint(asint((asuint(asint((asuint(v_58) + asuint(tint_f32_to_i32(arr2_vec3_f32[int(0)].x))))) + asuint(struct_inner.scalar_i32)))) + asuint(array_struct_inner[int(0)].scalar_i32)))));
}
