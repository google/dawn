...
void main() {
  ...
  v.x = (v.x + 500u);
  buf.Load4(0u);
  uint4 v_9 = uint4((0u).xxxx.x, (0u).xxxx.y, (0u).xxxx.z, (0u).xxxx.w);
  buf.Store4(0u, (0u).xxxx);
  uint4 v_10 = buf.Load4(0u);
  buf.Store4(0u, uint4(v_10.x, uint2(1u, 2u).y, uint2(1u, 2u).x, v_10.w));
  uint4 v_11 = buf.Load4(0u);
  buf.Store4(0u, uint4(v_11.x, uint2(3u, 4u).y, uint2(3u, 4u).x, v_11.w));
  buf.Store(8u, 5u);
  uint3 v_12 = (buf.Load4(0u).xyz + (10u).xxx);
  buf.Store4(0u, uint4(v_12.x, v_12.y, v_12.z, buf.Load4(0u).w));
  buf.Store(4u, 5u);
