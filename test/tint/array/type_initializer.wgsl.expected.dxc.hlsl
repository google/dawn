...
void main() {
  ...
  int nonempty_with_expr[4] = {int(1), x, asint((asuint(x) + asuint(int(1)))), nonempty[3u]};
  ...
  int v[4] = {int(1), int(2), x, asint((asuint(x) + asuint(int(1))))};
  int v_1[4] = {int(5), int(6), nonempty[2u], asint((asuint(nonempty[3u]) + asuint(int(1))))};
  ...
  int v_4[4] = {int(1), x, asint((asuint(x) + asuint(int(1)))), nonempty[3u]};
  ...
  int v_5[4] = {int(1), x, asint((asuint(x) + asuint(int(1)))), nonempty[3u]};
