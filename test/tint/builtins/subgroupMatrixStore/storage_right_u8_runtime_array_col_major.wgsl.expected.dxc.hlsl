...
void main() {
  ...
  m.Store(out0, (0u + (select(v_4, 0u, 0u) * 4u)), (select(v_4, 16u, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_5 = 0u;
  ...
  m.Store(out1, (0u + (select(v_9, 0u, 0u) * 8u)), (select(v_9, 16u, 1u) * 8u), MatrixLayout::ColMajor);
  uint v_10 = 0u;
  ...
  m.Store(out4, (0u + (select(v_24, 0u, 0u) * 2u)), (select(v_24, 16u, 4u) * 2u), MatrixLayout::ColMajor);
  uint v_25 = 0u;
  ...
  m.Store(out5, (0u + (select(v_29, 0u, 0u) * 4u)), (select(v_29, 16u, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_30 = 0u;
  ...
  m.Store(out6, (0u + (select(v_34, 0u, 0u) * 8u)), (select(v_34, 16u, 1u) * 8u), MatrixLayout::ColMajor);
}
