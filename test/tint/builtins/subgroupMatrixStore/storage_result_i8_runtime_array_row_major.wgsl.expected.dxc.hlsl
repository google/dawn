...
void main() {
  ...
  m.Store(out1, (0u + (select(v_5, v_4, 0u) * 8u)), (select(v_5, 16u, 1u) * 8u), MatrixLayout::RowMajor);
  uint v_6 = 0u;
  out2.GetDimensions(v_6);
  uint v_7 = asuint(int(0));
  bool v_8 = (((v_7 + (16u * 7u)) + 1u) <= (v_6 / 16u));
  m.Store(out2, (0u + (select(v_8, v_7, 0u) * 16u)), (select(v_8, 16u, 1u) * 16u), MatrixLayout::RowMajor);
  uint v_9 = 0u;
  out3.GetDimensions(v_9);
  uint v_10 = asuint(int(0));
  bool v_11 = (((v_10 + (16u * 7u)) + 1u) <= (v_9 / 16u));
  m.Store(out3, (0u + (select(v_11, v_10, 0u) * 16u)), (select(v_11, 16u, 1u) * 16u), MatrixLayout::RowMajor);
  uint v_12 = 0u;
  out4.GetDimensions(v_12);
  uint v_13 = asuint(int(0));
  bool v_14 = (((v_13 + (16u * 7u)) + 4u) <= (v_12 / 2u));
  m.Store(out4, (0u + (select(v_14, v_13, 0u) * 2u)), (select(v_14, 16u, 4u) * 2u), MatrixLayout::RowMajor);
  uint v_15 = 0u;
  ...
  m.Store(out6, (0u + (select(v_20, v_19, 0u) * 8u)), (select(v_20, 16u, 1u) * 8u), MatrixLayout::RowMajor);
}
