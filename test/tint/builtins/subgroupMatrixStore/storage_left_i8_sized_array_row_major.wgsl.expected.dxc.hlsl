...
[numthreads(64, 1, 1)]
void main() {
  Matrix_left_i8_8x8 m = Matrix_left_i8_8x8::Splat(int(0));
  m.Store(out0, 0u, 64u, MatrixLayout::RowMajor);
  m.Store(out1, 0u, 64u, MatrixLayout::RowMajor);
  m.Store(out2, 0u, 64u, MatrixLayout::RowMajor);
  m.Store(out3, 0u, 64u, MatrixLayout::RowMajor);
  m.Store(out4, 0u, 64u, MatrixLayout::RowMajor);
  m.Store(out5, 0u, 64u, MatrixLayout::RowMajor);
  m.Store(out6, 0u, 64u, MatrixLayout::RowMajor);
}
