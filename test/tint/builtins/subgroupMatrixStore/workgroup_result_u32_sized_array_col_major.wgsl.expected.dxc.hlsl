...
<built-in:hlsl>/dx/linalg.h:341:52: error: cannot initialize a parameter of type 'unsigned int const __attribute__((address_space(3))) (&)[1024]' with an lvalue of type 'vector<unsigned int, 2> __attribute__((address_space(3)))[1024]'
    __builtin_LinAlg_MatrixStoreToMemory(__handle, Arr, StartIdx, Stride,
                                                   ^~~
hlsl.hlsl:48:5: note: in instantiation of function template specialization 'dx::linalg::Matrix<dx::linalg::ComponentType::ComponentEnum::U32, 8, 8, dx::linalg::MatrixUse::MatrixUseEnum::Accumulator, dx::linalg::MatrixScope::MatrixScopeEnum::Wave>::Store<vector<unsigned int, 2>, 1024>' requested here
...
<built-in:hlsl>/dx/linalg.h:341:52: error: cannot initialize a parameter of type 'unsigned int const __attribute__((address_space(3))) (&)[1024]' with an lvalue of type 'vector<unsigned int, 4> __attribute__((address_space(3)))[1024]'
    __builtin_LinAlg_MatrixStoreToMemory(__handle, Arr, StartIdx, Stride,
                                                   ^~~
hlsl.hlsl:50:5: note: in instantiation of function template specialization 'dx::linalg::Matrix<dx::linalg::ComponentType::ComponentEnum::U32, 8, 8, dx::linalg::MatrixUse::MatrixUseEnum::Accumulator, dx::linalg::MatrixScope::MatrixScopeEnum::Wave>::Store<vector<unsigned int, 4>, 1024>' requested here
