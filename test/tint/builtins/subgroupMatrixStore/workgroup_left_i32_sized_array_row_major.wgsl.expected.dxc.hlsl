...
=========================================================
:91:19 error: Store: no matching call to 'Store(subgroup_matrix_left<i32, 8, 8>, ptr<workgroup, array<vec2<i32>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
5 candidate functions:
 ...
 • 'Store(byte_address_buffer<write' or 'read_write>  ✗ , offset: u32  ✗ , value: u32  ✓ )'
    ...
    %58:void = %m.Store %out1, 0u, 16u, 0u
                  ^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %55:subgroup_matrix_left<i32, 8, 8> = construct
    %m:subgroup_matrix_left<i32, 8, 8> = let %55
    %57:void = %m.Store %out0, 0u, 16u, 0u
    %58:void = %m.Store %out1, 0u, 16u, 0u
    %59:u32 = div 0u, 4u
    %60:u32 = mul 0u, 16u
    %61:u32 = div %60, 4u
    ...
    %63:u32 = mul 16u, 16u
    %64:u32 = div %63, 4u
    %65:void = %m.Store %out2, %62, %64, 0u
    %66:void = %m.Store %out3, 0u, 16u, 0u
    %67:u32 = div 0u, 2u
    %68:u32 = mul 0u, 4u
    %69:u32 = div %68, 2u
    %70:u32 = add %67, %69
