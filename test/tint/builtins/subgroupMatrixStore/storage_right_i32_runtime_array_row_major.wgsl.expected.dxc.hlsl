...
[numthreads(64, 1, 1)]
void main() {
  Matrix_right_i32_8x8 m = Matrix_right_i32_8x8::Splat(int(0));
  uint v = 0u;
  ...
  m.Store(out0, (0u + (select(v_4, 0u, 0u) * 4u)), (select(v_4, 16u, 8u) * 4u), MatrixLayout::RowMajor);
  uint v_5 = 0u;
  ...
  m.Store(out1, (0u + (select(v_9, 0u, 0u) * 8u)), (select(v_9, 16u, 4u) * 8u), MatrixLayout::RowMajor);
  uint v_10 = 0u;
  ...
  m.Store(out2, (0u + (select(v_14, 0u, 0u) * 16u)), (select(v_14, 16u, 2u) * 16u), MatrixLayout::RowMajor);
  uint v_15 = 0u;
  ...
  m.Store(out3, (0u + (select(v_19, 0u, 0u) * 16u)), (select(v_19, 16u, 2u) * 16u), MatrixLayout::RowMajor);
  uint v_20 = 0u;
  ...
  m.Store(out5, (0u + (select(v_24, 0u, 0u) * 4u)), (select(v_24, 16u, 8u) * 4u), MatrixLayout::RowMajor);
  uint v_25 = 0u;
  ...
  m.Store(out6, (0u + (select(v_29, 0u, 0u) * 8u)), (select(v_29, 16u, 4u) * 8u), MatrixLayout::RowMajor);
}
