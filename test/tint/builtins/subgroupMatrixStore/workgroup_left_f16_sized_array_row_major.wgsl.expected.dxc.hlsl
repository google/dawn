...
=========================================================
:85:19 error: Store: no matching call to 'Store(subgroup_matrix_left<f16, 8, 8>, ptr<workgroup, array<vec2<f16>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
5 candidate functions:
 ...
 • 'Store(byte_address_buffer<write' or 'read_write>  ✗ , offset: u32  ✗ , value: u32  ✓ )'
    ...
    %54:void = %m.Store %out5, 0u, 16u, 0u
                  ^^^^^
...
:86:19 error: Store: no matching call to 'Store(subgroup_matrix_left<f16, 8, 8>, ptr<workgroup, array<vec3<f16>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
5 candidate functions:
 ...
 • 'Store(byte_address_buffer<write' or 'read_write>  ✗ , offset: u32  ✗ , value: u32  ✓ )'
    ...
    %55:void = %m.Store %out6, 0u, 16u, 0u
                  ^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %41:subgroup_matrix_left<f16, 8, 8> = construct
    %m:subgroup_matrix_left<f16, 8, 8> = let %41
    %43:void = %m.Store %out0, 0u, 16u, 0u
    %44:void = %m.Store %out1, 0u, 16u, 0u
    %45:u32 = div 0u, 4u
    %46:u32 = mul 0u, 16u
    %47:u32 = div %46, 4u
    %48:u32 = add %45, %47
    %49:u32 = mul 16u, 16u
    %50:u32 = div %49, 4u
    %51:void = %m.Store %out2, %48, %50, 0u
    %52:void = %m.Store %out3, 0u, 16u, 0u
    %53:void = %m.Store %out4, 0u, 16u, 0u
    %54:void = %m.Store %out5, 0u, 16u, 0u
    %55:void = %m.Store %out6, 0u, 16u, 0u
    ret
  }
