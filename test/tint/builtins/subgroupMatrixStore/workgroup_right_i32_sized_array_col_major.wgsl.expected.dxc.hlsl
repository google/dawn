...
=========================================================
:91:19 error: Store: no matching call to 'Store(subgroup_matrix_right<i32, 8, 8>, ptr<workgroup, array<vec2<i32>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %55:subgroup_matrix_right<i32, 8, 8> = construct
    %m:subgroup_matrix_right<i32, 8, 8> = let %55
