...
=========================================================
:85:19 error: Store: no matching call to 'Store(subgroup_matrix_left<f32, 8, 8>, ptr<workgroup, array<vec3<f32>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
5 candidate functions:
 ...
 • 'Store(byte_address_buffer<write' or 'read_write>  ✗ , offset: u32  ✗ , value: u32  ✓ )'
    ...
    %54:void = %m.Store %out2, %53, 16u, 1u
                  ^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %47:subgroup_matrix_left<f32, 8, 8> = construct
    %m:subgroup_matrix_left<f32, 8, 8> = let %47
    %49:u32 = hlsl.asuint 0i
    %50:void = %m.Store %out0, %49, 16u, 1u
    %51:u32 = hlsl.asuint 0i
    %52:void = %m.Store %out1, %51, 16u, 1u
    %53:u32 = hlsl.asuint 0i
    %54:void = %m.Store %out2, %53, 16u, 1u
    %55:u32 = hlsl.asuint 0i
    %56:void = %m.Store %out3, %55, 16u, 1u
    %57:u32 = div 0u, 2u
