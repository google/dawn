...
void main() {
  ...
  bool v_1 = (116u <= (v / 4u));
  m.Store(out0, (0u + (select(v_1, 0u, 0u) * 4u)), (select(v_1, 16u, 4u) * 4u), MatrixLayout::ColMajor);
  uint v_2 = 0u;
  out1.GetDimensions(v_2);
  bool v_3 = (114u <= (v_2 / 8u));
  m.Store(out1, (0u + (select(v_3, 0u, 0u) * 8u)), (select(v_3, 16u, 2u) * 8u), MatrixLayout::ColMajor);
  uint v_4 = 0u;
  out2.GetDimensions(v_4);
  bool v_5 = (113u <= (v_4 / 16u));
  m.Store(out2, (0u + (select(v_5, 0u, 0u) * 16u)), (select(v_5, 16u, 1u) * 16u), MatrixLayout::ColMajor);
  uint v_6 = 0u;
  out3.GetDimensions(v_6);
  bool v_7 = (113u <= (v_6 / 16u));
  m.Store(out3, (0u + (select(v_7, 0u, 0u) * 16u)), (select(v_7, 16u, 1u) * 16u), MatrixLayout::ColMajor);
  uint v_8 = 0u;
  out4.GetDimensions(v_8);
  bool v_9 = (120u <= (v_8 / 2u));
  m.Store(out4, (0u + (select(v_9, 0u, 0u) * 2u)), (select(v_9, 16u, 8u) * 2u), MatrixLayout::ColMajor);
  uint v_10 = 0u;
  out5.GetDimensions(v_10);
  bool v_11 = (116u <= (v_10 / 4u));
  m.Store(out5, (0u + (select(v_11, 0u, 0u) * 4u)), (select(v_11, 16u, 4u) * 4u), MatrixLayout::ColMajor);
  uint v_12 = 0u;
  out6.GetDimensions(v_12);
  bool v_13 = (114u <= (v_12 / 8u));
  m.Store(out6, (0u + (select(v_13, 0u, 0u) * 8u)), (select(v_13, 16u, 2u) * 8u), MatrixLayout::ColMajor);
}
