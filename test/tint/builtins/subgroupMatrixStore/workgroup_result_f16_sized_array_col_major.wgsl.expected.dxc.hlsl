...
=========================================================
:85:19 error: Store: no matching call to 'Store(subgroup_matrix_result<f16, 8, 8>, ptr<workgroup, array<vec2<f16>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
:86:19 error: Store: no matching call to 'Store(subgroup_matrix_result<f16, 8, 8>, ptr<workgroup, array<vec3<f16>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %41:subgroup_matrix_result<f16, 8, 8> = construct
    %m:subgroup_matrix_result<f16, 8, 8> = let %41
