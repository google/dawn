...
[numthreads(64, 1, 1)]
void main() {
  Matrix_result_i8_8x8 m = Matrix_result_i8_8x8::Splat(int(0));
  uint v = 0u;
  ...
  bool v_3 = (113u <= (v_2 / 8u));
  m.Store(out1, (0u + (select(v_3, 0u, 0u) * 8u)), (select(v_3, 16u, 1u) * 8u), MatrixLayout::ColMajor);
  uint v_4 = 0u;
  ...
  bool v_9 = (116u <= (v_8 / 2u));
  m.Store(out4, (0u + (select(v_9, 0u, 0u) * 2u)), (select(v_9, 16u, 4u) * 2u), MatrixLayout::ColMajor);
  uint v_10 = 0u;
  out5.GetDimensions(v_10);
  bool v_11 = (114u <= (v_10 / 4u));
  m.Store(out5, (0u + (select(v_11, 0u, 0u) * 4u)), (select(v_11, 16u, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_12 = 0u;
  out6.GetDimensions(v_12);
  bool v_13 = (113u <= (v_12 / 8u));
  m.Store(out6, (0u + (select(v_13, 0u, 0u) * 8u)), (select(v_13, 16u, 1u) * 8u), MatrixLayout::ColMajor);
}
