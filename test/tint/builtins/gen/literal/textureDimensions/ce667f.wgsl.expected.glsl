...
layout(binding = 1, rg16_snorm) uniform highp writeonly image2DArray f_arg_0;
uvec2 textureDimensions_ce667f() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_ce667f();
}
//
// compute_main
//
...
layout(binding = 1, rg16_snorm) uniform highp writeonly image2DArray arg_0;
uvec2 textureDimensions_ce667f() {
