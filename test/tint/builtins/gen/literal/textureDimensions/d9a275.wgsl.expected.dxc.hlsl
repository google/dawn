...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rg8snorm, read>, read> = var undef @binding_point(1, 0)
}
...
%fragment_main = @fragment func():void {
  $B3: {
    %11:u32 = call %textureDimensions_d9a275
    %12:void = %prevent_dce.Store 0u, %11
    ret
  }
}
Failed to generate: :15:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rg8snorm, read>, ptr<function, u32, read_write>)'
...
%vertex_main_inner = func():VertexOutput {
  $B3: {
    ...
    %13:u32 = call %textureDimensions_d9a275
    store %12, %13
...
Failed to generate: :19:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rg8snorm, read>, ptr<function, u32, read_write>)'
