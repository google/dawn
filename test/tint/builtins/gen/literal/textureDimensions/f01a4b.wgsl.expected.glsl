...
layout(binding = 1, r16) uniform highp readonly image2D f_arg_0;
uvec2 textureDimensions_f01a4b() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_f01a4b();
}
//
// compute_main
//
...
layout(binding = 1, r16) uniform highp readonly image2D arg_0;
uvec2 textureDimensions_f01a4b() {
...
layout(binding = 0, r16) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_f01a4b();
  return v;
}
void main() {
