...
layout(binding = 1, rg16_snorm) uniform highp writeonly image2D f_arg_0;
uvec2 textureDimensions_e4b7ba() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_e4b7ba();
}
//
// compute_main
//
...
layout(binding = 1, rg16_snorm) uniform highp writeonly image2D arg_0;
uvec2 textureDimensions_e4b7ba() {
