...
layout(binding = 1, rg16ui) uniform highp readonly uimage2DArray f_arg_0;
uvec2 textureDimensions_f4b864() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_f4b864();
}
//
// compute_main
//
...
layout(binding = 1, rg16ui) uniform highp readonly uimage2DArray arg_0;
uvec2 textureDimensions_f4b864() {
...
layout(binding = 0, rg16ui) uniform highp readonly uimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_f4b864();
  return v;
}
void main() {
