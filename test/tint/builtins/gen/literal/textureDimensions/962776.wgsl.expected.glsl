...
layout(binding = 1, rg8_snorm) uniform highp readonly image3D f_arg_0;
uvec3 textureDimensions_962776() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_962776();
}
//
// compute_main
//
...
layout(binding = 1, rg8_snorm) uniform highp readonly image3D arg_0;
uvec3 textureDimensions_962776() {
...
layout(binding = 0, rg8_snorm) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_962776();
  return v;
}
void main() {
