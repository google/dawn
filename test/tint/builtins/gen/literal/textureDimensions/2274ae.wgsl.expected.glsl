...
layout(binding = 1, rg16i) uniform highp writeonly iimage2DArray f_arg_0;
uvec2 textureDimensions_2274ae() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_2274ae();
}
//
// compute_main
//
...
layout(binding = 1, rg16i) uniform highp writeonly iimage2DArray arg_0;
uvec2 textureDimensions_2274ae() {
