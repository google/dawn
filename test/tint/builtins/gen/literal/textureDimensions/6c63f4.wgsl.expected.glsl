...
layout(binding = 1, rgb10_a2) uniform highp readonly image2D f_arg_0;
uint textureDimensions_6c63f4() {
  uint res = uvec2(imageSize(f_arg_0)).x;
  return res;
}
void main() {
  v.inner = textureDimensions_6c63f4();
}
//
// compute_main
//
...
layout(binding = 1, rgb10_a2) uniform highp readonly image2D arg_0;
uint textureDimensions_6c63f4() {
...
layout(binding = 0, rgb10_a2) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_6c63f4();
  return v;
}
void main() {
