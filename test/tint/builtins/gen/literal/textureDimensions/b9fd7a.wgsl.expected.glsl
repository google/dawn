...
layout(binding = 1, rg8i) uniform highp readonly iimage2DArray f_arg_0;
uvec2 textureDimensions_b9fd7a() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_b9fd7a();
}
//
// compute_main
//
...
layout(binding = 1, rg8i) uniform highp readonly iimage2DArray arg_0;
uvec2 textureDimensions_b9fd7a() {
...
layout(binding = 0, rg8i) uniform highp readonly iimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_b9fd7a();
  return v;
}
void main() {
