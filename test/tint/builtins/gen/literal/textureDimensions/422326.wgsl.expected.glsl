...
layout(binding = 1, rg8i) uniform highp writeonly iimage2DArray f_arg_0;
uvec2 textureDimensions_422326() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_422326();
}
//
// compute_main
//
...
layout(binding = 1, rg8i) uniform highp writeonly iimage2DArray arg_0;
uvec2 textureDimensions_422326() {
