...
layout(binding = 1, r16i) uniform highp writeonly iimage2D f_arg_0;
uvec2 textureDimensions_d0b76c() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_d0b76c();
}
//
// compute_main
//
...
layout(binding = 1, r16i) uniform highp writeonly iimage2D arg_0;
uvec2 textureDimensions_d0b76c() {
