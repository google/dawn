...
layout(binding = 1, r16i) uniform highp readonly iimage3D f_arg_0;
uvec3 textureDimensions_ae85f1() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_ae85f1();
}
//
// compute_main
//
...
layout(binding = 1, r16i) uniform highp readonly iimage3D arg_0;
uvec3 textureDimensions_ae85f1() {
...
layout(binding = 0, r16i) uniform highp readonly iimage3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_ae85f1();
  return v;
}
void main() {
