...
layout(binding = 1, rgba16) uniform highp writeonly image2D f_arg_0;
uvec2 textureDimensions_41b76e() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_41b76e();
}
//
// compute_main
//
...
layout(binding = 1, rgba16) uniform highp writeonly image2D arg_0;
uvec2 textureDimensions_41b76e() {
