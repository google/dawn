...
layout(binding = 1, r16ui) uniform highp readonly uimage2D f_arg_0;
uint textureDimensions_ae3294() {
  uint res = uvec2(imageSize(f_arg_0)).x;
  return res;
}
void main() {
  v.inner = textureDimensions_ae3294();
}
//
// compute_main
//
...
layout(binding = 1, r16ui) uniform highp readonly uimage2D arg_0;
uint textureDimensions_ae3294() {
...
layout(binding = 0, r16ui) uniform highp readonly uimage2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_ae3294();
  return v;
}
void main() {
