...
layout(binding = 1, r16ui) uniform highp writeonly uimage2D f_arg_0;
uvec2 textureDimensions_4744dc() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_4744dc();
}
//
// compute_main
//
...
layout(binding = 1, r16ui) uniform highp writeonly uimage2D arg_0;
uvec2 textureDimensions_4744dc() {
