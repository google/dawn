...
layout(binding = 1, r11f_g11f_b10f) uniform highp readonly image2D f_arg_0;
uvec2 textureDimensions_77f4c8() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_77f4c8();
}
//
// compute_main
//
...
layout(binding = 1, r11f_g11f_b10f) uniform highp readonly image2D arg_0;
uvec2 textureDimensions_77f4c8() {
...
layout(binding = 0, r11f_g11f_b10f) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_77f4c8();
  return v;
}
void main() {
