...
layout(binding = 1, r8_snorm) uniform highp writeonly image2D f_arg_0;
uvec2 textureDimensions_34ea13() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_34ea13();
}
//
// compute_main
//
...
layout(binding = 1, r8_snorm) uniform highp writeonly image2D arg_0;
uvec2 textureDimensions_34ea13() {
