...
uvec3 textureDimensions_c871f3() {
  uvec3 res = uvec3(textureSize(f_arg_0, int(min(1u, (v_1.metadata[0u].x - 1u)))));
  return res;
}
void main() {
...
uvec3 textureDimensions_c871f3() {
  uvec3 res = uvec3(textureSize(arg_0, int(min(1u, (v_1.metadata[0u].x - 1u)))));
  return res;
}
...
uvec3 textureDimensions_c871f3() {
  uvec3 res = uvec3(textureSize(v_arg_0, int(min(1u, (v.metadata[0u].x - 1u)))));
  return res;
}
