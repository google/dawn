...
layout(binding = 1, r16i) uniform highp writeonly iimage2DArray f_arg_0;
uvec2 textureDimensions_d74c51() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_d74c51();
}
//
// compute_main
//
...
layout(binding = 1, r16i) uniform highp writeonly iimage2DArray arg_0;
uvec2 textureDimensions_d74c51() {
