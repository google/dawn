...
Failed to generate: :18:14 error: glsl.textureSize: no matching call to 'glsl.textureSize(texel_buffer<rg11b10ufloat, read>, i32)'
...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rg11b10ufloat, read>, read> = combined_texture_sampler undef @binding_point(0, 1)
}
...
%fragment_main = @fragment func():void {
  $B3: {
    %10:u32 = call %textureDimensions_ef2ec0
...
Failed to generate: :13:14 error: glsl.textureSize: no matching call to 'glsl.textureSize(texel_buffer<rg11b10ufloat, read>, i32)'
...
$B1: {  # root
  %arg_0:ptr<handle, texel_buffer<rg11b10ufloat, read>, read> = combined_texture_sampler undef @binding_point(0, 0)
}
...
%vertex_main = @vertex func():VertexOutput {
  $B3: {
    ...
    %12:u32 = call %textureDimensions_ef2ec0
    store %11, %12
