...
layout(binding = 1, rg16ui) uniform highp writeonly uimage2D f_arg_0;
uvec2 textureDimensions_0d9cfc() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_0d9cfc();
}
//
// compute_main
//
...
layout(binding = 1, rg16ui) uniform highp writeonly uimage2D arg_0;
uvec2 textureDimensions_0d9cfc() {
