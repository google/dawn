...
layout(binding = 1, rg16f) uniform highp readonly image2D f_arg_0;
uint textureDimensions_2641a4() {
  uint res = uvec2(imageSize(f_arg_0)).x;
  return res;
}
void main() {
  v.inner = textureDimensions_2641a4();
}
//
// compute_main
//
...
layout(binding = 1, rg16f) uniform highp readonly image2D arg_0;
uint textureDimensions_2641a4() {
...
layout(binding = 0, rg16f) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_2641a4();
  return v;
}
void main() {
