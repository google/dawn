...
layout(binding = 1, r8i) uniform highp readonly iimage2D f_arg_0;
uvec2 textureDimensions_5395df() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_5395df();
}
//
// compute_main
//
...
layout(binding = 1, r8i) uniform highp readonly iimage2D arg_0;
uvec2 textureDimensions_5395df() {
...
layout(binding = 0, r8i) uniform highp readonly iimage2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_5395df();
  return v;
}
void main() {
