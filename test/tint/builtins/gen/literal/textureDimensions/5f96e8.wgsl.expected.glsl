...
layout(binding = 1, rgba16) uniform highp readonly image3D f_arg_0;
uvec3 textureDimensions_5f96e8() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_5f96e8();
}
//
// compute_main
//
...
layout(binding = 1, rgba16) uniform highp readonly image3D arg_0;
uvec3 textureDimensions_5f96e8() {
...
layout(binding = 0, rgba16) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_5f96e8();
  return v;
}
void main() {
