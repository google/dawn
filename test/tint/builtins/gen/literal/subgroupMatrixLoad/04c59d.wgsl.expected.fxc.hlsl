...
%subgroupMatrixLoad_04c59d = func():subgroup_matrix_right<f16, 8, 8> {
  $B2: {
    ...
    %5:subgroup_matrix_right<f16, 8, 8> = subgroupMatrixLoad<subgroup_matrix_right<f16, 8, 8>, col_major> %4, 1i, 8i
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_right<f16, 8, 8> = call %subgroupMatrixLoad_04c59d
