...
%subgroupMatrixLoad_eedce2 = func():subgroup_matrix_result<u8, 8, 8> {
  $B2: {
    ...
    %5:subgroup_matrix_result<u8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<u8, 8, 8>, col_major> %4, 1i, 8i
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_result<u8, 8, 8> = call %subgroupMatrixLoad_eedce2
