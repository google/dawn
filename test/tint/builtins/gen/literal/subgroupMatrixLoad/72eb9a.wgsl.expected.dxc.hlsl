...
Matrix_right_i32_8x8 subgroupMatrixLoad_72eb9a() {
  Matrix_right_i32_8x8 res = Matrix_right_i32_8x8::Load(arg_0, 1u, 8u, MatrixLayout::RowMajor);
  return res;
}
...
void compute_main_inner(uint tint_local_index) {
  ...
  subgroupMatrixLoad_72eb9a().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
