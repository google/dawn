...
%subgroupMatrixLoad_4a6cd5 = func():subgroup_matrix_right<i8, 8, 8> {
  $B2: {
    ...
    %5:subgroup_matrix_right<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_right<i8, 8, 8>> %4, 1i, true, 8i
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_right<i8, 8, 8> = call %subgroupMatrixLoad_4a6cd5
