...
%subgroupMatrixLoad_50aa3d = func():subgroup_matrix_left<f16, 8, 8> {
  $B2: {
    %4:ptr<storage, array<f16, 1024>, read_write> = access %sb_rw, 0u
    %5:subgroup_matrix_left<f16, 8, 8> = subgroupMatrixLoad<subgroup_matrix_left<f16, 8, 8>> %4, 1i, true, 8i
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_left<f16, 8, 8> = call %subgroupMatrixLoad_50aa3d
