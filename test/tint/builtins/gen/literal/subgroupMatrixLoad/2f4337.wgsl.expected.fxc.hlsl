...
%subgroupMatrixLoad_2f4337 = func():subgroup_matrix_result<u32, 8, 8> {
  $B2: {
    %4:subgroup_matrix_result<u32, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, row_major> %arg_0, 1i, 8u
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %8:subgroup_matrix_result<u32, 8, 8> = call %subgroupMatrixLoad_2f4337
