...
%subgroupMatrixLoad_027197 = func():subgroup_matrix_left<i32, 8, 8> {
  $B2: {
    %4:ptr<storage, array<i32, 1024>, read> = access %sb_ro, 0u
    %5:subgroup_matrix_left<i32, 8, 8> = subgroupMatrixLoad<subgroup_matrix_left<i32, 8, 8>> %4, 1u, true, 8i
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_left<i32, 8, 8> = call %subgroupMatrixLoad_027197
