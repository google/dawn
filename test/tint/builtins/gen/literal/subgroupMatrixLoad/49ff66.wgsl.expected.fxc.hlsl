...
%subgroupMatrixLoad_49ff66 = func():subgroup_matrix_result<i32, 8, 8> {
  $B2: {
    %4:ptr<storage, array<i32, 1024>, read_write> = access %sb_rw, 0u
    %5:subgroup_matrix_result<i32, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i32, 8, 8>, row_major> %4, 1i, 8i
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_result<i32, 8, 8> = call %subgroupMatrixLoad_49ff66
