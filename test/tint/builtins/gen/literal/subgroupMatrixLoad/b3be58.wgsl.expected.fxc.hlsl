...
%subgroupMatrixLoad_b3be58 = func():subgroup_matrix_left<i8, 8, 8> {
  $B2: {
    ...
    %5:subgroup_matrix_left<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_left<i8, 8, 8>> %4, 1u, false, 8u
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_left<i8, 8, 8> = call %subgroupMatrixLoad_b3be58
