...
%subgroupMatrixMultiply_f51206 = func():subgroup_matrix_result<i32, 8, 8> {
  $B2: {
    %3:subgroup_matrix_left<u32, 8, 8> = construct
    %4:subgroup_matrix_right<u32, 8, 8> = construct
    %5:subgroup_matrix_result<i32, 8, 8> = subgroupMatrixMultiply<i32> %3, %4
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %9:subgroup_matrix_result<i32, 8, 8> = call %subgroupMatrixMultiply_f51206
