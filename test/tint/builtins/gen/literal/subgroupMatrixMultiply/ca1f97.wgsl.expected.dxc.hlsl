...
Matrix_result_i32_8x8 subgroupMatrixMultiply_ca1f97() {
  Matrix_result_i32_8x8 res = Multiply<ComponentType::I32>(Matrix_left_i8_8x8::Splat(int(0)), Matrix_right_i8_8x8::Splat(int(0)));
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiply_ca1f97().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
