...
Matrix_result_u32_8x8 subgroupMatrixMultiply_0dadd3() {
  Matrix_result_u32_8x8 res = Multiply<ComponentType::U32>(Matrix_left_i8_8x8::Splat(int(0)), Matrix_right_i8_8x8::Splat(int(0)));
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiply_0dadd3().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
