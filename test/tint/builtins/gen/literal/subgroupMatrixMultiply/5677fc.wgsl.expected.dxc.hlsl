...
Matrix_result_f32_8x8 subgroupMatrixMultiply_5677fc() {
  Matrix_result_f32_8x8 res = Multiply<ComponentType::F32>(Matrix_left_f16_8x8::Splat(float16_t(0.0h)), Matrix_right_f16_8x8::Splat(float16_t(0.0h)));
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiply_5677fc().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
