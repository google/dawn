...
uvec4 textureGather_d4b5c6() {
  float v_1 = float(1);
  uvec4 res = textureGather(f_arg_1_arg_2, vec4(1.0f), int(1u));
  return res;
}
void main() {
...
uvec4 textureGather_d4b5c6() {
  float v_1 = float(1);
  uvec4 res = textureGather(arg_1_arg_2, vec4(1.0f), int(1u));
  return res;
}
...
uvec4 textureGather_d4b5c6() {
  float v = float(1);
  uvec4 res = textureGather(v_arg_1_arg_2, vec4(1.0f), int(1u));
  return res;
}
