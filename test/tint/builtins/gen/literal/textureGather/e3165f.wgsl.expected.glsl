...
uvec4 textureGather_e3165f() {
  uvec4 res = textureGatherOffset(f_arg_1_arg_2, vec3(1.0f), ivec2(1), 1);
  return res;
}
void main() {
...
uvec4 textureGather_e3165f() {
  uvec4 res = textureGatherOffset(arg_1_arg_2, vec3(1.0f), ivec2(1), 1);
  return res;
}
...
uvec4 textureGather_e3165f() {
  uvec4 res = textureGatherOffset(v_arg_1_arg_2, vec3(1.0f), ivec2(1), 1);
  return res;
}
