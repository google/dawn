...
uvec4 textureGather_e3165f() {
  float v_1 = float(1);
  uvec4 res = textureGatherOffset(f_arg_1_arg_2, vec3(1.0f), ivec2(1), int(1u));
  return res;
}
void main() {
...
uvec4 textureGather_e3165f() {
  float v_1 = float(1);
  uvec4 res = textureGatherOffset(arg_1_arg_2, vec3(1.0f), ivec2(1), int(1u));
  return res;
}
...
uvec4 textureGather_e3165f() {
  float v = float(1);
  uvec4 res = textureGatherOffset(v_arg_1_arg_2, vec3(1.0f), ivec2(1), int(1u));
  return res;
}
