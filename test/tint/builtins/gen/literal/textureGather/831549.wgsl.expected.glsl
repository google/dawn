...
vec4 textureGather_831549() {
  vec4 res = textureGatherOffset(f_arg_1_arg_2, vec3(1.0f), ivec2(1), 1);
  return res;
}
void main() {
...
vec4 textureGather_831549() {
  vec4 res = textureGatherOffset(arg_1_arg_2, vec3(1.0f), ivec2(1), 1);
  return res;
}
...
vec4 textureGather_831549() {
  vec4 res = textureGatherOffset(v_arg_1_arg_2, vec3(1.0f), ivec2(1), 1);
  return res;
}
