...
ivec4 textureGather_9ab41e() {
  float v_1 = float(1);
  ivec4 res = textureGatherOffset(f_arg_1_arg_2, vec3(1.0f), ivec2(1), int(1u));
  return res;
}
void main() {
...
ivec4 textureGather_9ab41e() {
  float v_1 = float(1);
  ivec4 res = textureGatherOffset(arg_1_arg_2, vec3(1.0f), ivec2(1), int(1u));
  return res;
}
...
ivec4 textureGather_9ab41e() {
  float v = float(1);
  ivec4 res = textureGatherOffset(v_arg_1_arg_2, vec3(1.0f), ivec2(1), int(1u));
  return res;
}
