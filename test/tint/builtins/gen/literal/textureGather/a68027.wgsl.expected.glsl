...
vec4 textureGather_a68027() {
  float v_1 = float(1u);
  vec4 res = textureGatherOffset(f_arg_0_arg_1, vec3(1.0f), 0.0f, ivec2(1));
  return res;
}
void main() {
...
vec4 textureGather_a68027() {
  float v_1 = float(1u);
  vec4 res = textureGatherOffset(arg_0_arg_1, vec3(1.0f), 0.0f, ivec2(1));
  return res;
}
...
vec4 textureGather_a68027() {
  float v = float(1u);
  vec4 res = textureGatherOffset(v_arg_0_arg_1, vec3(1.0f), 0.0f, ivec2(1));
  return res;
}
