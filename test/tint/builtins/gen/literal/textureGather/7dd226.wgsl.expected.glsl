...
vec4 textureGather_7dd226() {
  vec4 res = textureGather(f_arg_0_arg_1, vec4(1.0f), 0.0f);
  return res;
}
void main() {
...
vec4 textureGather_7dd226() {
  vec4 res = textureGather(arg_0_arg_1, vec4(1.0f), 0.0f);
  return res;
}
...
vec4 textureGather_7dd226() {
  vec4 res = textureGather(v_arg_0_arg_1, vec4(1.0f), 0.0f);
  return res;
}
