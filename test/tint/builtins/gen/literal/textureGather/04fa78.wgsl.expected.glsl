...
ivec4 textureGather_04fa78() {
  float v_1 = float(1u);
  ivec4 res = textureGather(f_arg_1_arg_2, vec4(1.0f), int(1u));
  return res;
}
void main() {
...
ivec4 textureGather_04fa78() {
  float v_1 = float(1u);
  ivec4 res = textureGather(arg_1_arg_2, vec4(1.0f), int(1u));
  return res;
}
...
ivec4 textureGather_04fa78() {
  float v = float(1u);
  ivec4 res = textureGather(v_arg_1_arg_2, vec4(1.0f), int(1u));
  return res;
}
