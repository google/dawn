...
float textureSampleLevel_73e892() {
  float res = textureLod(f_arg_0_arg_1, vec3(1.0f, 1.0f, 0.0f), float(1u));
  return res;
}
void main() {
...
float textureSampleLevel_73e892() {
  float res = textureLod(arg_0_arg_1, vec3(1.0f, 1.0f, 0.0f), float(1u));
  return res;
}
...
float textureSampleLevel_73e892() {
  float res = textureLod(v_arg_0_arg_1, vec3(1.0f, 1.0f, 0.0f), float(1u));
  return res;
}
