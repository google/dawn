...
vec4 textureSampleLevel_faa6d7() {
  vec4 res = textureLodOffset(f_arg_0_arg_1, vec3(1.0f), 1.0f, ivec2(1));
  return res;
}
void main() {
...
vec4 textureSampleLevel_faa6d7() {
  vec4 res = textureLodOffset(arg_0_arg_1, vec3(1.0f), 1.0f, ivec2(1));
  return res;
}
...
vec4 textureSampleLevel_faa6d7() {
  vec4 res = textureLodOffset(v_arg_0_arg_1, vec3(1.0f), 1.0f, ivec2(1));
  return res;
}
