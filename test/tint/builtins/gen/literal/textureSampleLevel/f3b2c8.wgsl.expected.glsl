...
float textureSampleLevel_f3b2c8() {
  float res = textureLodOffset(f_arg_0_arg_1, vec3(1.0f, 1.0f, 0.0f), float(1u), ivec2(1));
  return res;
}
void main() {
...
float textureSampleLevel_f3b2c8() {
  float res = textureLodOffset(arg_0_arg_1, vec3(1.0f, 1.0f, 0.0f), float(1u), ivec2(1));
  return res;
}
...
float textureSampleLevel_f3b2c8() {
  float res = textureLodOffset(v_arg_0_arg_1, vec3(1.0f, 1.0f, 0.0f), float(1u), ivec2(1));
  return res;
}
