...
float textureSampleLevel_ff11bc() {
  float res = textureLod(f_arg_0_arg_1, vec4(1.0f), 0.0f, 1.0f);
  return res;
}
void main() {
...
float textureSampleLevel_ff11bc() {
  float res = textureLod(arg_0_arg_1, vec4(1.0f), 0.0f, 1.0f);
  return res;
}
...
float textureSampleLevel_ff11bc() {
  float res = textureLod(v_arg_0_arg_1, vec4(1.0f), 0.0f, 1.0f);
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v = VertexOutput(vec4(0.0f), 0.0f);
  v.pos = vec4(0.0f);
  v.prevent_dce = textureSampleLevel_ff11bc();
  return v;
}
void main() {
