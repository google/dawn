...
vec4 textureSampleLevel_aab3b9() {
  vec4 res = textureLod(f_arg_0_arg_1, vec4(1.0f), 1.0f);
  return res;
}
void main() {
...
vec4 textureSampleLevel_aab3b9() {
  vec4 res = textureLod(arg_0_arg_1, vec4(1.0f), 1.0f);
  return res;
}
...
vec4 textureSampleLevel_aab3b9() {
  vec4 res = textureLod(v_arg_0_arg_1, vec4(1.0f), 1.0f);
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v = VertexOutput(vec4(0.0f), vec4(0.0f));
  v.pos = vec4(0.0f);
  v.prevent_dce = textureSampleLevel_aab3b9();
  return v;
}
void main() {
