...
float textureSampleLevel_2974eb() {
  float v_1 = float(1);
  float res = textureLod(f_arg_0_arg_1, vec4(1.0f, 1.0f, 1.0f, 0.0f), float(1u));
  return res;
}
void main() {
...
float textureSampleLevel_2974eb() {
  float v_1 = float(1);
  float res = textureLod(arg_0_arg_1, vec4(1.0f, 1.0f, 1.0f, 0.0f), float(1u));
  return res;
}
...
float textureSampleLevel_2974eb() {
  float v = float(1);
  float res = textureLod(v_arg_0_arg_1, vec4(1.0f, 1.0f, 1.0f, 0.0f), float(1u));
  return res;
}
