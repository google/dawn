...
float textureSampleLevel_e6ce9e() {
  float v_1 = float(1u);
  float res = textureLodOffset(f_arg_0_arg_1, vec4(1.0f, 1.0f, 1.0f, 0.0f), float(1), ivec2(1));
  return res;
}
void main() {
...
float textureSampleLevel_e6ce9e() {
  float v_1 = float(1u);
  float res = textureLodOffset(arg_0_arg_1, vec4(1.0f, 1.0f, 1.0f, 0.0f), float(1), ivec2(1));
  return res;
}
...
float textureSampleLevel_e6ce9e() {
  float v = float(1u);
  float res = textureLodOffset(v_arg_0_arg_1, vec4(1.0f, 1.0f, 1.0f, 0.0f), float(1), ivec2(1));
  return res;
}
