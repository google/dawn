...
vec4 textureGatherCompare_2e409c() {
  float v_1 = float(1u);
  vec4 res = textureGather(f_arg_0_arg_1, vec4(1.0f), 1.0f);
  return res;
}
void main() {
...
vec4 textureGatherCompare_2e409c() {
  float v_1 = float(1u);
  vec4 res = textureGather(arg_0_arg_1, vec4(1.0f), 1.0f);
  return res;
}
...
vec4 textureGatherCompare_2e409c() {
  float v = float(1u);
  vec4 res = textureGather(v_arg_0_arg_1, vec4(1.0f), 1.0f);
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_1 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureGatherCompare_2e409c();
  return v_1;
}
void main() {
