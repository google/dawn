...
Matrix_left_f32_8x8 subgroupMatrixScalarAdd_7f3869() {
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixScalarAdd_7f3869().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
