...
float textureSampleCompareLevel_7dc3c0() {
  float v_1 = float(1u);
  float res = texture(f_arg_0_arg_1, vec4(1.0f));
  return res;
}
void main() {
...
float textureSampleCompareLevel_7dc3c0() {
  float v_1 = float(1u);
  float res = texture(arg_0_arg_1, vec4(1.0f));
  return res;
}
...
float textureSampleCompareLevel_7dc3c0() {
  float v = float(1u);
  float res = texture(v_arg_0_arg_1, vec4(1.0f));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_1 = VertexOutput(vec4(0.0f), 0.0f);
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureSampleCompareLevel_7dc3c0();
  return v_1;
}
void main() {
