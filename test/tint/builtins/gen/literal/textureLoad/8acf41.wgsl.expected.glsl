...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    vec4 v_17 = texelFetch(f_arg_0_plane0, ivec2(v_14), 0);
    v_15 = v_17.xyz;
    v_16 = v_17.w;
  } else {
    float v_18 = texelFetch(f_arg_0_plane0, ivec2(v_14), 0).x;
    v_15 = (vec4(v_18, texelFetch(f_arg_0_plane1, ivec2(uvec2((v_13 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_16 = 1.0f;
  }
  vec3 v_19 = v_15;
  vec3 v_20 = vec3(0.0f);
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    vec3 v_21 = tint_ApplySrcTransferFunction(v_19, params.srcTransferFunction);
    vec3 v_22 = vec3(0.0f);
    if ((params.ootfParam.w != 0.0f)) {
      float v_23 = dot(params.ootfParam.xyz, v_21);
      v_22 = (v_21 * (sign(v_23) * pow(abs(v_23), params.ootfParam.w)));
    } else {
      v_22 = v_21;
    }
    v_20 = tint_ApplyGammaTransferFunction((params.gamutConversionMatrix * v_22), params.dstTransferFunction);
  } else {
    v_20 = v_19;
  }
  return vec4(v_20, v_16);
}
...
tint_ExternalTextureParams v_50(uint start_byte_offset) {
  ...
  vec2 v_77 = uintBitsToFloat(mix(v_76.xy, v_76.zw, bvec2((((v_75 & 15u) >> 2u) == 2u))));
  return tint_ExternalTextureParams(v_51[((start_byte_offset & 15u) >> 2u)], v_53[((v_52 & 15u) >> 2u)], v_54, v_55, v_56, v_57, v_58, v_59, v_62, v_65, v_68, v_71, v_74, v_77, uintBitsToFloat(v_2.inner[((272u + start_byte_offset) / 16u)]));
}
vec4 textureLoad_8acf41() {
  tint_ExternalTextureParams v_78 = v_50(0u);
  vec4 res = tint_TextureLoadMultiplanarExternal(v_78, min(uvec2(1u), ((v_78.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  float v_16 = 0.0f;
  if ((params.numPlanes == 1u)) {
    vec4 v_17 = texelFetch(arg_0_plane0, ivec2(v_14), 0);
    v_15 = v_17.xyz;
    v_16 = v_17.w;
  } else {
    float v_18 = texelFetch(arg_0_plane0, ivec2(v_14), 0).x;
    v_15 = (vec4(v_18, texelFetch(arg_0_plane1, ivec2(uvec2((v_13 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_16 = 1.0f;
  }
  vec3 v_19 = v_15;
  vec3 v_20 = vec3(0.0f);
...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  float v_15 = 0.0f;
  if ((params.numPlanes == 1u)) {
    vec4 v_16 = texelFetch(v_arg_0_plane0, ivec2(v_13), 0);
    v_14 = v_16.xyz;
    v_15 = v_16.w;
  } else {
    float v_17 = texelFetch(v_arg_0_plane0, ivec2(v_13), 0).x;
    v_14 = (vec4(v_17, texelFetch(v_arg_0_plane1, ivec2(uvec2((v_12 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_15 = 1.0f;
  }
  vec3 v_18 = v_14;
  vec3 v_19 = vec3(0.0f);
...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_77, min(uvec2(1u), ((v_77.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_78 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_78.pos = vec4(0.0f);
  v_78.prevent_dce = textureLoad_8acf41();
  return v_78;
}
void main() {
  VertexOutput v_79 = vertex_main_inner();
  gl_Position = vec4(v_79.pos.x, -(v_79.pos.y), ((2.0f * v_79.pos.z) - v_79.pos.w), v_79.pos.w);
  tint_interstage_location0 = v_79.prevent_dce;
  gl_PointSize = 1.0f;
}
