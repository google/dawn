...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_81, min(uvec2(1u), ((v_81.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_80, min(uvec2(1u), ((v_80.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_81 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_81.pos = vec4(0.0f);
  v_81.prevent_dce = textureLoad_1bfdfb();
  return v_81;
}
void main() {
