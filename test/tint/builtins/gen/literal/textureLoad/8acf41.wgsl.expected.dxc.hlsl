...
tint_TransferFunctionParams v_35(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_43 = {arg_0_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)], asfloat(arg_0_params[(v_36 / 16u)][((v_36 & 15u) >> 2u)]), asfloat(arg_0_params[(v_37 / 16u)][((v_37 & 15u) >> 2u)]), asfloat(arg_0_params[(v_38 / 16u)][((v_38 & 15u) >> 2u)]), asfloat(arg_0_params[(v_39 / 16u)][((v_39 & 15u) >> 2u)]), asfloat(arg_0_params[(v_40 / 16u)][((v_40 & 15u) >> 2u)]), asfloat(arg_0_params[(v_41 / 16u)][((v_41 & 15u) >> 2u)]), asfloat(arg_0_params[(v_42 / 16u)][((v_42 & 15u) >> 2u)])};
  return v_43;
}
...
tint_ExternalTextureParams v_45(uint start_byte_offset) {
  uint v_46 = arg_0_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)];
  uint v_47 = (4u + start_byte_offset);
  uint v_48 = arg_0_params[(v_47 / 16u)][((v_47 & 15u) >> 2u)];
...
VertexOutput vertex_main_inner() {
  ...
  v_69.pos = (0.0f).xxxx;
  v_69.prevent_dce = textureLoad_8acf41();
