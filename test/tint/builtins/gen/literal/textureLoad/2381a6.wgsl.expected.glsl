...
layout(binding = 1, r8i) uniform highp readonly iimage2DArray f_arg_0;
ivec4 textureLoad_2381a6() {
...
layout(binding = 1, r8i) uniform highp readonly iimage2DArray arg_0;
ivec4 textureLoad_2381a6() {
...
layout(binding = 0, r8i) uniform highp readonly iimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_3.pos = vec4(0.0f);
  v_3.prevent_dce = textureLoad_2381a6();
  return v_3;
}
void main() {
