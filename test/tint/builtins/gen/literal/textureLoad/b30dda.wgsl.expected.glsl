...
layout(binding = 1, r16ui) uniform highp readonly uimage3D f_arg_0;
uvec4 textureLoad_b30dda() {
  uvec3 v_1 = (uvec3(imageSize(f_arg_0)) - uvec3(1u));
  uvec4 res = imageLoad(f_arg_0, ivec3(min(uvec3(ivec3(1)), v_1)));
  return res;
}
void main() {
  v.inner = textureLoad_b30dda();
}
//
// compute_main
//
...
layout(binding = 1, r16ui) uniform highp readonly uimage3D arg_0;
uvec4 textureLoad_b30dda() {
...
layout(binding = 0, r16ui) uniform highp readonly uimage3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureLoad_b30dda();
  return v_1;
}
void main() {
