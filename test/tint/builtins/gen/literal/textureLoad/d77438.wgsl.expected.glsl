...
layout(binding = 1, r8_snorm) uniform highp readonly image2DArray f_arg_0;
vec4 textureLoad_d77438() {
...
layout(binding = 1, r8_snorm) uniform highp readonly image2DArray arg_0;
vec4 textureLoad_d77438() {
...
layout(binding = 0, r8_snorm) uniform highp readonly image2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_2.pos = vec4(0.0f);
  v_2.prevent_dce = textureLoad_d77438();
  return v_2;
}
void main() {
