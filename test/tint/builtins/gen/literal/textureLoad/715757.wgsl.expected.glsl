...
layout(binding = 1, r8_snorm) uniform highp readonly image3D f_arg_0;
vec4 textureLoad_715757() {
  uvec3 v_1 = (uvec3(imageSize(f_arg_0)) - uvec3(1u));
  vec4 res = imageLoad(f_arg_0, ivec3(min(uvec3(ivec3(1)), v_1)));
  return res;
}
void main() {
  v.inner = textureLoad_715757();
}
//
// compute_main
//
...
layout(binding = 1, r8_snorm) uniform highp readonly image3D arg_0;
vec4 textureLoad_715757() {
...
layout(binding = 0, r8_snorm) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureLoad_715757();
  return v_1;
}
void main() {
