...
vec4 textureLoad_f2ac49() {
  ...
  uint v_3 = (v.metadata[(0u / 4u)][(0u % 4u)] - 1u);
...
VertexOutput vertex_main_inner() {
  ...
  v_7.pos = vec4(0.0f);
  v_7.prevent_dce = textureLoad_f2ac49();
  return v_7;
}
void main() {
