...
layout(binding = 1, r16i) uniform highp readonly iimage2DArray f_arg_0;
ivec4 textureLoad_da7455() {
...
layout(binding = 1, r16i) uniform highp readonly iimage2DArray arg_0;
ivec4 textureLoad_da7455() {
...
layout(binding = 0, r16i) uniform highp readonly iimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_2.pos = vec4(0.0f);
  v_2.prevent_dce = textureLoad_da7455();
  return v_2;
}
void main() {
