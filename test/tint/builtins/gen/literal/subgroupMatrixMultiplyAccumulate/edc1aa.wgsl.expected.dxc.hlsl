...
Matrix_result_i32_8x8 subgroupMatrixMultiplyAccumulate_edc1aa() {
  Matrix_result_i32_8x8 res = tint_MatrixMultiplyAccumulate(Matrix_left_i8_8x8::Splat(int(0)), Matrix_right_i8_8x8::Splat(int(0)), Matrix_result_i32_8x8::Splat(int(0)));
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiplyAccumulate_edc1aa().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
