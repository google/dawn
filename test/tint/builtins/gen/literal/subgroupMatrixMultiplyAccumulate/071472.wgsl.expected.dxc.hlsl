...
Matrix_result_f32_8x8 subgroupMatrixMultiplyAccumulate_071472() {
  Matrix_result_f32_8x8 res = tint_MatrixMultiplyAccumulate(Matrix_left_f16_8x8::Splat(float16_t(0.0h)), Matrix_right_f16_8x8::Splat(float16_t(0.0h)), Matrix_result_f32_8x8::Splat(0.0f));
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiplyAccumulate_071472().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
