...
Matrix_result_u32_8x8 subgroupMatrixMultiplyAccumulate_9ad4f5() {
  Matrix_result_u32_8x8 res = tint_MatrixMultiplyAccumulate(Matrix_left_u32_8x8::Splat(0u), Matrix_right_u32_8x8::Splat(0u), Matrix_result_u32_8x8::Splat(0u));
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiplyAccumulate_9ad4f5().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
