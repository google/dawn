...
layout(binding = 1, rg8ui) uniform highp readonly uimage2DArray f_arg_0;
uint textureNumLayers_ea0633() {
  uint res = uint(imageSize(f_arg_0).z);
  return res;
}
void main() {
  v.inner = textureNumLayers_ea0633();
}
//
// compute_main
//
...
layout(binding = 1, rg8ui) uniform highp readonly uimage2DArray arg_0;
uint textureNumLayers_ea0633() {
...
layout(binding = 0, rg8ui) uniform highp readonly uimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureNumLayers_ea0633();
  return v;
}
void main() {
