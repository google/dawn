...
layout(binding = 1, rg8ui) uniform highp readonly uimage3D f_arg_0;
uvec3 textureDimensions_57e9ae() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_57e9ae();
}
//
// compute_main
//
...
layout(binding = 1, rg8ui) uniform highp readonly uimage3D arg_0;
uvec3 textureDimensions_57e9ae() {
...
layout(binding = 0, rg8ui) uniform highp readonly uimage3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_57e9ae();
  return v;
}
void main() {
