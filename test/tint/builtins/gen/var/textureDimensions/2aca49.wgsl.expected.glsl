...
Failed to generate: :13:14 error: glsl.textureSize: no matching call to 'glsl.textureSize(texel_buffer<rgba16uint, read_write>, i32)'
...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rgba16uint, read_write>, read> = combined_texture_sampler undef @binding_point(0, 1)
}

%textureDimensions_2aca49 = func():u32 {
  $B2: {
    %4:texel_buffer<rgba16uint, read_write> = load %arg_0
    %5:i32 = glsl.textureSize %4, 0i
    %6:u32 = bitcast %5
...
%fragment_main = @fragment func():void {
  $B3: {
    %10:u32 = call %textureDimensions_2aca49
