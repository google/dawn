...
layout(binding = 1, rg16i) uniform highp readonly iimage3D f_arg_0;
uvec3 textureDimensions_db6553() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_db6553();
}
//
// compute_main
//
...
layout(binding = 1, rg16i) uniform highp readonly iimage3D arg_0;
uvec3 textureDimensions_db6553() {
...
layout(binding = 0, rg16i) uniform highp readonly iimage3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_db6553();
  return v;
}
void main() {
