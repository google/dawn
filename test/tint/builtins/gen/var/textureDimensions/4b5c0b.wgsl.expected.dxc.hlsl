...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rgba8sint, read_write>, read> = var undef @binding_point(1, 0)
}

%textureDimensions_4b5c0b = func():u32 {
  $B2: {
    %4:texel_buffer<rgba8sint, read_write> = load %arg_0
...
%fragment_main = @fragment func():void {
  $B3: {
    %11:u32 = call %textureDimensions_4b5c0b
    %12:void = %prevent_dce.Store 0u, %11
    ret
  }
}
Failed to generate: :10:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rgba8sint, read_write>, ptr<function, u32, read_write>)'
