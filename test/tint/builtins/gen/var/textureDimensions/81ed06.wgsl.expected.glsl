...
Failed to generate: :13:14 error: glsl.textureSize: no matching call to 'glsl.textureSize(texel_buffer<r32float, read_write>, i32)'
...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<r32float, read_write>, read> = combined_texture_sampler undef @binding_point(0, 1)
}
...
%fragment_main = @fragment func():void {
  $B3: {
    %10:u32 = call %textureDimensions_81ed06
