...
layout(binding = 1, r16f) uniform highp readonly image2DArray f_arg_0;
uvec2 textureDimensions_7b120a() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_7b120a();
}
//
// compute_main
//
...
layout(binding = 1, r16f) uniform highp readonly image2DArray arg_0;
uvec2 textureDimensions_7b120a() {
...
layout(binding = 0, r16f) uniform highp readonly image2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_7b120a();
  return v;
}
void main() {
