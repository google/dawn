...
layout(binding = 1, rgba16) uniform highp readonly image2DArray f_arg_0;
uvec2 textureDimensions_0dbd4f() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_0dbd4f();
}
//
// compute_main
//
...
layout(binding = 1, rgba16) uniform highp readonly image2DArray arg_0;
uvec2 textureDimensions_0dbd4f() {
...
layout(binding = 0, rgba16) uniform highp readonly image2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_0dbd4f();
  return v;
}
void main() {
