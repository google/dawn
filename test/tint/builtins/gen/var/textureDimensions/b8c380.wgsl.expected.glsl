...
layout(binding = 1, rg8ui) uniform highp readonly uimage2D f_arg_0;
uvec2 textureDimensions_b8c380() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_b8c380();
}
//
// compute_main
//
...
layout(binding = 1, rg8ui) uniform highp readonly uimage2D arg_0;
uvec2 textureDimensions_b8c380() {
...
layout(binding = 0, rg8ui) uniform highp readonly uimage2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_b8c380();
  return v;
}
void main() {
