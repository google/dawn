...
layout(binding = 1, rgb10_a2ui) uniform highp writeonly uimage2D f_arg_0;
uvec2 textureDimensions_b5348b() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_b5348b();
}
//
// compute_main
//
...
layout(binding = 1, rgb10_a2ui) uniform highp writeonly uimage2D arg_0;
uvec2 textureDimensions_b5348b() {
