...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rg16snorm, read_write>, read> = var undef @binding_point(1, 0)
}
...
%fragment_main = @fragment func():void {
  $B3: {
    %11:u32 = call %textureDimensions_83fcc4
    %12:void = %prevent_dce.Store 0u, %11
    ret
  }
}
Failed to generate: :10:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rg16snorm, read_write>, ptr<function, u32, read_write>)'
