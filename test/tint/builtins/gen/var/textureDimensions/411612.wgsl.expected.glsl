...
layout(binding = 1, rg8) uniform highp readonly image3D f_arg_0;
uvec3 textureDimensions_411612() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_411612();
}
//
// compute_main
//
...
layout(binding = 1, rg8) uniform highp readonly image3D arg_0;
uvec3 textureDimensions_411612() {
...
layout(binding = 0, rg8) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_411612();
  return v;
}
void main() {
