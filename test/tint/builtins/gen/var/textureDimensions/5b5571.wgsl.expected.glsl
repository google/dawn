...
layout(binding = 1, rgb10_a2) uniform highp writeonly image2DArray f_arg_0;
uvec2 textureDimensions_5b5571() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_5b5571();
}
//
// compute_main
//
...
layout(binding = 1, rgb10_a2) uniform highp writeonly image2DArray arg_0;
uvec2 textureDimensions_5b5571() {
