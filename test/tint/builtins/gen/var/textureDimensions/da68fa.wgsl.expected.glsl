...
layout(binding = 1, rg8) uniform highp readonly image2DArray f_arg_0;
uvec2 textureDimensions_da68fa() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_da68fa();
}
//
// compute_main
//
...
layout(binding = 1, rg8) uniform highp readonly image2DArray arg_0;
uvec2 textureDimensions_da68fa() {
...
layout(binding = 0, rg8) uniform highp readonly image2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_da68fa();
  return v;
}
void main() {
