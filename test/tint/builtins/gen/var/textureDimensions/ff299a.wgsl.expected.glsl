...
layout(binding = 1, rg8_snorm) uniform highp readonly image2D f_arg_0;
uvec2 textureDimensions_ff299a() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_ff299a();
}
//
// compute_main
//
...
layout(binding = 1, rg8_snorm) uniform highp readonly image2D arg_0;
uvec2 textureDimensions_ff299a() {
...
layout(binding = 0, rg8_snorm) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_ff299a();
  return v;
}
void main() {
