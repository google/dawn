...
layout(binding = 1, r16) uniform highp writeonly image2DArray f_arg_0;
uvec2 textureDimensions_ad64a1() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_ad64a1();
}
//
// compute_main
//
...
layout(binding = 1, r16) uniform highp writeonly image2DArray arg_0;
uvec2 textureDimensions_ad64a1() {
