...
layout(binding = 1, rg8) uniform highp readonly image2D f_arg_0;
uvec2 textureDimensions_b04863() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_b04863();
}
//
// compute_main
//
...
layout(binding = 1, rg8) uniform highp readonly image2D arg_0;
uvec2 textureDimensions_b04863() {
...
layout(binding = 0, rg8) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_b04863();
  return v;
}
void main() {
