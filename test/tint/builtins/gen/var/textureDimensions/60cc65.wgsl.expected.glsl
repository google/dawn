...
layout(binding = 1, rg8_snorm) uniform highp readonly image2DArray f_arg_0;
uvec2 textureDimensions_60cc65() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_60cc65();
}
//
// compute_main
//
...
layout(binding = 1, rg8_snorm) uniform highp readonly image2DArray arg_0;
uvec2 textureDimensions_60cc65() {
...
layout(binding = 0, rg8_snorm) uniform highp readonly image2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_60cc65();
  return v;
}
void main() {
