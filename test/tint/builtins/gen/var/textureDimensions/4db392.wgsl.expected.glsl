...
layout(binding = 1, r8i) uniform highp readonly iimage3D f_arg_0;
uvec3 textureDimensions_4db392() {
  uvec3 res = uvec3(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_4db392();
}
//
// compute_main
//
...
layout(binding = 1, r8i) uniform highp readonly iimage3D arg_0;
uvec3 textureDimensions_4db392() {
...
layout(binding = 0, r8i) uniform highp readonly iimage3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_4db392();
  return v;
}
void main() {
