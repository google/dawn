...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rgba32uint, read>, read> = var undef @binding_point(1, 0)
}

%textureDimensions_3e16a9 = func():u32 {
  $B2: {
    %4:texel_buffer<rgba32uint, read> = load %arg_0
...
%fragment_main = @fragment func():void {
  $B3: {
    %11:u32 = call %textureDimensions_3e16a9
    %12:void = %prevent_dce.Store 0u, %11
    ret
  }
}
Failed to generate: :15:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rgba32uint, read>, ptr<function, u32, read_write>)'
...
%textureDimensions_3e16a9 = func():u32 {
  $B2: {
    %3:texel_buffer<rgba32uint, read> = load %arg_0
...
%vertex_main_inner = func():VertexOutput {
  $B3: {
    ...
    %13:u32 = call %textureDimensions_3e16a9
    store %12, %13
...
Failed to generate: :19:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rgba32uint, read>, ptr<function, u32, read_write>)'
