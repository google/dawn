...
layout(binding = 1, rg16ui) uniform highp writeonly uimage2DArray f_arg_0;
uvec2 textureDimensions_604003() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_604003();
}
//
// compute_main
//
...
layout(binding = 1, rg16ui) uniform highp writeonly uimage2DArray arg_0;
uvec2 textureDimensions_604003() {
