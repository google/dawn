...
layout(binding = 1, rg8ui) uniform highp writeonly uimage2D f_arg_0;
uvec2 textureDimensions_3f8107() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_3f8107();
}
//
// compute_main
//
...
layout(binding = 1, rg8ui) uniform highp writeonly uimage2D arg_0;
uvec2 textureDimensions_3f8107() {
