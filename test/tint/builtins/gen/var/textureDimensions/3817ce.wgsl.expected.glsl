...
layout(binding = 1, rg16i) uniform highp writeonly iimage2D f_arg_0;
uvec2 textureDimensions_3817ce() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_3817ce();
}
//
// compute_main
//
...
layout(binding = 1, rg16i) uniform highp writeonly iimage2D arg_0;
uvec2 textureDimensions_3817ce() {
