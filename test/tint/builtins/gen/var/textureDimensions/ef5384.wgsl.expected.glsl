...
layout(binding = 1, rg8) uniform highp writeonly image2DArray f_arg_0;
uvec2 textureDimensions_ef5384() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_ef5384();
}
//
// compute_main
//
...
layout(binding = 1, rg8) uniform highp writeonly image2DArray arg_0;
uvec2 textureDimensions_ef5384() {
