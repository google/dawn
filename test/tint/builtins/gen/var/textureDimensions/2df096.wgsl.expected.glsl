...
layout(binding = 1, rg16f) uniform highp writeonly image2D f_arg_0;
uvec2 textureDimensions_2df096() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_2df096();
}
//
// compute_main
//
...
layout(binding = 1, rg16f) uniform highp writeonly image2D arg_0;
uvec2 textureDimensions_2df096() {
