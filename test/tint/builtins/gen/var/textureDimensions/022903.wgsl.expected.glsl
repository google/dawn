...
uint textureDimensions_022903() {
  uint arg_1 = 1u;
  uint res = uvec2(textureSize(f_arg_0, int(min(arg_1, (v_1.metadata[0u].x - 1u))))).x;
  return res;
}
void main() {
...
uint textureDimensions_022903() {
  uint arg_1 = 1u;
  uint res = uvec2(textureSize(arg_0, int(min(arg_1, (v_1.metadata[0u].x - 1u))))).x;
  return res;
}
...
uint textureDimensions_022903() {
  uint arg_1 = 1u;
  uint res = uvec2(textureSize(v_arg_0, int(min(arg_1, (v.metadata[0u].x - 1u))))).x;
  return res;
}
