...
layout(binding = 1, rg8_snorm) uniform highp writeonly image2DArray f_arg_0;
uvec2 textureDimensions_d06484() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_d06484();
}
//
// compute_main
//
...
layout(binding = 1, rg8_snorm) uniform highp writeonly image2DArray arg_0;
uvec2 textureDimensions_d06484() {
