...
Failed to generate: :18:14 error: glsl.textureSize: no matching call to 'glsl.textureSize(texel_buffer<rg16snorm, read>, i32)'
...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rg16snorm, read>, read> = combined_texture_sampler undef @binding_point(0, 1)
}

%textureDimensions_82085d = func():u32 {
  $B2: {
    %4:texel_buffer<rg16snorm, read> = load %arg_0
    %5:i32 = glsl.textureSize %4, 0i
    %6:u32 = bitcast %5
...
%fragment_main = @fragment func():void {
  $B3: {
    %10:u32 = call %textureDimensions_82085d
...
Failed to generate: :13:14 error: glsl.textureSize: no matching call to 'glsl.textureSize(texel_buffer<rg16snorm, read>, i32)'
...
$B1: {  # root
  %arg_0:ptr<handle, texel_buffer<rg16snorm, read>, read> = combined_texture_sampler undef @binding_point(0, 0)
}

%textureDimensions_82085d = func():u32 {
  $B2: {
    %3:texel_buffer<rg16snorm, read> = load %arg_0
    %4:i32 = glsl.textureSize %3, 0i
    %5:u32 = bitcast %4
...
%vertex_main = @vertex func():VertexOutput {
  $B3: {
    ...
    %12:u32 = call %textureDimensions_82085d
    store %11, %12
