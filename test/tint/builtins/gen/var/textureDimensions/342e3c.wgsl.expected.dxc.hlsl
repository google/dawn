...
$B1: {  # root
  ...
  %arg_0:ptr<handle, texel_buffer<rgba16unorm, read>, read> = var undef @binding_point(1, 0)
}
...
%fragment_main = @fragment func():void {
  $B3: {
    %11:u32 = call %textureDimensions_342e3c
    %12:void = %prevent_dce.Store 0u, %11
    ret
  }
}
Failed to generate: :15:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rgba16unorm, read>, ptr<function, u32, read_write>)'
...
%vertex_main_inner = func():VertexOutput {
  $B3: {
    ...
    %13:u32 = call %textureDimensions_342e3c
    store %12, %13
...
Failed to generate: :19:18 error: GetDimensions: no matching call to 'GetDimensions(texel_buffer<rgba16unorm, read>, ptr<function, u32, read_write>)'
