...
layout(binding = 1, rgb10_a2ui) uniform highp readonly uimage2D f_arg_0;
uvec2 textureDimensions_d557a0() {
  uvec2 res = uvec2(imageSize(f_arg_0));
  return res;
}
void main() {
  v.inner = textureDimensions_d557a0();
}
//
// compute_main
//
...
layout(binding = 1, rgb10_a2ui) uniform highp readonly uimage2D arg_0;
uvec2 textureDimensions_d557a0() {
...
layout(binding = 0, rgb10_a2ui) uniform highp readonly uimage2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureDimensions_d557a0();
  return v;
}
void main() {
