...
layout(binding = 1, r8ui) uniform highp writeonly uimage2DArray f_arg_0;
uvec2 textureDimensions_11615a() {
  uvec2 res = uvec2(imageSize(f_arg_0).xy);
  return res;
}
void main() {
  v.inner = textureDimensions_11615a();
}
//
// compute_main
//
...
layout(binding = 1, r8ui) uniform highp writeonly uimage2DArray arg_0;
uvec2 textureDimensions_11615a() {
