...
Matrix_left_i8_8x8 subgroupMatrixScalarAdd_7308be() {
  Matrix_left_i8_8x8 arg_0 = Matrix_left_i8_8x8::Splat(int(0));
  int arg_1 = int(8);
  Matrix_left_i8_8x8 res = tint_subgroup_matrix_scalar_op(arg_0, arg_1);
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixScalarAdd_7308be().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
