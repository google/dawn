...
uint countTrailingZeros_21e394() {
  ...
  uint v_3 = (v_1 >> v_2);
  uint v_4 = mix(0u, 8u, ((v_3 & 255u) == 0u));
  uint v_5 = (v_3 >> v_4);
  uint v_6 = mix(0u, 4u, ((v_5 & 15u) == 0u));
  uint v_7 = (v_5 >> v_6);
  uint v_8 = mix(0u, 2u, ((v_7 & 3u) == 0u));
  uint v_9 = (v_7 >> v_8);
  uint res = ((v_2 | (v_4 | (v_6 | (v_8 | mix(0u, 1u, ((v_9 & 1u) == 0u)))))) + mix(0u, 1u, (v_9 == 0u)));
  return res;
}
void main() {
...
uint countTrailingZeros_21e394() {
  ...
  uint v_2 = (v >> v_1);
  uint v_3 = mix(0u, 8u, ((v_2 & 255u) == 0u));
  uint v_4 = (v_2 >> v_3);
  uint v_5 = mix(0u, 4u, ((v_4 & 15u) == 0u));
  uint v_6 = (v_4 >> v_5);
  uint v_7 = mix(0u, 2u, ((v_6 & 3u) == 0u));
  uint v_8 = (v_6 >> v_7);
  uint res = ((v_1 | (v_3 | (v_5 | (v_7 | mix(0u, 1u, ((v_8 & 1u) == 0u)))))) + mix(0u, 1u, (v_8 == 0u)));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_9 = VertexOutput(vec4(0.0f), 0u);
  v_9.pos = vec4(0.0f);
  v_9.prevent_dce = countTrailingZeros_21e394();
  return v_9;
}
void main() {
