...
uvec3 countTrailingZeros_8ed26f() {
  ...
  uvec3 v_9 = (v_7 >> v_8);
  uvec3 res = ((v_2 | (v_4 | (v_6 | (v_8 | mix(uvec3(0u), uvec3(1u), equal((v_9 & uvec3(1u)), uvec3(0u))))))) + mix(uvec3(0u), uvec3(1u), equal(v_9, uvec3(0u))));
  return res;
}
void main() {
...
uvec3 countTrailingZeros_8ed26f() {
  ...
  uvec3 v_8 = (v_6 >> v_7);
  uvec3 res = ((v_1 | (v_3 | (v_5 | (v_7 | mix(uvec3(0u), uvec3(1u), equal((v_8 & uvec3(1u)), uvec3(0u))))))) + mix(uvec3(0u), uvec3(1u), equal(v_8, uvec3(0u))));
  return res;
}
