...
layout(binding = 1, rg16) uniform highp readonly image2D f_arg_0;
vec4 textureLoad_582a22() {
  int arg_1 = 1;
  int v_1 = arg_1;
...
layout(binding = 1, rg16) uniform highp readonly image2D arg_0;
vec4 textureLoad_582a22() {
  int arg_1 = 1;
  int v_1 = arg_1;
...
layout(binding = 0, rg16) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_2.pos = vec4(0.0f);
  v_2.prevent_dce = textureLoad_582a22();
  return v_2;
}
void main() {
