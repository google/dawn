...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_78, min(arg_1, ((v_78.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_77, min(arg_1, ((v_77.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
