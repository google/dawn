...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_81, min(arg_1, ((v_81.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_80, min(arg_1, ((v_80.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
