...
layout(binding = 1, rg16_snorm) uniform highp readonly image2D f_arg_0;
vec4 textureLoad_055c87() {
...
layout(binding = 1, rg16_snorm) uniform highp readonly image2D arg_0;
vec4 textureLoad_055c87() {
  uvec2 arg_1 = uvec2(1u);
  uvec2 v_1 = arg_1;
...
layout(binding = 0, rg16_snorm) uniform highp readonly image2D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureLoad_055c87();
  return v_1;
}
void main() {
