...
layout(binding = 1, rg16f) uniform highp readonly image3D f_arg_0;
vec4 textureLoad_5a14b2() {
  ivec3 arg_1 = ivec3(1);
  ivec3 v_1 = arg_1;
...
layout(binding = 1, rg16f) uniform highp readonly image3D arg_0;
vec4 textureLoad_5a14b2() {
  ivec3 arg_1 = ivec3(1);
  ivec3 v_1 = arg_1;
...
layout(binding = 0, rg16f) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_2.pos = vec4(0.0f);
  v_2.prevent_dce = textureLoad_5a14b2();
  return v_2;
}
void main() {
