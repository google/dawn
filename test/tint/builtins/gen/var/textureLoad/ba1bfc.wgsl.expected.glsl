...
layout(binding = 1, r16ui) uniform highp readonly uimage2DArray f_arg_0;
uvec4 textureLoad_ba1bfc() {
...
layout(binding = 1, r16ui) uniform highp readonly uimage2DArray arg_0;
uvec4 textureLoad_ba1bfc() {
  uvec2 arg_1 = uvec2(1u);
  int arg_2 = 1;
  uvec2 v_1 = arg_1;
...
layout(binding = 0, r16ui) uniform highp readonly uimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_5.pos = vec4(0.0f);
  v_5.prevent_dce = textureLoad_ba1bfc();
  return v_5;
}
void main() {
