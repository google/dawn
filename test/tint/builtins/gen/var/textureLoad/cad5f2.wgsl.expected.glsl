...
uvec4 textureLoad_cad5f2() {
  ...
  uvec2 v_4 = (uvec2(textureSize(f_arg_0)) - uvec2(1u));
...
uvec4 textureLoad_cad5f2() {
  ...
  ivec2 v_2 = arg_1;
  uint v_3 = min(arg_2, (v_1.metadata[0u].x - 1u));
  uvec2 v_4 = (uvec2(textureSize(arg_0)) - uvec2(1u));
  ivec2 v_5 = ivec2(min(uvec2(v_2), v_4));
...
uvec4 textureLoad_cad5f2() {
  ...
  uvec2 v_3 = (uvec2(textureSize(v_arg_0)) - uvec2(1u));
...
VertexOutput vertex_main_inner() {
  ...
  v_5.pos = vec4(0.0f);
  v_5.prevent_dce = textureLoad_cad5f2();
  return v_5;
}
void main() {
