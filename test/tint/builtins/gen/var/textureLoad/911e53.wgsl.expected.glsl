...
layout(binding = 1, rgba16_snorm) uniform highp readonly image3D f_arg_0;
vec4 textureLoad_911e53() {
...
layout(binding = 1, rgba16_snorm) uniform highp readonly image3D arg_0;
vec4 textureLoad_911e53() {
  uvec3 arg_1 = uvec3(1u);
  uvec3 v_1 = arg_1;
...
layout(binding = 0, rgba16_snorm) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureLoad_911e53();
  return v_1;
}
void main() {
