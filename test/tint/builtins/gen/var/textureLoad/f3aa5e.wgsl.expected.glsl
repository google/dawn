...
layout(binding = 1, rg16i) uniform highp readonly iimage2DArray f_arg_0;
ivec4 textureLoad_f3aa5e() {
...
layout(binding = 1, rg16i) uniform highp readonly iimage2DArray arg_0;
ivec4 textureLoad_f3aa5e() {
  uvec2 arg_1 = uvec2(1u);
  int arg_2 = 1;
  uvec2 v_1 = arg_1;
...
layout(binding = 0, rg16i) uniform highp readonly iimage2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_5.pos = vec4(0.0f);
  v_5.prevent_dce = textureLoad_f3aa5e();
  return v_5;
}
void main() {
