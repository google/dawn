...
layout(binding = 1, r16_snorm) uniform highp readonly image3D f_arg_0;
vec4 textureLoad_17ecfd() {
  ivec3 arg_1 = ivec3(1);
  ivec3 v_1 = arg_1;
...
layout(binding = 1, r16_snorm) uniform highp readonly image3D arg_0;
vec4 textureLoad_17ecfd() {
  ivec3 arg_1 = ivec3(1);
  ivec3 v_1 = arg_1;
...
layout(binding = 0, r16_snorm) uniform highp readonly image3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_2.pos = vec4(0.0f);
  v_2.prevent_dce = textureLoad_17ecfd();
  return v_2;
}
void main() {
