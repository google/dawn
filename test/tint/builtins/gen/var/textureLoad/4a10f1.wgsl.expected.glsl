...
layout(binding = 1, r8ui) uniform highp readonly uimage3D f_arg_0;
uvec4 textureLoad_4a10f1() {
...
layout(binding = 1, r8ui) uniform highp readonly uimage3D arg_0;
uvec4 textureLoad_4a10f1() {
  uvec3 arg_1 = uvec3(1u);
  uvec3 v_1 = arg_1;
...
layout(binding = 0, r8ui) uniform highp readonly uimage3D v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v_1.pos = vec4(0.0f);
  v_1.prevent_dce = textureLoad_4a10f1();
  return v_1;
}
void main() {
