...
int4 extractBits_fb850f() {
  ...
  uint v_3 = (v_2 + v_1);
  int4 v_4 = select((v_2 < 32u), asint((asuint(v) << uint4((v_2).xxxx))), (int(0)).xxxx);
  int4 res = select((v_3 < 32u), (v_4 >> uint4((v_3).xxxx)), ((v_4 >> (31u).xxxx) >> (1u).xxxx));
  return res;
}
...
VertexOutput vertex_main_inner() {
  ...
  v_5.pos = (0.0f).xxxx;
  v_5.prevent_dce = extractBits_fb850f();
