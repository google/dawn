...
uvec2 countLeadingZeros_70783f() {
  ...
  uvec2 res = ((v_2 | (v_4 | (v_6 | (v_8 | (mix(uvec2(0u), uvec2(1u), lessThanEqual(v_9, uvec2(2147483647u))) | v_10))))) + v_10);
  return res;
}
void main() {
...
uvec2 countLeadingZeros_70783f() {
  ...
  uvec2 res = ((v_1 | (v_3 | (v_5 | (v_7 | (mix(uvec2(0u), uvec2(1u), lessThanEqual(v_8, uvec2(2147483647u))) | v_9))))) + v_9);
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_10 = VertexOutput(vec4(0.0f), uvec2(0u));
  v_10.pos = vec4(0.0f);
