...
int countLeadingZeros_6d4656() {
  ...
  uint v_2 = (v << v_1);
  uint v_3 = (((v_2 <= 16777215u)) ? (8u) : (0u));
  uint v_4 = (v_2 << v_3);
  uint v_5 = (((v_4 <= 268435455u)) ? (4u) : (0u));
  uint v_6 = (v_4 << v_5);
  uint v_7 = (((v_6 <= 1073741823u)) ? (2u) : (0u));
  uint v_8 = (v_6 << v_7);
  uint v_9 = (((v_8 <= 2147483647u)) ? (1u) : (0u));
  uint v_10 = (((v_8 == 0u)) ? (1u) : (0u));
  int res = asint(((v_1 | (v_3 | (v_5 | (v_7 | (v_9 | v_10))))) + v_10));
  return res;
}
...
VertexOutput vertex_main_inner() {
  ...
  v_11.pos = (0.0f).xxxx;
  v_11.prevent_dce = countLeadingZeros_6d4656();
