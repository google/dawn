...
ivec3 countLeadingZeros_7c38a6() {
  ...
  ivec3 res = ivec3(((v_2 | (v_4 | (v_6 | (v_8 | (mix(uvec3(0u), uvec3(1u), lessThanEqual(v_9, uvec3(2147483647u))) | v_10))))) + v_10));
  return res;
}
void main() {
...
ivec3 countLeadingZeros_7c38a6() {
  ...
  ivec3 res = ivec3(((v_1 | (v_3 | (v_5 | (v_7 | (mix(uvec3(0u), uvec3(1u), lessThanEqual(v_8, uvec3(2147483647u))) | v_9))))) + v_9));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_10 = VertexOutput(vec4(0.0f), ivec3(0));
  v_10.pos = vec4(0.0f);
  v_10.prevent_dce = countLeadingZeros_7c38a6();
  return v_10;
}
void main() {
