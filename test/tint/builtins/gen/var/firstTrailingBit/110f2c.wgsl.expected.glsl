...
uvec4 firstTrailingBit_110f2c() {
  ...
  uvec4 v_9 = (v_7 >> v_8);
  uvec4 res = mix((v_2 | (v_4 | (v_6 | (v_8 | mix(uvec4(0u), uvec4(1u), equal((v_9 & uvec4(1u)), uvec4(0u))))))), uvec4(4294967295u), equal(v_9, uvec4(0u)));
  return res;
}
void main() {
...
uvec4 firstTrailingBit_110f2c() {
  ...
  uvec4 v_8 = (v_6 >> v_7);
  uvec4 res = mix((v_1 | (v_3 | (v_5 | (v_7 | mix(uvec4(0u), uvec4(1u), equal((v_8 & uvec4(1u)), uvec4(0u))))))), uvec4(4294967295u), equal(v_8, uvec4(0u)));
  return res;
}
