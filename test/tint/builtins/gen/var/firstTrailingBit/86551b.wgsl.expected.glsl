...
ivec4 firstTrailingBit_86551b() {
  ...
  uvec4 v_9 = (v_7 >> v_8);
  ivec4 res = ivec4(mix((v_2 | (v_4 | (v_6 | (v_8 | mix(uvec4(0u), uvec4(1u), equal((v_9 & uvec4(1u)), uvec4(0u))))))), uvec4(4294967295u), equal(v_9, uvec4(0u))));
  return res;
}
void main() {
...
ivec4 firstTrailingBit_86551b() {
  ...
  uvec4 v_8 = (v_6 >> v_7);
  ivec4 res = ivec4(mix((v_1 | (v_3 | (v_5 | (v_7 | mix(uvec4(0u), uvec4(1u), equal((v_8 & uvec4(1u)), uvec4(0u))))))), uvec4(4294967295u), equal(v_8, uvec4(0u))));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_9 = VertexOutput(vec4(0.0f), ivec4(0));
  v_9.pos = vec4(0.0f);
  v_9.prevent_dce = firstTrailingBit_86551b();
  return v_9;
}
void main() {
