...
uvec3 firstTrailingBit_cb51ce() {
  ...
  uvec3 v_9 = (v_7 >> v_8);
  uvec3 res = mix((v_2 | (v_4 | (v_6 | (v_8 | mix(uvec3(0u), uvec3(1u), equal((v_9 & uvec3(1u)), uvec3(0u))))))), uvec3(4294967295u), equal(v_9, uvec3(0u)));
  return res;
}
void main() {
...
uvec3 firstTrailingBit_cb51ce() {
  ...
  uvec3 v_8 = (v_6 >> v_7);
  uvec3 res = mix((v_1 | (v_3 | (v_5 | (v_7 | mix(uvec3(0u), uvec3(1u), equal((v_8 & uvec3(1u)), uvec3(0u))))))), uvec3(4294967295u), equal(v_8, uvec3(0u)));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_9 = VertexOutput(vec4(0.0f), uvec3(0u));
  v_9.pos = vec4(0.0f);
  v_9.prevent_dce = firstTrailingBit_cb51ce();
  return v_9;
}
void main() {
