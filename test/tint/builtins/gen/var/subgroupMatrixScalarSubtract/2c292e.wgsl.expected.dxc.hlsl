...
Matrix_result_u8_8x8 subgroupMatrixScalarSubtract_2c292e() {
  Matrix_result_u8_8x8 arg_0 = Matrix_result_u8_8x8::Splat(0u);
  uint arg_1 = 8u;
  Matrix_result_u8_8x8 res = tint_subgroup_matrix_scalar_op(arg_0, arg_1);
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixScalarSubtract_2c292e().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
