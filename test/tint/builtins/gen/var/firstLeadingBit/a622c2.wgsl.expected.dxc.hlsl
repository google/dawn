...
int2 firstLeadingBit_a622c2() {
  ...
  uint2 v_1 = select((v < (2147483648u).xx), v, ~(v));
  uint2 v_2 = select(((v_1 & (4294901760u).xx) == (0u).xx), (0u).xx, (16u).xx);
  uint2 v_3 = (v_1 >> v_2);
  uint2 v_4 = select(((v_3 & (65280u).xx) == (0u).xx), (0u).xx, (8u).xx);
  uint2 v_5 = (v_3 >> v_4);
  uint2 v_6 = select(((v_5 & (240u).xx) == (0u).xx), (0u).xx, (4u).xx);
  uint2 v_7 = (v_5 >> v_6);
  uint2 v_8 = select(((v_7 & (12u).xx) == (0u).xx), (0u).xx, (2u).xx);
  uint2 v_9 = (v_7 >> v_8);
  int2 res = asint(select((v_9 == (0u).xx), (4294967295u).xx, (v_2 | (v_4 | (v_6 | (v_8 | select(((v_9 & (2u).xx) == (0u).xx), (0u).xx, (1u).xx)))))));
  return res;
}
