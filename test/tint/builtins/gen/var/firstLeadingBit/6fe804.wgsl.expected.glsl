...
uvec2 firstLeadingBit_6fe804() {
  ...
  uvec2 v_9 = (v_7 >> v_8);
  uvec2 res = mix((v_2 | (v_4 | (v_6 | (v_8 | mix(uvec2(1u), uvec2(0u), equal((v_9 & uvec2(2u)), uvec2(0u))))))), uvec2(4294967295u), equal(v_9, uvec2(0u)));
  return res;
}
void main() {
...
uvec2 firstLeadingBit_6fe804() {
  ...
  uvec2 v_2 = (v >> v_1);
  uvec2 v_3 = mix(uvec2(8u), uvec2(0u), equal((v_2 & uvec2(65280u)), uvec2(0u)));
  uvec2 v_4 = (v_2 >> v_3);
  uvec2 v_5 = mix(uvec2(4u), uvec2(0u), equal((v_4 & uvec2(240u)), uvec2(0u)));
  uvec2 v_6 = (v_4 >> v_5);
  uvec2 v_7 = mix(uvec2(2u), uvec2(0u), equal((v_6 & uvec2(12u)), uvec2(0u)));
  uvec2 v_8 = (v_6 >> v_7);
  uvec2 res = mix((v_1 | (v_3 | (v_5 | (v_7 | mix(uvec2(1u), uvec2(0u), equal((v_8 & uvec2(2u)), uvec2(0u))))))), uvec2(4294967295u), equal(v_8, uvec2(0u)));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_9 = VertexOutput(vec4(0.0f), uvec2(0u));
  v_9.pos = vec4(0.0f);
  v_9.prevent_dce = firstLeadingBit_6fe804();
  return v_9;
}
void main() {
