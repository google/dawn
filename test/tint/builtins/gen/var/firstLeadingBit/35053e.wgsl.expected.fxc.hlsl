...
int3 firstLeadingBit_35053e() {
  ...
  uint3 v_3 = (v_1 >> v_2);
  uint3 v_4 = ((((v_3 & (65280u).xxx) == (0u).xxx)) ? ((0u).xxx) : ((8u).xxx));
  uint3 v_5 = (v_3 >> v_4);
  uint3 v_6 = ((((v_5 & (240u).xxx) == (0u).xxx)) ? ((0u).xxx) : ((4u).xxx));
  uint3 v_7 = (v_5 >> v_6);
  uint3 v_8 = ((((v_7 & (12u).xxx) == (0u).xxx)) ? ((0u).xxx) : ((2u).xxx));
  uint3 v_9 = (v_7 >> v_8);
  int3 res = asint((((v_9 == (0u).xxx)) ? ((4294967295u).xxx) : ((v_2 | (v_4 | (v_6 | (v_8 | ((((v_9 & (2u).xxx) == (0u).xxx)) ? ((0u).xxx) : ((1u).xxx)))))))));
  return res;
}
