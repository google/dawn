...
uint2 firstLeadingBit_6fe804() {
  ...
  uint2 v_2 = (v >> v_1);
  uint2 v_3 = ((((v_2 & (65280u).xx) == (0u).xx)) ? ((0u).xx) : ((8u).xx));
  uint2 v_4 = (v_2 >> v_3);
  uint2 v_5 = ((((v_4 & (240u).xx) == (0u).xx)) ? ((0u).xx) : ((4u).xx));
  uint2 v_6 = (v_4 >> v_5);
  uint2 v_7 = ((((v_6 & (12u).xx) == (0u).xx)) ? ((0u).xx) : ((2u).xx));
  uint2 v_8 = (v_6 >> v_7);
  uint2 res = (((v_8 == (0u).xx)) ? ((4294967295u).xx) : ((v_1 | (v_3 | (v_5 | (v_7 | ((((v_8 & (2u).xx) == (0u).xx)) ? ((0u).xx) : ((1u).xx))))))));
  return res;
}
