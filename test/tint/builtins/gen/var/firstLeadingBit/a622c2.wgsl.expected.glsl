...
ivec2 firstLeadingBit_a622c2() {
  ...
  uvec2 v_4 = (v_2 >> v_3);
  uvec2 v_5 = mix(uvec2(8u), uvec2(0u), equal((v_4 & uvec2(65280u)), uvec2(0u)));
  uvec2 v_6 = (v_4 >> v_5);
  uvec2 v_7 = mix(uvec2(4u), uvec2(0u), equal((v_6 & uvec2(240u)), uvec2(0u)));
  uvec2 v_8 = (v_6 >> v_7);
  uvec2 v_9 = mix(uvec2(2u), uvec2(0u), equal((v_8 & uvec2(12u)), uvec2(0u)));
  uvec2 v_10 = (v_8 >> v_9);
  ivec2 res = ivec2(mix((v_3 | (v_5 | (v_7 | (v_9 | mix(uvec2(1u), uvec2(0u), equal((v_10 & uvec2(2u)), uvec2(0u))))))), uvec2(4294967295u), equal(v_10, uvec2(0u))));
  return res;
}
void main() {
...
ivec2 firstLeadingBit_a622c2() {
  ...
  uvec2 v_9 = (v_7 >> v_8);
  ivec2 res = ivec2(mix((v_2 | (v_4 | (v_6 | (v_8 | mix(uvec2(1u), uvec2(0u), equal((v_9 & uvec2(2u)), uvec2(0u))))))), uvec2(4294967295u), equal(v_9, uvec2(0u))));
  return res;
}
