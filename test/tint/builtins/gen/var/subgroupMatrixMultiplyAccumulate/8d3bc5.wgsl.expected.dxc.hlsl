...
Matrix_result_i8_8x8 subgroupMatrixMultiplyAccumulate_8d3bc5() {
  ...
  Matrix_result_i8_8x8 res = tint_MatrixMultiplyAccumulate(arg_0, arg_1, arg_2);
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiplyAccumulate_8d3bc5().Store(prevent_dce, 0u, 8u, MatrixLayout::RowMajor);
}
