...
Matrix_result_u8_8x8 subgroupMatrixMultiplyAccumulate_052cba() {
  ...
  Matrix_result_u8_8x8 arg_2 = Matrix_result_u8_8x8::Splat(0u);
  Matrix_result_u8_8x8 res = tint_MatrixMultiplyAccumulate(arg_0, arg_1, arg_2);
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixMultiplyAccumulate_052cba().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
