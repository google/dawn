...
%subgroupMatrixMultiplyAccumulate_877989 = func():subgroup_matrix_result<u32, 8, 8> {
  $B2: {
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %16:subgroup_matrix_result<u32, 8, 8> = call %subgroupMatrixMultiplyAccumulate_877989
