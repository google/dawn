...
%subgroupMatrixMultiplyAccumulate_071472 = func():subgroup_matrix_result<f32, 8, 8> {
  $B2: {
    ...
    %12:subgroup_matrix_result<f32, 8, 8> = subgroupMatrixMultiplyAccumulate %9, %10, %11
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %16:subgroup_matrix_result<f32, 8, 8> = call %subgroupMatrixMultiplyAccumulate_071472
