...
%subgroupMatrixMultiply_42abed = func():subgroup_matrix_result<f16, 8, 8> {
  $B2: {
    ...
    %9:subgroup_matrix_result<f16, 8, 8> = subgroupMatrixMultiply<f16> %7, %8
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %13:subgroup_matrix_result<f16, 8, 8> = call %subgroupMatrixMultiply_42abed
