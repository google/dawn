...
layout(binding = 1, r16) uniform highp readonly image2DArray f_arg_0;
uint textureNumLayers_137c24() {
  uint res = uint(imageSize(f_arg_0).z);
  return res;
}
void main() {
  v.inner = textureNumLayers_137c24();
}
//
// compute_main
//
...
layout(binding = 1, r16) uniform highp readonly image2DArray arg_0;
uint textureNumLayers_137c24() {
...
layout(binding = 0, r16) uniform highp readonly image2DArray v_arg_0;
...
VertexOutput vertex_main_inner() {
  ...
  v.pos = vec4(0.0f);
  v.prevent_dce = textureNumLayers_137c24();
  return v;
}
void main() {
