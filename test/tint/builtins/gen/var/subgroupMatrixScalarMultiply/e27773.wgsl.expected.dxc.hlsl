...
Matrix_right_u8_8x8 subgroupMatrixScalarMultiply_e27773() {
  Matrix_right_u8_8x8 arg_0 = Matrix_right_u8_8x8::Splat(0u);
  uint arg_1 = 8u;
  Matrix_right_u8_8x8 res = tint_subgroup_matrix_scalar_op(arg_0, arg_1);
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixScalarMultiply_e27773().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
