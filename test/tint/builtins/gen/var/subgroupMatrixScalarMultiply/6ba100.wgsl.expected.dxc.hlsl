...
Matrix_result_u32_8x8 tint_subgroup_matrix_scalar_op(Matrix_result_u32_8x8 m, uint s) {
  Matrix_result_u32_8x8 result = m;
  {
    uint v = 0u;
    v = 0u;
    while(true) {
...
Matrix_result_u32_8x8 subgroupMatrixScalarMultiply_6ba100() {
  Matrix_result_u32_8x8 arg_0 = Matrix_result_u32_8x8::Splat(0u);
  uint arg_1 = 8u;
  Matrix_result_u32_8x8 res = tint_subgroup_matrix_scalar_op(arg_0, arg_1);
  return res;
}

[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixScalarMultiply_6ba100().Store(prevent_dce, 0u, 64u, MatrixLayout::RowMajor);
}
