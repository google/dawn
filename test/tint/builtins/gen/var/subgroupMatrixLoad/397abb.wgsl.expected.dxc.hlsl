...
Matrix_left_i8_8x8 subgroupMatrixLoad_397abb() {
  int arg_1 = int(1);
  int arg_3 = int(8);
  int v = arg_1;
  ...
  if ((((asuint(v) + (v_1 * 7u)) + 8u) <= 4096u)) {
    v_2 = Matrix_left_i8_8x8::Load(sb_ro, (0u + (uint(v) * 1u)), (v_1 * 1u), MatrixLayout::ColMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_397abb().Store(prevent_dce, 0u, 8u, MatrixLayout::RowMajor);
}
