...
Matrix_result_u8_8x8 subgroupMatrixLoad_bbc2f9() {
  uint arg_1 = 1u;
  uint arg_3 = 8u;
  uint v = arg_1;
  ...
  if ((((v + (v_1 * 7u)) + 8u) <= 4096u)) {
    v_2 = Matrix_result_u8_8x8::Load(sb_ro, (0u + (v * 1u)), (v_1 * 1u), MatrixLayout::ColMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_bbc2f9().Store(prevent_dce, 0u, 8u, MatrixLayout::RowMajor);
}
