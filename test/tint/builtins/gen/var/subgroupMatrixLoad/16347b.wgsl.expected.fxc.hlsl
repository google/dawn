...
%subgroupMatrixLoad_16347b = func():subgroup_matrix_right<f16, 8, 8> {
  $B2: {
    ...
    %7:u32 = load %arg_1
    %8:u32 = load %arg_2
    %9:subgroup_matrix_right<f16, 8, 8> = subgroupMatrixLoad<subgroup_matrix_right<f16, 8, 8>, col_major> %6, %7, %8
    %res:ptr<function, subgroup_matrix_right<f16, 8, 8>, read_write> = var %9
    %11:subgroup_matrix_right<f16, 8, 8> = load %res
    ret %11
  }
}
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %13:subgroup_matrix_right<f16, 8, 8> = call %subgroupMatrixLoad_16347b
