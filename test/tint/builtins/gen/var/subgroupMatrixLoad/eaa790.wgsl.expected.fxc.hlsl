...
%subgroupMatrixLoad_eaa790 = func():subgroup_matrix_result<f16, 8, 8> {
  $B2: {
    ...
    %7:u32 = load %arg_1
    %8:u32 = load %arg_2
    %9:subgroup_matrix_result<f16, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<f16, 8, 8>> %6, %7, false, %8
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %13:subgroup_matrix_result<f16, 8, 8> = call %subgroupMatrixLoad_eaa790
