...
%subgroupMatrixLoad_60b835 = func():subgroup_matrix_right<i8, 8, 8> {
  $B2: {
    ...
    %6:u32 = load %arg_1
    %7:u32 = load %arg_3
    %8:subgroup_matrix_right<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_right<i8, 8, 8>> %arg_0, %6, true, %7
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %12:subgroup_matrix_right<i8, 8, 8> = call %subgroupMatrixLoad_60b835
