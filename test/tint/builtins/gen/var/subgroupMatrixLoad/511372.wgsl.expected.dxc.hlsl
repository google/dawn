...
Matrix_left_f16_8x8 subgroupMatrixLoad_511372() {
  int arg_1 = int(1);
  int arg_2 = int(8);
  uint v = max(asuint(arg_2), 8u);
  uint v_1 = asuint(arg_1);
  bool v_2 = (((v_1 + (v * 7u)) + 8u) <= 1024u);
  Matrix_left_f16_8x8 res = Matrix_left_f16_8x8::Load(arg_0, select(v_2, v_1, 0u), select(v_2, v, 8u), MatrixLayout::ColMajor);
  return res;
}
...
void compute_main_inner(uint tint_local_index) {
  ...
  subgroupMatrixLoad_511372().Store(prevent_dce, 0u, 16u, MatrixLayout::RowMajor);
}
