...
Matrix_result_u32_8x8 subgroupMatrixLoad_06297f() {
  uint arg_1 = 1u;
  int arg_3 = int(8);
  uint v = arg_1;
  ...
  if ((((v + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_result_u32_8x8::Load(sb_rw, (0u + (v * 4u)), (v_1 * 4u), MatrixLayout::ColMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_06297f().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
