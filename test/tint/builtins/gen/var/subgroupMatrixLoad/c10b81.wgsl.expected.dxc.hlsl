...
Matrix_right_f32_8x8 subgroupMatrixLoad_c10b81() {
  int arg_1 = int(1);
  int arg_3 = int(8);
  int v = arg_1;
  ...
  if ((((asuint(v) + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_right_f32_8x8::Load(sb_ro, (0u + (uint(v) * 4u)), (v_1 * 4u), MatrixLayout::ColMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_c10b81().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
