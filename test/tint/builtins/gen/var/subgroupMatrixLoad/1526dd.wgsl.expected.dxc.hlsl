...
Matrix_left_i32_8x8 subgroupMatrixLoad_1526dd() {
  int arg_1 = int(1);
  int arg_2 = int(8);
  int v = arg_1;
  ...
  if ((((asuint(v) + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_left_i32_8x8::Load(sb_rw, (0u + (uint(v) * 4u)), (v_1 * 4u), MatrixLayout::RowMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_1526dd().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
