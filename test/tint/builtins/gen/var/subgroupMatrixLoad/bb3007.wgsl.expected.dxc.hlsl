...
Matrix_result_f16_8x8 subgroupMatrixLoad_bb3007() {
  uint arg_1 = 1u;
  int arg_3 = int(8);
  uint v = arg_1;
  ...
  if ((((v + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_result_f16_8x8::Load(arg_0, v, v_1, MatrixLayout::ColMajor);
  }
...
void compute_main_inner(uint tint_local_index) {
  ...
  subgroupMatrixLoad_bb3007().Store(prevent_dce, 0u, 16u, MatrixLayout::RowMajor);
}
