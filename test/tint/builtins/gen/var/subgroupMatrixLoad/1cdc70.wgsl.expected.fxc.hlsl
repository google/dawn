...
%subgroupMatrixLoad_1cdc70 = func():subgroup_matrix_result<i8, 8, 8> {
  $B2: {
    ...
    %7:i32 = load %arg_1
    %8:i32 = load %arg_2
    %9:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, row_major> %6, %7, %8
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %13:subgroup_matrix_result<i8, 8, 8> = call %subgroupMatrixLoad_1cdc70
