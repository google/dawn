...
Matrix_result_u32_8x8 subgroupMatrixLoad_e2bcc9() {
  int arg_1 = int(1);
  int arg_3 = int(8);
  int v = arg_1;
  ...
  if ((((asuint(v) + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_result_u32_8x8::Load(arg_0, asuint(v), v_1, MatrixLayout::ColMajor);
  }
...
void compute_main_inner(uint tint_local_index) {
  ...
  subgroupMatrixLoad_e2bcc9().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
