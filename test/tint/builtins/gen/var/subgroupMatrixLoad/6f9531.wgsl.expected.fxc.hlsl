...
%subgroupMatrixLoad_6f9531 = func():subgroup_matrix_result<u8, 8, 8> {
  $B2: {
    ...
    %6:u32 = load %arg_1
    %7:u32 = load %arg_2
    %8:subgroup_matrix_result<u8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<u8, 8, 8>, col_major> %arg_0, %6, %7
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %12:subgroup_matrix_result<u8, 8, 8> = call %subgroupMatrixLoad_6f9531
