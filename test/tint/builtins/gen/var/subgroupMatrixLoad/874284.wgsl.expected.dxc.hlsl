...
Matrix_right_u8_8x8 subgroupMatrixLoad_874284() {
  int arg_1 = int(1);
  uint arg_3 = 8u;
  int v = arg_1;
  ...
  if ((((asuint(v) + (v_1 * 7u)) + 8u) <= 4096u)) {
    v_2 = Matrix_right_u8_8x8::Load(sb_rw, (0u + (uint(v) * 1u)), (v_1 * 1u), MatrixLayout::ColMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_874284().Store(prevent_dce, 0u, 8u, MatrixLayout::RowMajor);
}
