...
%subgroupMatrixLoad_0c5a28 = func():subgroup_matrix_left<i32, 8, 8> {
  $B2: {
    ...
    %6:u32 = load %arg_1
    %7:i32 = load %arg_2
    %8:subgroup_matrix_left<i32, 8, 8> = subgroupMatrixLoad<subgroup_matrix_left<i32, 8, 8>, row_major> %arg_0, %6, %7
...
%compute_main = @compute @workgroup_size(1i, 1i, 1i) func():void {
  $B3: {
    %12:subgroup_matrix_left<i32, 8, 8> = call %subgroupMatrixLoad_0c5a28
