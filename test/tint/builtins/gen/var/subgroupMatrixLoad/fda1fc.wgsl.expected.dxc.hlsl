...
Matrix_right_f32_8x8 subgroupMatrixLoad_fda1fc() {
  int arg_1 = int(1);
  uint arg_3 = 8u;
  int v = arg_1;
  ...
  if ((((asuint(v) + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_right_f32_8x8::Load(arg_0, asuint(v), v_1, MatrixLayout::ColMajor);
  }
...
void compute_main_inner(uint tint_local_index) {
  ...
  subgroupMatrixLoad_fda1fc().Store(prevent_dce, 0u, 32u, MatrixLayout::RowMajor);
}
