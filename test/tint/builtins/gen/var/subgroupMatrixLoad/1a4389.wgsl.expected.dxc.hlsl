...
Matrix_left_u32_8x8 subgroupMatrixLoad_1a4389() {
  uint arg_1 = 1u;
  uint arg_2 = 8u;
  uint v = arg_1;
  ...
  if ((((v + (v_1 * 7u)) + 8u) <= 1024u)) {
    v_2 = Matrix_left_u32_8x8::Load(sb_ro, (0u + (v * 4u)), (v_1 * 4u), MatrixLayout::RowMajor);
  }
...
[numthreads(1, 1, 1)]
void compute_main() {
  subgroupMatrixLoad_1a4389().Store(prevent_dce, 0u, 256u, MatrixLayout::RowMajor);
}
