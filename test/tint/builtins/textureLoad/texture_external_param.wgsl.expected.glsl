...
void doTextureLoad() {
  vec4 res = textureLoad2d(v_49(0u), ivec2(0));
}
...
void main() {
  vec4 v_77 = vertex_main_inner();
  gl_Position = vec4(v_77.x, -(v_77.y), ((2.0f * v_77.z) - v_77.w), v_77.w);
  gl_PointSize = 1.0f;
}
//
// fragment_main
...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  float v_15 = 0.0f;
  if ((params.numPlanes == 1u)) {
    vec4 v_16 = texelFetch(f_arg_0_plane0, ivec2(v_13), 0);
    v_14 = v_16.xyz;
    v_15 = v_16.w;
  } else {
    float v_17 = texelFetch(f_arg_0_plane0, ivec2(v_13), 0).x;
    v_14 = (vec4(v_17, texelFetch(f_arg_0_plane1, ivec2(uvec2((v_12 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_15 = 1.0f;
  }
  vec3 v_18 = v_14;
  vec3 v_19 = vec3(0.0f);
...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  float v_15 = 0.0f;
  if ((params.numPlanes == 1u)) {
    vec4 v_16 = texelFetch(arg_0_plane0, ivec2(v_13), 0);
    v_14 = v_16.xyz;
    v_15 = v_16.w;
  } else {
    float v_17 = texelFetch(arg_0_plane0, ivec2(v_13), 0).x;
    v_14 = (vec4(v_17, texelFetch(arg_0_plane1, ivec2(uvec2((v_12 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_15 = 1.0f;
  }
  vec3 v_18 = v_14;
  vec3 v_19 = vec3(0.0f);
