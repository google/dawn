...
void main() {
  ...
  Matrix_result_f32_8x8 m1 = Matrix_result_f32_8x8::Load(in1, 0u, 128u, MatrixLayout::RowMajor);
  uint v_3 = 0u;
  v.GetDimensions(v_3);
  bool v_4 = (120u <= (v_3 / 4u));
  m1.Store(v, (0u + (select(v_4, 0u, 0u) * 4u)), (select(v_4, 16u, 8u) * 4u), MatrixLayout::ColMajor);
  Matrix_result_f32_8x8 m2 = Matrix_result_f32_8x8::Load(in2, 0u, 256u, MatrixLayout::RowMajor);
  uint v_5 = 0u;
  v.GetDimensions(v_5);
  bool v_6 = (120u <= (v_5 / 4u));
  m2.Store(v, (0u + (select(v_6, 0u, 0u) * 4u)), (select(v_6, 16u, 8u) * 4u), MatrixLayout::ColMajor);
  Matrix_result_f32_8x8 m3 = Matrix_result_f32_8x8::Load(in3, 0u, 256u, MatrixLayout::RowMajor);
  uint v_7 = 0u;
  v.GetDimensions(v_7);
  ...
  Matrix_result_f32_8x8 m6 = Matrix_result_f32_8x8::Load(in6, 0u, 128u, MatrixLayout::RowMajor);
  uint v_11 = 0u;
