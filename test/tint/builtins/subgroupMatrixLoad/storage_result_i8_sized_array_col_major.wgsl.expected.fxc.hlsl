...
%main = @compute @workgroup_size(64i, 1i, 1i) func():void {
  $B2: {
    %10:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in0, 0u, 16u
    %m0:subgroup_matrix_result<i8, 8, 8> = let %10
    %12:void = subgroupMatrixStore<col_major> %out, 0i, %m0, 16i
    %13:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in1, 0u, 16u
    %m1:subgroup_matrix_result<i8, 8, 8> = let %13
    %15:void = subgroupMatrixStore<col_major> %out, 0i, %m1, 16i
    %16:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in2, 0u, 16u
    %m2:subgroup_matrix_result<i8, 8, 8> = let %16
    %18:void = subgroupMatrixStore<col_major> %out, 0i, %m2, 16i
    %19:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in3, 0u, 16u
    %m3:subgroup_matrix_result<i8, 8, 8> = let %19
    %21:void = subgroupMatrixStore<col_major> %out, 0i, %m3, 16i
    %22:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in4, 0u, 16u
    %m4:subgroup_matrix_result<i8, 8, 8> = let %22
    %24:void = subgroupMatrixStore<col_major> %out, 0i, %m4, 16i
    %25:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in5, 0u, 16u
    %m5:subgroup_matrix_result<i8, 8, 8> = let %25
    %27:void = subgroupMatrixStore<col_major> %out, 0i, %m5, 16i
    %28:subgroup_matrix_result<i8, 8, 8> = subgroupMatrixLoad<subgroup_matrix_result<i8, 8, 8>, col_major> %in6, 0u, 16u
    %m6:subgroup_matrix_result<i8, 8, 8> = let %28
