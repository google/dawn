...
void main() {
  ...
  Matrix_right_i32_8x8 m1 = Matrix_right_i32_8x8::Load(in1, (0u + (select(v_8, 0u, 0u) * 8u)), (select(v_8, 16u, 4u) * 8u), MatrixLayout::RowMajor);
  uint v_9 = 0u;
  v.GetDimensions(v_9);
  ...
  Matrix_right_i32_8x8 m2 = Matrix_right_i32_8x8::Load(in2, (0u + (select(v_14, 0u, 0u) * 16u)), (select(v_14, 16u, 2u) * 16u), MatrixLayout::RowMajor);
  uint v_15 = 0u;
  ...
  Matrix_right_i32_8x8 m3 = Matrix_right_i32_8x8::Load(in3, (0u + (select(v_20, 0u, 0u) * 16u)), (select(v_20, 16u, 2u) * 16u), MatrixLayout::RowMajor);
  uint v_21 = 0u;
  ...
  Matrix_right_i32_8x8 m6 = Matrix_right_i32_8x8::Load(in6, (0u + (select(v_32, 0u, 0u) * 8u)), (select(v_32, 16u, 4u) * 8u), MatrixLayout::RowMajor);
  uint v_33 = 0u;
