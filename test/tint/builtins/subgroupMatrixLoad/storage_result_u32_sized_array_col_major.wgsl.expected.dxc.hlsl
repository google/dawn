...
void main() {
  ...
  Matrix_result_u32_8x8 m1 = Matrix_result_u32_8x8::Load(in1, 0u, 64u, MatrixLayout::ColMajor);
  uint v_5 = 0u;
  v.GetDimensions(v_5);
  ...
  Matrix_result_u32_8x8 m2 = Matrix_result_u32_8x8::Load(in2, 0u, 64u, MatrixLayout::ColMajor);
  uint v_9 = 0u;
  v.GetDimensions(v_9);
  ...
  Matrix_result_u32_8x8 m3 = Matrix_result_u32_8x8::Load(in3, 0u, 64u, MatrixLayout::ColMajor);
  uint v_13 = 0u;
  ...
  Matrix_result_u32_8x8 m6 = Matrix_result_u32_8x8::Load(in6, 0u, 64u, MatrixLayout::ColMajor);
  uint v_21 = 0u;
