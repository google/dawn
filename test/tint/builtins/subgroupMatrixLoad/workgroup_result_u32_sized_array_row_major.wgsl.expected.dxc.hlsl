...
hlsl.hlsl:75:30: error: no matching function for call to 'Load'
  Matrix_result_u32_8x8 m5 = Matrix_result_u32_8x8::Load(in5, ((0u / 2u) + ((asuint(int(0)) * 4u) / 2u)), ((16u * 4u) / 2u), MatrixLayout::RowMajor);
                             ^~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<built-in:hlsl>/dx/linalg.h:282:7: note: candidate template ignored: disabled by 'enable_if' [with T = uint16_t, Size = 2048]
      ...
      ^
hlsl.hlsl:82:30: error: no matching function for call to 'Load'
  Matrix_result_u32_8x8 m6 = Matrix_result_u32_8x8::Load(in6, ((0u / 2u) + ((asuint(int(0)) * 8u) / 2u)), ((16u * 8u) / 2u), MatrixLayout::RowMajor);
                             ^~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<built-in:hlsl>/dx/linalg.h:290:60: error: cannot initialize a parameter of type 'unsigned int const __attribute__((address_space(3))) (&)[1024]' with an lvalue of type 'vector<unsigned int, 2> __attribute__((address_space(3)))[1024]'
    __builtin_LinAlg_MatrixLoadFromMemory(Result.__handle, Arr, StartIdx,
                                                           ^~~
hlsl.hlsl:54:53: note: in instantiation of function template specialization 'dx::linalg::Matrix<dx::linalg::ComponentType::ComponentEnum::U32, 8, 8, dx::linalg::MatrixUse::MatrixUseEnum::Accumulator, dx::linalg::MatrixScope::MatrixScopeEnum::Wave>::Load<vector<unsigned int, 2>, 1024>' requested here
  Matrix_result_u32_8x8 m1 = Matrix_result_u32_8x8::Load(in1, asuint(int(0)), 16u, MatrixLayout::RowMajor);
                                                    ^
...
<built-in:hlsl>/dx/linalg.h:290:60: error: cannot initialize a parameter of type 'unsigned int const __attribute__((address_space(3))) (&)[1024]' with an lvalue of type 'vector<unsigned int, 4> __attribute__((address_space(3)))[1024]'
    __builtin_LinAlg_MatrixLoadFromMemory(Result.__handle, Arr, StartIdx,
                                                           ^~~
hlsl.hlsl:68:53: note: in instantiation of function template specialization 'dx::linalg::Matrix<dx::linalg::ComponentType::ComponentEnum::U32, 8, 8, dx::linalg::MatrixUse::MatrixUseEnum::Accumulator, dx::linalg::MatrixScope::MatrixScopeEnum::Wave>::Load<vector<unsigned int, 4>, 1024>' requested here
  Matrix_result_u32_8x8 m3 = Matrix_result_u32_8x8::Load(in3, asuint(int(0)), 16u, MatrixLayout::RowMajor);
                                                    ^
...
void main_inner(uint tint_local_index) {
  ...
  Matrix_result_u32_8x8 m0 = Matrix_result_u32_8x8::Load(in0, asuint(int(0)), 16u, MatrixLayout::RowMajor);
  uint v_8 = 0u;
  v.GetDimensions(v_8);
  ...
  Matrix_result_u32_8x8 m2 = Matrix_result_u32_8x8::Load(in2, ((0u / 4u) + ((asuint(int(0)) * 16u) / 4u)), ((16u * 16u) / 4u), MatrixLayout::RowMajor);
  uint v_16 = 0u;
