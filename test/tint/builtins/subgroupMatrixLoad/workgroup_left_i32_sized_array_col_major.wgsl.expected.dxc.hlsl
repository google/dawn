...
4 candidate functions:
 ...
 • 'hlsl.Load<SM  ✓ >(ptr<workgroup, array<S, AC>, AM>  ✗ , offset: u32  ✓ , stride: u32  ✓ , matrix_layout  ✓ ) -> SM' where:
    ...
    %74:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in1, 0u, 16u, 1u
                                          ^^^^^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %56:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in0, 0u, 16u, 1u
    ...
    %96:u32 = mul 16u, 16u
    %97:u32 = div %96, 4u
    %98:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in2, %95, %97, 1u
    ...
    %116:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in3, 0u, 16u, 1u
    ...
    %138:u32 = mul 16u, 4u
    %139:u32 = div %138, 2u
    %140:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in5, %137, %139, 1u
    ...
    %162:u32 = mul 16u, 8u
    %163:u32 = div %162, 2u
    %164:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in6, %161, %163, 1u
