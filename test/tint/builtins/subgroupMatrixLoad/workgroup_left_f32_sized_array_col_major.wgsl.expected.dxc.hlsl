...
=========================================================
:118:43 error: hlsl.Load: no matching call to 'hlsl.Load<subgroup_matrix_left<f32, 8, 8>>(ptr<workgroup, array<vec3<f32>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
4 candidate functions:
 ...
 • 'hlsl.Load<SM  ✓ >(ptr<workgroup, array<S, AC>, AM>  ✗ , offset: u32  ✓ , stride: u32  ✓ , matrix_layout  ✓ ) -> SM' where:
    ...
    %87:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in2, %86, 16u, 1u
                                          ^^^^^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %49:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in0, %48, 16u, 1u
    %m0:subgroup_matrix_left<f32, 8, 8> = let %49
    ...
    %68:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in1, %67, 16u, 1u
    %m1:subgroup_matrix_left<f32, 8, 8> = let %68
    ...
    %87:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in2, %86, 16u, 1u
    %m2:subgroup_matrix_left<f32, 8, 8> = let %87
    ...
    %106:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in3, %105, 16u, 1u
    %m3:subgroup_matrix_left<f32, 8, 8> = let %106
    ...
    %129:u32 = mul 16u, 4u
    %130:u32 = div %129, 2u
    %131:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in5, %128, %130, 1u
    %m5:subgroup_matrix_left<f32, 8, 8> = let %131
    ...
    %154:u32 = mul 16u, 8u
    %155:u32 = div %154, 2u
    %156:subgroup_matrix_left<f32, 8, 8> = hlsl.Load<subgroup_matrix_left<f32, 8, 8>> %in6, %153, %155, 1u
    %m6:subgroup_matrix_left<f32, 8, 8> = let %156
