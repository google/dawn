...
[numthreads(64, 1, 1)]
void main() {
  Matrix_right_f32_8x8 m0 = Matrix_right_f32_8x8::Load(in0, 0u, 64u, MatrixLayout::ColMajor);
  uint v_1 = 0u;
  v.GetDimensions(v_1);
  ...
  Matrix_right_f32_8x8 m1 = Matrix_right_f32_8x8::Load(in1, 0u, 128u, MatrixLayout::ColMajor);
  uint v_5 = 0u;
  v.GetDimensions(v_5);
  ...
  Matrix_right_f32_8x8 m2 = Matrix_right_f32_8x8::Load(in2, 0u, 256u, MatrixLayout::ColMajor);
  uint v_9 = 0u;
  v.GetDimensions(v_9);
  ...
  Matrix_right_f32_8x8 m3 = Matrix_right_f32_8x8::Load(in3, 0u, 256u, MatrixLayout::ColMajor);
  uint v_13 = 0u;
  ...
  Matrix_right_f32_8x8 m5 = Matrix_right_f32_8x8::Load(in5, 0u, 64u, MatrixLayout::ColMajor);
  uint v_17 = 0u;
  ...
  Matrix_right_f32_8x8 m6 = Matrix_right_f32_8x8::Load(in6, 0u, 128u, MatrixLayout::ColMajor);
  uint v_21 = 0u;
