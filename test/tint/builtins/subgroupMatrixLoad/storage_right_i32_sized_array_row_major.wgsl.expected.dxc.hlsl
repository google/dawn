...
void main() {
  ...
  Matrix_right_i32_8x8 m1 = Matrix_right_i32_8x8::Load(in1, 0u, 64u, MatrixLayout::RowMajor);
  uint v_5 = 0u;
  v.GetDimensions(v_5);
  ...
  Matrix_right_i32_8x8 m2 = Matrix_right_i32_8x8::Load(in2, 0u, 64u, MatrixLayout::RowMajor);
  uint v_9 = 0u;
  v.GetDimensions(v_9);
  ...
  Matrix_right_i32_8x8 m3 = Matrix_right_i32_8x8::Load(in3, 0u, 64u, MatrixLayout::RowMajor);
  uint v_13 = 0u;
  ...
  Matrix_right_i32_8x8 m6 = Matrix_right_i32_8x8::Load(in6, 0u, 64u, MatrixLayout::RowMajor);
  uint v_21 = 0u;
