...
=========================================================
:107:43 error: hlsl.Load: no matching call to 'hlsl.Load<subgroup_matrix_left<i32, 8, 8>>(ptr<workgroup, array<vec2<i32>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
4 candidate functions:
 ...
 • 'hlsl.Load<SM  ✓ >(ptr<workgroup, array<S, AC>, AM>  ✗ , offset: u32  ✓ , stride: u32  ✓ , matrix_layout  ✓ ) -> SM' where:
    ...
    %74:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in1, 0u, 16u, 0u
                                          ^^^^^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %56:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in0, 0u, 16u, 0u
    %m0:subgroup_matrix_left<i32, 8, 8> = let %56
    ...
    %74:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in1, 0u, 16u, 0u
    %m1:subgroup_matrix_left<i32, 8, 8> = let %74
    ...
    %96:u32 = mul 16u, 16u
    %97:u32 = div %96, 4u
    %98:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in2, %95, %97, 0u
    %m2:subgroup_matrix_left<i32, 8, 8> = let %98
    ...
    %116:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in3, 0u, 16u, 0u
    %m3:subgroup_matrix_left<i32, 8, 8> = let %116
    ...
    %138:u32 = mul 16u, 4u
    %139:u32 = div %138, 2u
    %140:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in5, %137, %139, 0u
    %m5:subgroup_matrix_left<i32, 8, 8> = let %140
    ...
    %162:u32 = mul 16u, 8u
    %163:u32 = div %162, 2u
    %164:subgroup_matrix_left<i32, 8, 8> = hlsl.Load<subgroup_matrix_left<i32, 8, 8>> %in6, %161, %163, 0u
    %m6:subgroup_matrix_left<i32, 8, 8> = let %164
