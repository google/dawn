...
hlsl.hlsl:75:28: error: no matching function for call to 'Load'
  Matrix_left_u32_8x8 m5 = Matrix_left_u32_8x8::Load(in5, ((0u / 2u) + ((asuint(int(0)) * 4u) / 2u)), ((16u * 4u) / 2u), MatrixLayout::ColMajor);
                           ^~~~~~~~~~~~~~~~~~~~~~~~~
...
hlsl.hlsl:82:28: error: no matching function for call to 'Load'
  Matrix_left_u32_8x8 m6 = Matrix_left_u32_8x8::Load(in6, ((0u / 2u) + ((asuint(int(0)) * 8u) / 2u)), ((16u * 8u) / 2u), MatrixLayout::ColMajor);
                           ^~~~~~~~~~~~~~~~~~~~~~~~~
...
hlsl.hlsl:54:49: note: in instantiation of function template specialization 'dx::linalg::Matrix<dx::linalg::ComponentType::ComponentEnum::U32, 8, 8, dx::linalg::MatrixUse::MatrixUseEnum::A, dx::linalg::MatrixScope::MatrixScopeEnum::Wave>::Load<vector<unsigned int, 2>, 1024>' requested here
  Matrix_left_u32_8x8 m1 = Matrix_left_u32_8x8::Load(in1, asuint(int(0)), 16u, MatrixLayout::ColMajor);
                                                ^
...
hlsl.hlsl:68:49: note: in instantiation of function template specialization 'dx::linalg::Matrix<dx::linalg::ComponentType::ComponentEnum::U32, 8, 8, dx::linalg::MatrixUse::MatrixUseEnum::A, dx::linalg::MatrixScope::MatrixScopeEnum::Wave>::Load<vector<unsigned int, 4>, 1024>' requested here
  Matrix_left_u32_8x8 m3 = Matrix_left_u32_8x8::Load(in3, asuint(int(0)), 16u, MatrixLayout::ColMajor);
                                                ^
...
void main_inner(uint tint_local_index) {
  ...
  Matrix_left_u32_8x8 m0 = Matrix_left_u32_8x8::Load(in0, asuint(int(0)), 16u, MatrixLayout::ColMajor);
  uint v_8 = 0u;
  v.GetDimensions(v_8);
  ...
  Matrix_left_u32_8x8 m2 = Matrix_left_u32_8x8::Load(in2, ((0u / 4u) + ((asuint(int(0)) * 16u) / 4u)), ((16u * 16u) / 4u), MatrixLayout::ColMajor);
  uint v_16 = 0u;
