...
fn main() {
  let m0 = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, col_major>(&(in0), 0u, 16u);
  subgroupMatrixStore<col_major>(&(out), 0, m0, 16);
  let m1 = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, col_major>(&(in1), 0u, 16u);
  subgroupMatrixStore<col_major>(&(out), 0, m1, 16);
  let m2 = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, col_major>(&(in2), 0u, 16u);
  subgroupMatrixStore<col_major>(&(out), 0, m2, 16);
  let m3 = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, col_major>(&(in3), 0u, 16u);
  subgroupMatrixStore<col_major>(&(out), 0, m3, 16);
  let m5 = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, col_major>(&(in5), 0u, 16u);
  subgroupMatrixStore<col_major>(&(out), 0, m5, 16);
  let m6 = subgroupMatrixLoad<subgroup_matrix_result<u32, 8, 8>, col_major>(&(in6), 0u, 16u);
