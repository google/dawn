...
void main() {
  ...
  Matrix_result_u32_8x8 m0 = Matrix_result_u32_8x8::Load(in0, (0u + (select(v_6, v_2, 0u) * 4u)), (select(v_6, 16u, 8u) * 4u), MatrixLayout::RowMajor);
  uint v_7 = 0u;
  v.GetDimensions(v_7);
  ...
  Matrix_result_u32_8x8 m1 = Matrix_result_u32_8x8::Load(in1, (0u + (select(v_19, v_15, 0u) * 8u)), (select(v_19, 16u, 4u) * 8u), MatrixLayout::RowMajor);
  uint v_20 = 0u;
  ...
  Matrix_result_u32_8x8 m2 = Matrix_result_u32_8x8::Load(in2, (0u + (select(v_32, v_28, 0u) * 16u)), (select(v_32, 16u, 2u) * 16u), MatrixLayout::RowMajor);
  uint v_33 = 0u;
  ...
  Matrix_result_u32_8x8 m3 = Matrix_result_u32_8x8::Load(in3, (0u + (select(v_45, v_41, 0u) * 16u)), (select(v_45, 16u, 2u) * 16u), MatrixLayout::RowMajor);
  uint v_46 = 0u;
  ...
  Matrix_result_u32_8x8 m5 = Matrix_result_u32_8x8::Load(in5, (0u + (select(v_58, v_54, 0u) * 4u)), (select(v_58, 16u, 8u) * 4u), MatrixLayout::RowMajor);
  uint v_59 = 0u;
  ...
  Matrix_result_u32_8x8 m6 = Matrix_result_u32_8x8::Load(in6, (0u + (select(v_71, v_67, 0u) * 8u)), (select(v_71, 16u, 4u) * 8u), MatrixLayout::RowMajor);
  uint v_72 = 0u;
