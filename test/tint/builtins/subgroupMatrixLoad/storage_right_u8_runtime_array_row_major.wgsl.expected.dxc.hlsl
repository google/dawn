...
void main() {
  ...
  Matrix_right_u8_8x8 m1 = Matrix_right_u8_8x8::Load(in1, (0u + (select(v_8, 0u, 0u) * 8u)), (select(v_8, 16u, 1u) * 8u), MatrixLayout::RowMajor);
  uint v_9 = 0u;
  v.GetDimensions(v_9);
  ...
  Matrix_right_u8_8x8 m2 = Matrix_right_u8_8x8::Load(in2, (0u + (select(v_14, 0u, 0u) * 16u)), (select(v_14, 16u, 1u) * 16u), MatrixLayout::RowMajor);
  uint v_15 = 0u;
  ...
  Matrix_right_u8_8x8 m3 = Matrix_right_u8_8x8::Load(in3, (0u + (select(v_20, 0u, 0u) * 16u)), (select(v_20, 16u, 1u) * 16u), MatrixLayout::RowMajor);
  uint v_21 = 0u;
  ...
  Matrix_right_u8_8x8 m4 = Matrix_right_u8_8x8::Load(in4, (0u + (select(v_26, 0u, 0u) * 2u)), (select(v_26, 16u, 4u) * 2u), MatrixLayout::RowMajor);
  uint v_27 = 0u;
  ...
  Matrix_right_u8_8x8 m6 = Matrix_right_u8_8x8::Load(in6, (0u + (select(v_38, 0u, 0u) * 8u)), (select(v_38, 16u, 1u) * 8u), MatrixLayout::RowMajor);
  uint v_39 = 0u;
