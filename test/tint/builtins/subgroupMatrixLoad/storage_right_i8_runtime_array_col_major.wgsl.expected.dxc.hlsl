...
void main() {
  ...
  Matrix_right_i8_8x8 m1 = Matrix_right_i8_8x8::Load(in1, (0u + (select(v_10, v_9, 0u) * 8u)), (select(v_10, 16u, 1u) * 8u), MatrixLayout::ColMajor);
  uint v_11 = 0u;
  ...
  Matrix_right_i8_8x8 m2 = Matrix_right_i8_8x8::Load(in2, (0u + (select(v_17, v_16, 0u) * 16u)), (select(v_17, 16u, 1u) * 16u), MatrixLayout::ColMajor);
  uint v_18 = 0u;
  ...
  Matrix_right_i8_8x8 m3 = Matrix_right_i8_8x8::Load(in3, (0u + (select(v_24, v_23, 0u) * 16u)), (select(v_24, 16u, 1u) * 16u), MatrixLayout::ColMajor);
  uint v_25 = 0u;
  ...
  Matrix_right_i8_8x8 m4 = Matrix_right_i8_8x8::Load(in4, (0u + (select(v_31, v_30, 0u) * 2u)), (select(v_31, 16u, 4u) * 2u), MatrixLayout::ColMajor);
  uint v_32 = 0u;
  ...
  Matrix_right_i8_8x8 m6 = Matrix_right_i8_8x8::Load(in6, (0u + (select(v_45, v_44, 0u) * 8u)), (select(v_45, 16u, 1u) * 8u), MatrixLayout::ColMajor);
  uint v_46 = 0u;
