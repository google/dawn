...
void main() {
  ...
  Matrix_right_i8_8x8 m0 = Matrix_right_i8_8x8::Load(in0, (0u + (select(v_6, v_2, 0u) * 4u)), (select(v_6, 16u, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_7 = 0u;
  v.GetDimensions(v_7);
  ...
  m0.Store(v, (0u + (select(v_13, v_8, 0u) * 4u)), (select(v_13, v_9, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_14 = 0u;
  ...
  Matrix_right_i8_8x8 m1 = Matrix_right_i8_8x8::Load(in1, (0u + (select(v_19, v_15, 0u) * 8u)), (select(v_19, 16u, 1u) * 8u), MatrixLayout::ColMajor);
  uint v_20 = 0u;
  ...
  m1.Store(v, (0u + (select(v_26, v_21, 0u) * 4u)), (select(v_26, v_22, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_27 = 0u;
  ...
  Matrix_right_i8_8x8 m2 = Matrix_right_i8_8x8::Load(in2, (0u + (select(v_32, v_28, 0u) * 16u)), (select(v_32, 16u, 1u) * 16u), MatrixLayout::ColMajor);
  uint v_33 = 0u;
  ...
  m2.Store(v, (0u + (select(v_39, v_34, 0u) * 4u)), (select(v_39, v_35, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_40 = 0u;
  ...
  Matrix_right_i8_8x8 m3 = Matrix_right_i8_8x8::Load(in3, (0u + (select(v_45, v_41, 0u) * 16u)), (select(v_45, 16u, 1u) * 16u), MatrixLayout::ColMajor);
  uint v_46 = 0u;
  ...
  m3.Store(v, (0u + (select(v_52, v_47, 0u) * 4u)), (select(v_52, v_48, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_53 = 0u;
  in4.GetDimensions(v_53);
  ...
  uint v_57 = (v_56 + 4u);
  bool v_58 = (select((v_57 < v_56), 4294967295u, v_57) <= (v_53 / 2u));
  Matrix_right_i8_8x8 m4 = Matrix_right_i8_8x8::Load(in4, (0u + (select(v_58, v_54, 0u) * 2u)), (select(v_58, 16u, 4u) * 2u), MatrixLayout::ColMajor);
  uint v_59 = 0u;
  ...
  m4.Store(v, (0u + (select(v_65, v_60, 0u) * 4u)), (select(v_65, v_61, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_66 = 0u;
  in5.GetDimensions(v_66);
  ...
  uint v_70 = (v_69 + 2u);
  bool v_71 = (select((v_70 < v_69), 4294967295u, v_70) <= (v_66 / 4u));
  Matrix_right_i8_8x8 m5 = Matrix_right_i8_8x8::Load(in5, (0u + (select(v_71, v_67, 0u) * 4u)), (select(v_71, 16u, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_72 = 0u;
  ...
  m5.Store(v, (0u + (select(v_78, v_73, 0u) * 4u)), (select(v_78, v_74, 2u) * 4u), MatrixLayout::ColMajor);
  uint v_79 = 0u;
  in6.GetDimensions(v_79);
  uint v_80 = asuint(int(0));
  uint v_81 = (v_80 + select((((16u != 0u) & (7u != 0u)) & (7u > (4294967295u / 16u))), 4294967295u, (16u * 7u)));
  uint v_82 = select((v_81 < v_80), 4294967295u, v_81);
  uint v_83 = (v_82 + 1u);
  bool v_84 = (select((v_83 < v_82), 4294967295u, v_83) <= (v_79 / 8u));
  Matrix_right_i8_8x8 m6 = Matrix_right_i8_8x8::Load(in6, (0u + (select(v_84, v_80, 0u) * 8u)), (select(v_84, 16u, 1u) * 8u), MatrixLayout::ColMajor);
  uint v_85 = 0u;
  v.GetDimensions(v_85);
  uint v_86 = asuint(int(0));
  uint v_87 = asuint(int(16));
  uint v_88 = (v_86 + select((((v_87 != 0u) & (7u != 0u)) & (7u > (4294967295u / v_87))), 4294967295u, (v_87 * 7u)));
  uint v_89 = select((v_88 < v_86), 4294967295u, v_88);
  uint v_90 = (v_89 + 2u);
  bool v_91 = (select((v_90 < v_89), 4294967295u, v_90) <= (v_85 / 4u));
  m6.Store(v, (0u + (select(v_91, v_86, 0u) * 4u)), (select(v_91, v_87, 2u) * 4u), MatrixLayout::ColMajor);
}
