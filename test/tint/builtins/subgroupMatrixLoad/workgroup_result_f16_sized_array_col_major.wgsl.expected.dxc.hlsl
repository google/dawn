...
4 candidate functions:
 ...
 • 'hlsl.Load<SM  ✓ >(ptr<workgroup, array<S, AC>, AM>  ✗ , offset: u32  ✓ , stride: u32  ✓ , matrix_layout  ✓ ) -> SM' where:
    ...
    %159:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in5, 0u, 16u, 1u
                                             ^^^^^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %42:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in0, 0u, 16u, 1u
    ...
    %65:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in1, 0u, 16u, 1u
    ...
    %91:u32 = mul 16u, 16u
    %92:u32 = div %91, 4u
    %93:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in2, %90, %92, 1u
    ...
    %115:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in3, 0u, 16u, 1u
    ...
    %137:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in4, 0u, 16u, 1u
    ...
    %181:subgroup_matrix_result<f16, 8, 8> = hlsl.Load<subgroup_matrix_result<f16, 8, 8>> %in6, 0u, 16u, 1u
