...
=========================================================
:189:45 error: hlsl.Load: no matching call to 'hlsl.Load<subgroup_matrix_right<f16, 8, 8>>(ptr<workgroup, array<vec2<f16>, 1024>, read_write>, u32, u32, hlsl.matrix_layout)'
...
4 candidate functions:
 ...
 • 'hlsl.Load<SM  ✓ >(ptr<workgroup, array<S, AC>, AM>  ✗ , offset: u32  ✓ , stride: u32  ✓ , matrix_layout  ✓ ) -> SM' where:
    ...
    %159:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in5, 0u, 16u, 0u
                                            ^^^^^^^^^
...
%main_inner = func(%tint_local_index:u32):void {
  $B2: {
    ...
    %42:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in0, 0u, 16u, 0u
    %m0:subgroup_matrix_right<f16, 8, 8> = let %42
    ...
    %65:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in1, 0u, 16u, 0u
    %m1:subgroup_matrix_right<f16, 8, 8> = let %65
    ...
    %91:u32 = mul 16u, 16u
    %92:u32 = div %91, 4u
    %93:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in2, %90, %92, 0u
    %m2:subgroup_matrix_right<f16, 8, 8> = let %93
    ...
    %115:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in3, 0u, 16u, 0u
    %m3:subgroup_matrix_right<f16, 8, 8> = let %115
    ...
    %137:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in4, 0u, 16u, 0u
    %m4:subgroup_matrix_right<f16, 8, 8> = let %137
    ...
    %159:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in5, 0u, 16u, 0u
    %m5:subgroup_matrix_right<f16, 8, 8> = let %159
    ...
    %181:subgroup_matrix_right<f16, 8, 8> = hlsl.Load<subgroup_matrix_right<f16, 8, 8>> %in6, 0u, 16u, 0u
    %m6:subgroup_matrix_right<f16, 8, 8> = let %181
