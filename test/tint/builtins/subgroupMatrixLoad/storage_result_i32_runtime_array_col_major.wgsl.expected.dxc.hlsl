...
void main() {
  ...
  Matrix_result_i32_8x8 m0 = Matrix_result_i32_8x8::Load(in0, (0u + (select(v_2, 0u, 0u) * 4u)), (select(v_2, 16u, 8u) * 4u), MatrixLayout::ColMajor);
  uint v_3 = 0u;
  v.GetDimensions(v_3);
  ...
  Matrix_result_i32_8x8 m1 = Matrix_result_i32_8x8::Load(in1, (0u + (select(v_6, 0u, 0u) * 8u)), (select(v_6, 16u, 4u) * 8u), MatrixLayout::ColMajor);
  uint v_7 = 0u;
  v.GetDimensions(v_7);
  ...
  Matrix_result_i32_8x8 m2 = Matrix_result_i32_8x8::Load(in2, (0u + (select(v_10, 0u, 0u) * 16u)), (select(v_10, 16u, 2u) * 16u), MatrixLayout::ColMajor);
  uint v_11 = 0u;
  ...
  Matrix_result_i32_8x8 m3 = Matrix_result_i32_8x8::Load(in3, (0u + (select(v_14, 0u, 0u) * 16u)), (select(v_14, 16u, 2u) * 16u), MatrixLayout::ColMajor);
  uint v_15 = 0u;
  ...
  Matrix_result_i32_8x8 m5 = Matrix_result_i32_8x8::Load(in5, (0u + (select(v_18, 0u, 0u) * 4u)), (select(v_18, 16u, 8u) * 4u), MatrixLayout::ColMajor);
  uint v_19 = 0u;
  ...
  Matrix_result_i32_8x8 m6 = Matrix_result_i32_8x8::Load(in6, (0u + (select(v_22, 0u, 0u) * 8u)), (select(v_22, 16u, 4u) * 8u), MatrixLayout::ColMajor);
  uint v_23 = 0u;
