...
void main_inner(uint idx) {
  ...
  Matrix_left_f32_8x8 v_32[2] = make_array();
  Matrix_left_f32_8x8 v_33 = v_32[0u];
  uint v_34 = 0u;
  buffer.GetDimensions(v_34);
  uint v_35 = asuint(int(0));
  uint v_36 = asuint(int(64));
  bool v_37 = (((v_35 + (v_36 * 7u)) + 8u) <= (v_34 / 4u));
  v_33.Store(buffer, (0u + (select(v_37, v_35, 0u) * 4u)), (select(v_37, v_36, 8u) * 4u), MatrixLayout::RowMajor);
  Matrix_left_f32_8x8 v_38[2][2] = make_nested_array();
  Matrix_left_f32_8x8 v_39 = v_38[1u][0u];
  uint v_40 = 0u;
  buffer.GetDimensions(v_40);
  uint v_41 = asuint(int(0));
  uint v_42 = asuint(int(64));
  bool v_43 = (((v_41 + (v_42 * 7u)) + 8u) <= (v_40 / 4u));
  v_39.Store(buffer, (0u + (select(v_43, v_41, 0u) * 4u)), (select(v_43, v_42, 8u) * 4u), MatrixLayout::RowMajor);
  S v_44 = make_struct();
  Matrix_left_f32_8x8 v_45 = v_44.l;
  uint v_46 = 0u;
  ...
  S_Nested v_50 = make_nested_struct();
  Matrix_right_f32_8x8 v_51 = v_50.s.r;
  uint v_52 = 0u;
