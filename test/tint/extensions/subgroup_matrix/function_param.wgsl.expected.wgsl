...
fn foo(m : subgroup_matrix_left<f32, 8, 8>, m_array : array<subgroup_matrix_left<f32, 8, 8>, 4>, m_nested_array : array<array<subgroup_matrix_left<f32, 8, 8>, 4>, 4>, m_struct : S, m_nested_struct : S_Nested) {
