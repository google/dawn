...
void main() {
  ...
  if ((((asuint(int(0)) + (asuint(int(64)) * 7u)) + 8u) <= (v_16 / 4u))) {
    v_15.Store(buffer, 0u, 256u, MatrixLayout::RowMajor);
  }
  uint v_17 = 0u;
  buffer.GetDimensions(v_17);
  if ((((asuint(int(0)) + (asuint(int(64)) * 7u)) + 8u) <= (v_17 / 4u))) {
  ...
  if ((((asuint(int(0)) + (asuint(int(64)) * 7u)) + 8u) <= (v_20 / 4u))) {
  ...
  if ((((asuint(int(0)) + (asuint(int(64)) * 7u)) + 8u) <= (v_25 / 4u))) {
  ...
  if ((((asuint(int(0)) + (asuint(int(64)) * 7u)) + 8u) <= (v_32 / 4u))) {
