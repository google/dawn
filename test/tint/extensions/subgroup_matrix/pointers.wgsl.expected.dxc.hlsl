...
void foo(inout Matrix_left_f32_8x8 m, inout Matrix_left_f32_8x8 m_array[4], inout Matrix_left_f32_8x8 m_nested_array[4][4], inout S m_struct, inout S_Nested m_nested_struct) {
  ...
  uint v_3 = (v_1 + select((((v_2 != 0u) & true) & (7u > (4294967295u / v_2))), 4294967295u, (v_2 * 7u)));
  ...
  uint v_17 = (v_15 + select((((v_16 != 0u) & true) & (7u > (4294967295u / v_16))), 4294967295u, (v_16 * 7u)));
  ...
  uint v_24 = (v_22 + select((((v_23 != 0u) & true) & (7u > (4294967295u / v_23))), 4294967295u, (v_23 * 7u)));
