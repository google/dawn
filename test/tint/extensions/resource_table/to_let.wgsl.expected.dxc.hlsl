...
float4 fs_inner() {
  ...
  if ((2u < tint_resource_table_metadata.Load(0u))) {
    v = any((uint3((tint_resource_table_metadata.Load(12u)).xxx) == uint3(6u, 7u, 34u)));
  } else {
    v = false;
  }
  bool has_resource = v;
  uint v_1 = 0u;
  if (has_resource) {
    v_1 = tint_resource_table_metadata.Load(12u);
  } else {
    v_1 = 6u;
  }
  ...
  if ((3u < tint_resource_table_metadata.Load(0u))) {
    v_3 = any((uint2((tint_resource_table_metadata.Load(16u)).xx) == uint2(40u, 41u)));
  } else {
    v_3 = false;
  }
  ...
  uint v_4 = 0u;
  if (has_resource_1) {
    v_4 = tint_resource_table_metadata.Load(16u);
  } else {
    v_4 = 41u;
  }
