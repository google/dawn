...
tint_ExternalTextureParams v_44(uint start_byte_offset) {
  ...
  tint_ExternalTextureParams v_72 = {v_45, v_47, v_48, v_49, v_50, v_51, v_52, v_53, v_56, v_59, v_62, v_65, v_68, v_71, asfloat(t_params[((272u + start_byte_offset) / 16u)])};
  return v_72;
}
...
void i() {
  ...
  float4 r = tint_TextureLoadMultiplanarExternal(t_plane0, t_plane1, v_73, (0u).xx);
}
