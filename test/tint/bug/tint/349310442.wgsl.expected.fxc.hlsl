...
tint_TransferFunctionParams v_37(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_45 = {t_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)], asfloat(t_params[(v_38 / 16u)][((v_38 & 15u) >> 2u)]), asfloat(t_params[(v_39 / 16u)][((v_39 & 15u) >> 2u)]), asfloat(t_params[(v_40 / 16u)][((v_40 & 15u) >> 2u)]), asfloat(t_params[(v_41 / 16u)][((v_41 & 15u) >> 2u)]), asfloat(t_params[(v_42 / 16u)][((v_42 & 15u) >> 2u)]), asfloat(t_params[(v_43 / 16u)][((v_43 & 15u) >> 2u)]), asfloat(t_params[(v_44 / 16u)][((v_44 & 15u) >> 2u)])};
  return v_45;
}
...
tint_ExternalTextureParams v_47(uint start_byte_offset) {
  uint v_48 = t_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)];
  uint v_49 = (4u + start_byte_offset);
  uint v_50 = t_params[(v_49 / 16u)][((v_49 & 15u) >> 2u)];
  ...
  uint4 v_73 = t_params[(v_72 / 16u)];
  float2 v_74 = asfloat((((((v_72 & 15u) >> 2u) == 2u)) ? (v_73.zw) : (v_73.xy)));
  tint_ExternalTextureParams v_75 = {v_48, v_50, v_51, v_52, v_53, v_54, v_55, v_56, v_59, v_62, v_65, v_68, v_71, v_74, asfloat(t_params[((272u + start_byte_offset) / 16u)])};
  return v_75;
}
...
void i() {
  ...
  float4 r = tint_TextureLoadMultiplanarExternal(t_plane0, t_plane1, v_76, uint2((int(0)).xx));
}
