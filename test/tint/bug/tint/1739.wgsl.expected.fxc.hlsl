...
void main() {
  ...
  float4 red = tint_TextureLoadMultiplanarExternal(t_plane0, t_plane1, v_72, uint2((int(10)).xx));
  outImage[(int(0)).xx] = red;
  tint_ExternalTextureParams v_73 = v_44(0u);
  float4 green = tint_TextureLoadMultiplanarExternal(t_plane0, t_plane1, v_73, uint2(int2(int(70), int(118))));
