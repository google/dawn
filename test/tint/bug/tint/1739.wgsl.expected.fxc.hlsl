...
void main() {
  ...
  float4 red = tint_TextureLoadMultiplanarExternal(t_plane0, t_plane1, v_73, (10u).xx);
  outImage[(int(0)).xx] = red;
  tint_ExternalTextureParams v_74 = v_44(0u);
  float4 green = tint_TextureLoadMultiplanarExternal(t_plane0, t_plane1, v_74, uint2(70u, 118u));
