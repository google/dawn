...
float2x2 v_4(uint start_byte_offset) {
  ...
  uint4 v_7 = x_20[(v_6 / 16u)];
  return float2x2(asfloat(select((((start_byte_offset & 15u) >> 2u) == 2u), v_5.zw, v_5.xy)), asfloat(select((((v_6 & 15u) >> 2u) == 2u), v_7.zw, v_7.xy)));
}
