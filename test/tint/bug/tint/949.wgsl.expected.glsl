...
void main_1() {
  ...
  uvec4 v_10 = v.inner[8u];
  float x_454 = uintBitsToFloat(v_10.x);
  mat3 x_457 = TBN;
  param_8 = x_457;
...
main_out main_inner(vec2 vMainuv_param, vec4 v_output1_param, bool v_11, vec2 v_uv_param, vec4 v_output2_param) {
