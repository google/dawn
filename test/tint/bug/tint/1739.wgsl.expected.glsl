...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    vec4 v_16 = texelFetch(t_plane0, ivec2(v_13), 0);
    v_14 = v_16.xyz;
    v_15 = v_16.w;
  } else {
    float v_17 = texelFetch(t_plane0, ivec2(v_13), 0).x;
    v_14 = (vec4(v_17, texelFetch(t_plane1, ivec2(uvec2((v_12 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_15 = 1.0f;
  }
  vec3 v_18 = v_14;
  vec3 v_19 = vec3(0.0f);
...
tint_ExternalTextureParams v_49(uint start_byte_offset) {
  ...
  return tint_ExternalTextureParams(v_50[((start_byte_offset & 15u) >> 2u)], v_52[((v_51 & 15u) >> 2u)], v_53, v_54, v_55, v_56, v_57, v_58, v_61, v_64, v_67, v_70, v_73, v_76, uintBitsToFloat(v_1.inner[((272u + start_byte_offset) / 16u)]));
}
layout(local_size_x = 1, local_size_y = 1, local_size_z = 1) in;
void main() {
  tint_ExternalTextureParams v_77 = v_49(0u);
  vec4 red = tint_TextureLoadMultiplanarExternal(v_77, min(uvec2(10u), ((v_77.apparentSize + uvec2(1u)) - uvec2(1u))));
  imageStore(outImage, ivec2(0), red);
  tint_ExternalTextureParams v_78 = v_49(0u);
  vec4 green = tint_TextureLoadMultiplanarExternal(v_78, min(uvec2(70u, 118u), ((v_78.apparentSize + uvec2(1u)) - uvec2(1u))));
