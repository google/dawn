...
void main() {
  ...
  bool4 v4b = (false).xxxx;
  {
    ...
    while((i < int(2))) {
      ...
      v3f = (((v_7 == uint3(0u, 1u, 2u))) ? (v_6) : (v_5));
      int v_8 = i;
      float4 v_9 = v4f;
      float4 v_10 = float4((1.0f).xxxx);
      uint4 v_11 = uint4((uint(v_8)).xxxx);
      v4f = (((v_11 == uint4(0u, 1u, 2u, 3u))) ? (v_10) : (v_9));
      int v_12 = i;
      int2 v_13 = v2i;
      int2 v_14 = int2((int(1)).xx);
      uint2 v_15 = uint2((uint(v_12)).xx);
      v2i = (((v_15 == uint2(0u, 1u))) ? (v_14) : (v_13));
      int v_16 = i;
      int3 v_17 = v3i;
      int3 v_18 = int3((int(1)).xxx);
      uint3 v_19 = uint3((uint(v_16)).xxx);
      v3i = (((v_19 == uint3(0u, 1u, 2u))) ? (v_18) : (v_17));
      int v_20 = i;
      int4 v_21 = v4i;
      int4 v_22 = int4((int(1)).xxxx);
      uint4 v_23 = uint4((uint(v_20)).xxxx);
      v4i = (((v_23 == uint4(0u, 1u, 2u, 3u))) ? (v_22) : (v_21));
      int v_24 = i;
      uint2 v_25 = v2u;
      uint2 v_26 = uint2((1u).xx);
      uint2 v_27 = uint2((uint(v_24)).xx);
      v2u = (((v_27 == uint2(0u, 1u))) ? (v_26) : (v_25));
      int v_28 = i;
      uint3 v_29 = v3u;
      uint3 v_30 = uint3((1u).xxx);
      uint3 v_31 = uint3((uint(v_28)).xxx);
      v3u = (((v_31 == uint3(0u, 1u, 2u))) ? (v_30) : (v_29));
      int v_32 = i;
      uint4 v_33 = v4u;
      uint4 v_34 = uint4((1u).xxxx);
      uint4 v_35 = uint4((uint(v_32)).xxxx);
      v4u = (((v_35 == uint4(0u, 1u, 2u, 3u))) ? (v_34) : (v_33));
      int v_36 = i;
      bool2 v_37 = v2b;
      bool2 v_38 = bool2((true).xx);
      uint2 v_39 = uint2((uint(v_36)).xx);
      v2b = (((v_39 == uint2(0u, 1u))) ? (v_38) : (v_37));
      int v_40 = i;
      bool3 v_41 = v3b;
