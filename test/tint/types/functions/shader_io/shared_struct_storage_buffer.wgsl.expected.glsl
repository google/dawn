...
void main() {
  frag_main_inner(S(tint_interstage_location0, tint_interstage_location1, 0u, 0u, tint_pad16_init, tint_pad16_init, tint_pad16_init, tint_pad64_init, gl_FragCoord, tint_pad16_init, tint_pad16_init, tint_pad16_init, tint_pad64_init));
}
