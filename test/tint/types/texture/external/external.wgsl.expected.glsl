...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    vec4 v_17 = texelFetch(t_f_plane0, ivec2(v_14), 0);
    v_15 = v_17.xyz;
    v_16 = v_17.w;
  } else {
    float v_18 = texelFetch(t_f_plane0, ivec2(v_14), 0).x;
    v_15 = (vec4(v_18, texelFetch(t_f_plane1, ivec2(uvec2((v_13 * params.plane1CoordFactor))), 0).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_16 = 1.0f;
  }
  vec3 v_19 = v_15;
  vec3 v_20 = vec3(0.0f);
...
tint_ExternalTextureParams v_50(uint start_byte_offset) {
  ...
  return tint_ExternalTextureParams(v_51[((start_byte_offset & 15u) >> 2u)], v_53[((v_52 & 15u) >> 2u)], v_54, v_55, v_56, v_57, v_58, v_59, v_62, v_65, v_68, v_71, v_74, v_77, uintBitsToFloat(v_1.inner[((272u + start_byte_offset) / 16u)]));
}
layout(local_size_x = 1, local_size_y = 1, local_size_z = 1) in;
void main() {
  tint_ExternalTextureParams v_78 = v_50(0u);
  v_2.inner = tint_TextureLoadMultiplanarExternal(v_78, min(uvec2(0u), ((v_78.apparentSize + uvec2(1u)) - uvec2(1u))));
}
