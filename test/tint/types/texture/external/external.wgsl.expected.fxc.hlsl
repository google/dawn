...
float4 tint_TextureLoadMultiplanarExternal(Texture2D<float4> plane_0, Texture2D<float4> plane_1, tint_ExternalTextureParams params, uint2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    float4 v_17 = plane_0.Load(int3(int2(v_14), int(0)));
    v_15 = v_17.xyz;
    v_16 = v_17.w;
  } else {
    float v_18 = plane_0.Load(int3(int2(v_14), int(0))).x;
    v_15 = mul(params.yuvToRgbConversionMatrix, float4(v_18, plane_1.Load(int3(int2(tint_v2f32_to_v2u32((v_13 * params.plane1CoordFactor))), int(0))).xy, 1.0f));
    v_16 = 1.0f;
  }
  float3 v_19 = v_15;
  float3 v_20 = (0.0f).xxx;
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    tint_TransferFunctionParams v_21 = params.srcTransferFunction;
    float3 v_22 = tint_ApplySrcTransferFunction(v_19, v_21);
    float3 v_23 = (0.0f).xxx;
    if ((params.ootfParam.w != 0.0f)) {
      float v_24 = dot(params.ootfParam.xyz, v_22);
      v_23 = (v_22 * (float(sign(v_24)) * pow(abs(v_24), params.ootfParam.w)));
    } else {
      v_23 = v_22;
    }
    tint_TransferFunctionParams v_25 = params.dstTransferFunction;
    v_20 = tint_ApplyGammaTransferFunction(mul(v_23, params.gamutConversionMatrix), v_25);
  } else {
    v_20 = v_19;
  }
  return float4(v_20, v_16);
}
...
tint_ExternalTextureParams v_45(uint start_byte_offset) {
  ...
  float2 v_72 = asfloat((((((v_70 & 15u) >> 2u) == 2u)) ? (v_71.zw) : (v_71.xy)));
  tint_ExternalTextureParams v_73 = {v_46, v_48, v_49, v_50, v_51, v_52, v_53, v_54, v_57, v_60, v_63, v_66, v_69, v_72, asfloat(t_f_params[((272u + start_byte_offset) / 16u)])};
  return v_73;
}

[numthreads(1, 1, 1)]
void main() {
  tint_ExternalTextureParams v_74 = v_45(0u);
  v_1.Store4(0u, asuint(tint_TextureLoadMultiplanarExternal(t_f_plane0, t_f_plane1, v_74, (0u).xx)));
}
