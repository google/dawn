...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    ...
    vec4 v_17 = texelFetch(t_f_plane0, v_16, int(0u));
    v_14 = v_17.xyz;
    v_15 = v_17.w;
  } else {
    ivec2 v_18 = ivec2(v_13);
    float v_19 = texelFetch(t_f_plane0, v_18, int(0u)).x;
    ivec2 v_20 = ivec2(uvec2((v_12 * params.plane1CoordFactor)));
    v_14 = (vec4(v_19, texelFetch(t_f_plane1, v_20, int(0u)).xy, 1.0f) * params.yuvToRgbConversionMatrix);
    v_15 = 1.0f;
  }
  vec3 v_21 = v_14;
  vec3 v_22 = vec3(0.0f);
...
void main() {
  ...
  vec4 vals = tint_TextureLoadMultiplanarExternal(v_80, min(uvec2(ivec2(0)), ((v_80.apparentSize + uvec2(1u)) - uvec2(1u))));
}
