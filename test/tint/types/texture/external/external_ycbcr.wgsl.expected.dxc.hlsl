...
float3x2 v_25(uint start_byte_offset) {
  ...
  uint4 v_28 = t_f_params[(v_27 / 16u)];
...
tint_TransferFunctionParams v_32(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_40 = {t_f_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)], asfloat(t_f_params[(v_33 / 16u)][((v_33 & 15u) >> 2u)]), asfloat(t_f_params[(v_34 / 16u)][((v_34 & 15u) >> 2u)]), asfloat(t_f_params[(v_35 / 16u)][((v_35 & 15u) >> 2u)]), asfloat(t_f_params[(v_36 / 16u)][((v_36 & 15u) >> 2u)]), asfloat(t_f_params[(v_37 / 16u)][((v_37 & 15u) >> 2u)]), asfloat(t_f_params[(v_38 / 16u)][((v_38 & 15u) >> 2u)]), asfloat(t_f_params[(v_39 / 16u)][((v_39 & 15u) >> 2u)])};
  return v_40;
}
...
tint_ExternalTextureParams v_42(uint start_byte_offset) {
  uint v_43 = t_f_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)];
  uint v_44 = (4u + start_byte_offset);
  uint v_45 = t_f_params[(v_44 / 16u)][((v_44 & 15u) >> 2u)];
  ...
  uint4 v_53 = t_f_params[(v_52 / 16u)];
...
void main() {
  ...
  float4 vals = tint_TextureLoadMultiplanarExternal(t_f_plane0, t_f_plane1, v_65, (0u).xx);
}
