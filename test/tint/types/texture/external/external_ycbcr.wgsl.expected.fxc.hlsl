...
float4 tint_TextureLoadMultiplanarExternal(Texture2D<float4> plane_0, Texture2D<float4> plane_1, tint_ExternalTextureParams params, uint2 coords) {
  ...
  if ((params.numPlanes == 1u)) {
    float4 v_16 = plane_0.Load(int3(int2(v_13), int(0)));
    v_14 = v_16.xyz;
    v_15 = v_16.w;
  } else {
    float v_17 = plane_0.Load(int3(int2(v_13), int(0))).x;
    v_14 = mul(params.yuvToRgbConversionMatrix, float4(v_17, plane_1.Load(int3(int2(tint_v2f32_to_v2u32((v_12 * params.plane1CoordFactor))), int(0))).xy, 1.0f));
    v_15 = 1.0f;
  }
  float3 v_18 = v_14;
  float3 v_19 = (0.0f).xxx;
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    tint_TransferFunctionParams v_20 = params.srcTransferFunction;
    float3 v_21 = tint_ApplySrcTransferFunction(v_18, v_20);
    float3 v_22 = (0.0f).xxx;
    if ((params.ootfParam.w != 0.0f)) {
      float v_23 = dot(params.ootfParam.xyz, v_21);
      v_22 = (v_21 * (float(sign(v_23)) * pow(abs(v_23), params.ootfParam.w)));
    } else {
      v_22 = v_21;
    }
    tint_TransferFunctionParams v_24 = params.dstTransferFunction;
    v_19 = tint_ApplyGammaTransferFunction(mul(v_22, params.gamutConversionMatrix), v_24);
  } else {
    v_19 = v_18;
  }
  return float4(v_19, v_15);
}
...
float3x2 v_25(uint start_byte_offset) {
  ...
  uint4 v_29 = t_f_params[(v_28 / 16u)];
...
tint_TransferFunctionParams v_34(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_42 = {t_f_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)], asfloat(t_f_params[(v_35 / 16u)][((v_35 & 15u) >> 2u)]), asfloat(t_f_params[(v_36 / 16u)][((v_36 & 15u) >> 2u)]), asfloat(t_f_params[(v_37 / 16u)][((v_37 & 15u) >> 2u)]), asfloat(t_f_params[(v_38 / 16u)][((v_38 & 15u) >> 2u)]), asfloat(t_f_params[(v_39 / 16u)][((v_39 & 15u) >> 2u)]), asfloat(t_f_params[(v_40 / 16u)][((v_40 & 15u) >> 2u)]), asfloat(t_f_params[(v_41 / 16u)][((v_41 & 15u) >> 2u)])};
  return v_42;
}
...
tint_ExternalTextureParams v_44(uint start_byte_offset) {
  uint v_45 = t_f_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)];
  uint v_46 = (4u + start_byte_offset);
  uint v_47 = t_f_params[(v_46 / 16u)][((v_46 & 15u) >> 2u)];
  ...
  uint4 v_55 = t_f_params[(v_54 / 16u)];
  ...
  float2 v_71 = asfloat((((((v_69 & 15u) >> 2u) == 2u)) ? (v_70.zw) : (v_70.xy)));
  tint_ExternalTextureParams v_72 = {v_45, v_47, v_48, v_49, v_50, v_51, v_52, v_53, v_56, v_59, v_62, v_65, v_68, v_71, asfloat(t_f_params[((272u + start_byte_offset) / 16u)])};
  return v_72;
}

[numthreads(1, 1, 1)]
void main() {
  tint_ExternalTextureParams v_73 = v_44(0u);
  float4 vals = tint_TextureLoadMultiplanarExternal(t_f_plane0, t_f_plane1, v_73, (0u).xx);
}
